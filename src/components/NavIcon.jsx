...
const PATHS = {
  ...
  book: <path d="M12 6.5C10.8 5 8.9 4.2 6.5 4.2c-1.1 0-2.1.2-3 .5v13.6c.9-.3 1.9-.5 3-.5 2.4 0 4.3.8 5.5 2.2 1.2-1.4 3.1-2.2 5.5-2.2 1.1 0 2.1.2 3 .5V4.7c-.9-.3-1.9-.5-3-.5-2.4 0-4.3.8-5.5 2.3Zm0 0V20" />,
  // flame / daily streak
  flame: (
    <>
