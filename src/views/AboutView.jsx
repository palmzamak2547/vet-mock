      ...
      <div className="vmx-dash-card" style={{ marginBottom: 16 }}>
        ...
        <div style={{ fontSize: 14, lineHeight: 1.7 }}>
          <ul style={{ paddingLeft: 20, margin: 0 }}>
            <li>เครื่องมือทบทวนครบจบในเว็บเดียว — โจทย์ฝึก, notes สรุป, flashcard, สรุปคลิป, ห้องสมุดเอกสาร, ถามคลังความรู้, scoring</li>
            <li>รวมโจทย์ฝึกทุกชั้นปีในเว็บเดียว (ตอนนี้มีข้อสอบครบปี 1-5 แล้ว)</li>
