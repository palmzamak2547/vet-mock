...
export const QB_Y5_OSCE_MED = [
  ...
  { id: 8500, subject: 'poa-clinical', topic: 'poa-collapse', year: 5,
    ...
    answer: 0,
    explain: 'เกณฑ์การสอบของสถานีนี้: เตรียมอุปกรณ์ → เจาะจากหุ่นจำลอง → คงความปลอดเชื้อตลอดการเก็บตัวอย่าง → เก็บตัวอย่างเลือดอย่างเหมาะสม → เลือก parameter ได้เหมาะสม. การวัดผล: ปฏิบัติได้ถูกต้องและเหมาะสม + เลือก parameter ตามอาการ/โรคของสัตว์ป่วยได้ถูกต้อง.',
