...
export const QB_Y5_REPRO_CLINIC = [
  ...
  { id: 8406, subject: 'comp-repro-clinic', topic: 'comp-repro-anatomy-cycle', year: 5,
    ...
    options: ['Attraction to male (ดึงดูดเพศผู้)', 'Standing to be mounted (ยอมให้ผสม)', 'Bloody vulvar discharge (มีเลือดออก)', 'Vulvar swelling (อวัยวะเพศบวม)'],
    answer: 1,
  ...
  { id: 8413, subject: 'comp-repro-clinic', topic: 'comp-repro-surgery', year: 5,
    ...
    options: ['Peritoneum (เยื่อบุช่องท้อง)', 'External rectus sheath', 'Subcutaneous tissue', 'Skin (ชั้นผิวหนังนอกสุด)'],
    answer: 1,
  ...
  { id: 8428, subject: 'comp-repro-clinic', topic: 'comp-repro-male', year: 5,
    ...
    options: ['Urethritis (ท่อปัสสาวะอักเสบ)', 'Epididymitis (ท่อพักอสุจิอักเสบ)', 'Scrotal dermatitis', 'Orchitis (อัณฑะอักเสบ)'],
    answer: 2,
  ...
  { id: 8431, subject: 'comp-repro-clinic', topic: 'comp-repro-male', year: 5,
    ...
    options: ['Prostatic cyst (ถุงน้ำต่อมลูกหมาก)', 'Prostatic neoplasia (มะเร็งต่อมลูกหมาก)', 'Prostatitis (ต่อมลูกหมากอักเสบ)', 'Benign prostatic hyperplasia'],
    answer: 3,
  ...
  { id: 8445, subject: 'comp-repro-clinic', topic: 'comp-repro-male', year: 5,
    ...
    options: ['มักพบร่วมกับ BPH (ต่อมลูกหมากโต)', 'มักพบร่วมกับ Hypospadias (ท่อปัสสาวะเปิดผิดที่)', 'มักพบร่วมกับ Pseudohermaphroditism', 'มักพบร่วมกับ Brachycephalic breed (พันธุ์หน้าสั้น)'],
    answer: 3,
