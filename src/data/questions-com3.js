...
export const QB_COM3 = [
  ...
  { id: 712, subject: 'com3', topic: 'shock', year: 4, source: 'SHOCK 1 hr.pdf',
    ...
    options: ['หัวใจ pump เลือดออกไม่ได้', 'Inflammatory mediators → vasodilation', 'Mitochondrial dysfunction ใช้ O₂ ไม่ได้', 'Volume เลือดในหลอดเลือดน้อยลง'],
    answer: 1, explain: 'Distributive: sepsis, SIRS, anaphylaxis\ninflammatory mediators (NO) → vasodilation → VR ↓ → CO ↓\n"warm shock" — vasodilate\n\n❌ ทำไมข้ออื่นผิด\n— หัวใจ pump ไม่ได้ = cardiogenic\n— Mitochondrial dysfunction = metabolic/hypoxic\n— Volume ↓ = hypovolemic',
  ...
  { id: 714, subject: 'com3', topic: 'shock', year: 4, source: 'SHOCK 1 hr.pdf',
    ...
    options: ['Anemia รุนแรงจน O₂ carrying ต่ำ', 'Volume ในหลอดเลือดต่ำลงมาก', 'O₂ ถึง cell ปกติ แต่ cell ใช้ไม่ได้', 'Tissue ขาด O₂ จาก hypovolemia'],
  ...
  { id: 723, subject: 'com3', topic: 'cpcr', year: 4, source: 'CPCR 1 hr.pdf',
    ...
    options: ['VF + Pulseless VT', '3rd-degree AV block', 'PEA (Pulseless Electrical Activity)', 'Sinus bradycardia', 'Asystole'],
    answer: 0, explain: 'Shockable: Ventricular Fibrillation (VF) + pulseless VT\nNON-shockable: asystole + PEA → ให้ epinephrine แทน\n\n❌ ทำไมข้ออื่นผิด\n— 3rd-degree AV block / sinus brady = ใช้ atropine + pacemaker\n— PEA / asystole = NON-shockable → epi',
  ...
  { id: 724, subject: 'com3', topic: 'cpcr', year: 4, source: 'CPCR 1 hr.pdf',
    ...
    options: ['VF / pulseless VT เสมอ', 'Sinus tachycardia ที่ HR สูง', 'ทุก case ของ cardiac arrest', 'Asystole / PEA ที่มี vagal tone เด่น'],
  ...
  { id: 732, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'Acute Abdomen 1 hr.pdf',
    ...
    options: ['Fluid glucose < 50 mg/dL หรือต่ำกว่า blood', 'ไม่ใช้ค่า glucose ในการ Dx', 'Fluid glucose = blood glucose', 'Fluid glucose > blood glucose 20 mg/dL'],
    answer: 0, explain: 'Septic peritonitis: fluid glucose < 50 mg/dL หรือต่ำกว่า blood glucose > 20 mg/dL (bacteria กิน glucose)\n+ degenerate neutrophil ± bacteria\n\n❌ ทำไมข้ออื่นผิด\n— ไม่ใช้ glucose = ผิด (เป็น key marker)\n— fluid = blood = transudate ปกติ\n— fluid > blood = ผิดทิศ',
  ...
  { id: 741, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    options: ['Heart failure ระยะท้าย', 'ปอดทำงานปกติดี', 'Pleural space disease', 'ปกติในสุนัขปกติ'],
  ...
  { id: 742, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    options: ['Bronchodilator inhaler ขยายหลอดลม', 'Mannitol IV ลด ICP', 'Steroid IV ลด inflammation', 'Furosemide IV + O₂', 'IV crystalloid bolus ขยาย volume'],
    answer: 3, explain: 'Cardiogenic pulmonary edema: Furosemide 1-4 mg/kg IV ± CRI + O₂ supplementation + minimize stress\nmonitor RR\nห้าม IV fluid (ทำให้แย่ลง)\n\n❌ ทำไมข้ออื่นผิด\n— Bronchodilator = ใช้ใน asthma\n— Mannitol = osmotic, ICP\n— Steroid = ไม่ effective\n— Crystalloid = ทำให้ edema แย่ลง',
    verified: 'Respiratory and Cardiovascular Emergency 1 hr.pdf' },
  ...
  { id: 752, subject: 'com3', topic: 'er-anes', year: 4, source: 'Animal_Emerg_Anes 1 hr.pdf',
    ...
    options: ['Fentanyl CRI', 'Ketamine low-dose', 'Etomidate induction', 'Propofol + inhalant'],
  ...
  { id: 753, subject: 'com3', topic: 'er-anes', year: 4, source: 'Animal_Emerg_Anes 1 hr.pdf',
    ...
    options: ['ไม่ต้องวางยาสลบ ทำ awake', 'ฉีด ketamine bolus เดียวพอ', 'Premed: α2-agonist, induct: thiopental', 'Premed: opioid + benzo + anticholinergic'],
    answer: 3, explain: 'Head trauma: opioid + benzodiazepine + anticholinergic\npropofol induct\nIPPV ETCO₂ ≈ 40 mmHg (ป้องกัน vasodilate → ICP ↑)\nห้าม α2 (depress)\n\n❌ ทำไมข้ออื่นผิด\n— ไม่วางยา = ผ่าตัดยาก\n— Ketamine bolus = ↑ ICP\n— α2 + thiopental = ห้ามใน head trauma\n\n💡 induct: propofol smooth, maintain ETCO₂ 40 mmHg ป้องกัน intracranial pressure',
    verified: 'Animal_Emerg_Anes 1 hr.pdf + master p.46' },
  ...
  { id: 761, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'master p.33',
    ...
    options: ['ให้ dextrose แก้ภาวะน้ำตาลก่อน', 'แก้ electrolyte + dehydration ก่อน', 'ให้ steroid เสริม cortisol ก่อน', 'ให้ insulin bolus ลดน้ำตาลทันที'],
    answer: 1, explain: 'DKA: rehydrate (NSS) + correct electrolyte imbalance (K) + check phosphate ก่อน → จากนั้น regular insulin CRI (dog 2.2 U/kg/d, cat 1.1 U/kg/d)\nห้าม SC route\n\n❌ ทำไมข้ออื่นผิด\n— Glucose ก่อน = ไม่แก้ acidosis\n— Steroid ก่อน = no role\n— Insulin bolus = K ตก รุนแรง\n\n💡 จากนั้น CRI insulin',
    verified: 'metabolic and endocrine and UT 1 hr.pdf + master p.33' },
  ...
  { id: 763, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'master p.33',
    ...
    options: ['Glucose > 250 mg/dL + ketonuria', 'Na+ < 132 + K+ > 7 + hypoglycemia', 'Calcium < 8 mg/dL + low PTH', 'Na+ > 160 + K+ < 3.0 + alkalosis'],
  ...
  { id: 765, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'master p.34',
    ...
    options: ['ให้ steroid ลดบวมท่อปัสสาวะ', 'ผ่าตัด perineal urethrostomy ทันทีก่อน stabilize', 'ให้ NSAIDs ลดปวดก่อน', 'Cystocentesis + fluid + แก้ hyperK ก่อน', 'สวน catheter ระบายทันที'],
    answer: 3, explain: 'Stabilize first: cystocentesis (decompress) + IV fluid + correct hyperK ก่อนสวน catheter\nsedation/anes ตอนสวน\npost-obstructive diuresis ระวังให้ fluid พอ\n\n❌ ทำไมข้ออื่นผิด\n— Steroid = no role\n— Urethrostomy = elective หลัง stabilize\n— NSAIDs = nephrotoxic\n— Catheter ทันที = K สูง → arrest',
  ...
  { id: 771, subject: 'com3', topic: 'nutrition', year: 4, source: 'nutrition 1 hr.pdf',
    ...
    options: ['Stress: catabolism เร็ว ดึงโปรตีนมาใช้มาก', 'Stress ไม่มี catabolism เกิดขึ้น', 'ทั้งสองภาวะเหมือนกันทุกอย่าง', 'ทั้งคู่ใช้ glycogen เป็นแหล่งหลัก'],
    answer: 0, explain: 'Stress starvation (sepsis/trauma/burn): glucocorticoid + cytokines → protein catabolism เร่ง (ดึงโปรตีนมาใช้เป็นพลังงาน) + insulin resistance\nSimple (fast): สงวน protein, fat dominant\n\n❌ ทำไมข้ออื่นผิด\n— "ไม่มี catabolism" = ผิด (stress = catabolism เร่ง)\n— "เหมือนกัน" = ผิด\n— "ใช้ glycogen เป็นหลัก" = แค่ 24 hr แรก\n\n💡 Simple: ใช้ fat เป็นหลัก, สงวนโปรตีน\n\n💡 mobilize fat, immune suppression',
    verified: 'nutrition 1 hr.pdf + master p.36' },
  ...
  { id: 773, subject: 'com3', topic: 'nutrition', year: 4, source: 'nutrition 1 hr.pdf',
    ...
    options: ['Bolus feeding 50 ml/kg ทันที', 'พัก 24 ชม. แล้วเริ่ม 1/3 RER', 'เริ่ม 1/2 RER + เสริมเกลือแร่', 'ให้อาหาร full RER ได้เลย'],
    answer: 1, explain: 'หลังวางสาย: 24 ชม. แรก rest แล้วค่อยเริ่ม\nD1 = 1/3 RER\nD2 = 2/3 RER\nD3 = full RER\nslow bolus ≤ 5 ml/min\nระวัง refeeding syndrome (hypoP)\n\n❌ ทำไมข้ออื่นผิด\n— Bolus 50 ml/kg = overload + vomit\n— 1/2 RER เร็วเกิน\n— Full RER = refeeding syndrome',
    verified: 'nutrition 1 hr.pdf + master p.37' },
  ...
  { id: 781, subject: 'com3', topic: 'neuro-exam', year: 4, source: 'neuro_exam 1 hr.pdf',
    ...
    options: ['Peripheral nerve + neuromuscular junction', 'Skeletal muscle fiber', 'Cerebral cortex + brainstem', 'Cerebellum + spinal cord'],
  ...
  { id: 784, subject: 'com3', topic: 'neuro-exam', year: 4, source: 'neuro_exam 1 hr.pdf',
    ...
    options: ['Random เปลี่ยนแปลงไม่แน่นอน', 'Areflexia (absent reflex)', 'Hyperreflexia / Normal reflex', 'Hyporeflexia (decreased)'],
  ...
  { id: 790, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'neuro_ataxia_tremor 1 hr.pdf',
    ...
    options: ['Vertical หรือ direction-changing nystagmus', 'ไม่มี nystagmus เลย', 'Horizontal เพียงอย่างเดียวเสมอ', 'Horizontal/rotary, fast phase ออกจาก lesion'],
    answer: 0, explain: 'Central vestibular: vertical nystagmus หรือ direction-changing, มี mental status change, postural reaction deficit\nPeripheral: horizontal/rotary fixed, mental status ปกติ',
  ...
  { id: 791, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'neuro_ataxia_tremor 1 hr.pdf',
    ...
    options: ['ลูกแมว 4 wk มี cluster seizure', 'แมวอ้วน BCS 8/9 หายใจหอบ', 'สุนัขแก่ sudden onset head tilt + nystagmus', 'สุนัขเด็ก head tilt + ataxia เป็นๆหายๆ'],
    answer: 2, explain: 'Geriatric vestibular: dog แก่\nsudden onset head tilt + horizontal nystagmus + ataxia (severe peripheral vestibular signs)\nLOC ปกติ\nมัก self-resolve 1-2 wk\nsupportive care\n\n❌ ทำไมข้ออื่นผิด\n— ลูกแมว seizure = ไม่ vestibular\n— แมวอ้วน BCS 8 = HCM/asthma\n— สุนัขเด็กเป็นๆหายๆ = inflammatory/congenital\n\n💡 mental status ปกติ, self-resolve 1-2 weeks',
    verified: 'neuro_ataxia_tremor 1 hr.pdf + master p.8' },
  ...
  { id: 792, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'neuro_ataxia_tremor 1 hr.pdf',
    ...
    options: ['ไม่มี movement ผิดปกติ', 'Continuous shaking ทั้งตัว', 'Intention tremor เห็นชัดตอนจะทำกิจ', 'Resting tremor ขณะอยู่นิ่ง'],
    answer: 2, explain: 'Cerebellar: intention tremor (เห็นชัดตอนจะทำกิจ เช่น ตอนกินน้ำ) + hypermetria (overshoot) + truncal ataxia + menace deficit (with normal vision)\n\n❌ ทำไมข้ออื่นผิด\n— No movement = paresis\n— Continuous shaking ทั้งตัว = toxin/generalized tremor\n— Resting tremor = basal ganglia (rare vet)',
  ...
  { id: 803, subject: 'com3', topic: 'seizure', year: 4, source: 'seizure 1 hr.pdf',
    ...
    options: ['รอให้ชักหยุดเองภายใน 30 นาที', 'IV access + Diazepam 0.5 mg/kg IV', 'Mannitol 1 g/kg IV bolus ช้าๆ', 'ให้ phenobarbital 5 mg/kg PO'],
    answer: 1, explain: 'Diazepam IV 0.5 mg/kg bolus (or rectal 1-2 mg/kg) → ถ้ายังไม่หยุด: midazolam CRI / propofol CRI / phenobarb loading\nmonitor: airway, glucose, temperature\n\n❌ ทำไมข้ออื่นผิด\n— รอเอง 30 min = neuronal damage\n— Mannitol = ใช้ ICP\n— phenobarb PO = ช้าเกิน emergency\n\n💡 per rectum ถ้าไม่มี IV\n\n💡 หรือ rectal 1-2 mg/kg',
  ...
  { id: 811, subject: 'com3', topic: 'spinal', year: 4, source: 'Spinal disorder 2 hr.pdf',
    ...
    options: ['Persian, Siamese, Maine Coon cat', 'Great Dane, Doberman, German Shepherd', 'Chihuahua, Pomeranian, Maltese', 'Dachshund, Corgi, Beagle'],
  ...
  { id: 812, subject: 'com3', topic: 'spinal', year: 4, source: 'Spinal disorder 2 hr.pdf',
    ...
    options: ['คอเอียงเรื้อรัง', 'ตามองไม่เห็น', 'Respiratory failure', 'ขาหลังอ่อนแรง'],
  ...
  { id: 813, subject: 'com3', topic: 'spinal', year: 4, source: 'Spinal disorder 2 hr.pdf',
    ...
    options: ['Heart rate ขณะพัก', 'Deep pain perception (DPP)', 'PCV และ total solid', 'อายุและน้ำหนักของสัตว์'],
  ...
  { id: 820, subject: 'com3', topic: 'neuro-er', year: 4, source: 'neuroER 1 hr.pdf',
    ...
    options: ['Diazepam 0.5 mg/kg IV bolus', 'Dexamethasone 0.25 mg/kg IV', 'Mannitol 0.5-1 g/kg IV ช้าๆ 15-20 นาที', 'Furosemide 2 mg/kg IV q6h'],
  ...
  { id: 825, subject: 'com3', topic: 'triage', year: 4, source: 'triage 1 hr.pdf',
    ...
    options: ['ราคาค่ารักษาโดยประมาณ', 'ระดับสติ + การหายใจ + trauma', 'ประวัติฉีดวัคซีนครบหรือไม่', 'อายุและเพศของสัตว์'],
  ...
  { id: 831, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'Acute Abdomen 1 hr.pdf',
    ...
    options: ['Linear foreign body + plication', 'Megacolon + fecal impaction', '"Reverse C" / "double bubble"', 'Free air ใต้ diaphragm'],
    answer: 2, explain: 'GDV: right lateral X-ray = "double bubble" หรือ reverse C sign (compartmentalization)\nstomach rotate clockwise\nemergency Sx\n\n❌ ทำไมข้ออื่นผิด\n— Linear FB = string-like FB sign\n— Megacolon = constipation pattern\n— Free air = perforation\n\n💡 กระเพาะ rotate',
    verified: 'Acute Abdomen 1 hr.pdf + master p.22' },
  ...
  { id: 832, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'Acute Abdomen 1 hr.pdf',
    ...
    options: ['เมื่อมี hemoabdomen รุนแรงและ unstable', 'เมื่อสงสัย GDV จากภาพ X-ray ช่องท้อง', 'เมื่อ effusion น้อยมาก ใส่ fluid แล้วดูดออก analyze', 'ทุก case ของ acute abdomen เป็น routine'],
    answer: 2, explain: 'DPL ใช้เมื่อมี fluid ในช่องท้องน้อยมาก: ใส่ NSS เข้าช่องท้อง mix แล้วดูดออก → analyze (เพิ่ม sensitivity)\ninvasive ระวังโดนอวัยวะ\n\n❌ ทำไมข้ออื่นผิด\n— Severe hemoabdomen = AFAST/cytology พอ\n— GDV = X-ray dx\n— ทุก case = invasive เกินจำเป็น',
    verified: 'Acute Abdomen 1 hr.pdf + master p.23' },
  ...
  { id: 833, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    options: ['Oxygen cage (≈ 30-60%)', 'Room air เปิดหน้าต่างระบาย (21%)', 'Tight-fitting mask high flow (≈ 60-80%)', 'Nasal cannula (≈ 30-50%)', 'Flow-by mask (FiO₂ ≈ 25-40%)'],
    answer: 2, explain: 'FiO₂ scale: room air 21% → flow-by 25-40% → nasal 30-50% → cage 30-60% → tight mask 60-80% → ETT 100%\ntight mask high flow หรือ ETT ให้ FiO₂ สูงสุด\nเลือกตาม severity\n\n❌ ทำไมข้ออื่นผิด\n— O₂ cage 30-60%\n— Room air 21%\n— Nasal 30-50%\n— Flow-by 25-40% — ทั้งหมดต่ำกว่า tight mask/ETT\n\n💡 ≈ 100%',
    verified: 'Respiratory and Cardiovascular Emergency 1 hr.pdf' },
  ...
  { id: 835, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    options: ['O₂ + Terbutaline SC + glucocorticoid', 'Bronchodilator inhaler ห้ามใช้แมว < 8 wk', 'Antibiotic only (amoxicillin 22 mg/kg PO)', 'Furosemide 2 mg/kg IV q12h'],
    answer: 0, explain: 'Acute asthma: O₂ supplement + terbutaline 0.01 mg/kg SC (bronchodilator) + dexamethasone IV (glucocorticoid)\nlong-term: inhaled fluticasone + albuterol PRN\n\n❌ ทำไมข้ออื่นผิด\n— "Bronchodilator inhaler ห้าม" = ผิด (ใช้ albuterol/fluticasone ได้)\n— Antibiotic only = ไม่ใช่ first-line\n— Furosemide = ใช้ใน CHF',
    verified: 'Respiratory and Cardiovascular Emergency 1 hr.pdf' },
  ...
  { id: 836, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    options: ['Polyuria + polydipsia (slow onset, renal involvement)', 'Acute hindlimb paresis + cold limbs + absent femoral pulse', 'Vomit + diarrhea + abdominal pain (acute GI)', 'Cough เด่น + tachypnea (CHF)'],
    answer: 1, explain: 'ATE "5 Ps": Pain, Pulselessness, Pallor (cyanotic pads), Paresis/plegia, Poikilothermia (cold limbs) — onset เฉียบพลัน + ปวดมาก\nassociated cardiomyopathy (HCM)\npoor prognosis\nanalgesia + thromboprophylaxis (clopidogrel)\n\n❌ ทำไมข้ออื่นผิด\n— PU/PD = renal slow onset\n— V/D = GI\n— Cough = CHF associated ไม่ใช่ ATE classic',
    verified: 'Respiratory and Cardiovascular Emergency 1 hr.pdf' },
  ...
  { id: 842, subject: 'com3', topic: 'er-anes', year: 4, source: 'Animal_Emerg_Anes 1 hr.pdf',
    ...
    options: ['ลดขนาด induction agent ที่ต้องใช้', 'ลดความเจ็บปวดระหว่างใส่ท่อช่วยหายใจ', 'เพิ่ม O₂ reserve ใน FRC ลด risk hypoxia', 'ทำให้สัตว์ตื่นตัวมากขึ้นก่อน induction'],
    answer: 2, explain: 'Pre-O₂: 3-5 min mask → fill FRC (functional residual capacity) + denitrogenate\nลด desaturation risk during intubation\nสำคัญใน hypovolemic, dyspneic, brachycephalic\n\n❌ ทำไมข้ออื่นผิด\n— ลดความเจ็บ = ใช้ local\n— ลดยาวาง = MAC reduction (ไม่ใช่ pre-O₂)\n— ทำให้ตื่น = ผิด goal',
  ...
  { id: 844, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'master p.34',
    ...
    options: ['Atrial flutter, sawtooth pattern', 'Sinus tachycardia + ST elevation', 'Sinus arrest อย่างเดียว', 'Bradycardia + absent P + tall T + wide QRS', 'Tachycardia + tall narrow QRS'],
    answer: 3, explain: 'HyperK ECG: lose P wave first → wide QRS → tall peaked T → bradycardia → V-fib (sinoventricular rhythm)\nK+ > 7 = emergency\nTx: Ca gluconate (stabilize myocardium) + dextrose+insulin (shift K)\n\n❌ ทำไมข้ออื่นผิด\n— Atrial flutter = re-entry, ไม่ใช่ K\n— Sinus tachy + ST elev = MI\n— Sinus arrest only = sick sinus\n— Tachy + tall narrow QRS = ไม่ classic\n\n💡 sinoventricular rhythm',
    verified: 'master p.34' },
  ...
  { id: 846, subject: 'com3', topic: 'nutrition', year: 4, source: 'nutrition 1 hr.pdf',
    ...
    options: ['รักษาด้วย NPO เพื่อพัก liver', 'เกิดเฉพาะ kitten < 3 เดือน', 'แมวอ้วน + อดอาหาร → fat overload ที่ตับ', 'แมวผอม + อด < 12 ชม. → ไม่เสี่ยง hepatic lipidosis'],
    answer: 2, explain: 'Cat hepatic lipidosis: obese + anorexia 24-48 ชม. → fat mobilization → liver overload (severe)\nTx: aggressive enteral nutrition (E-tube) + L-carnitine 250 mg/cat\nกลับมาดูแลเอง 4-6 wk\n\n❌ ทำไมข้ออื่นผิด\n— NPO = ทำให้แย่ลง (ต้อง enteral feed)\n— เฉพาะ kitten = ผิด (โตเต็มวัยเป็นได้)\n— ผอม < 12 hr ไม่เสี่ยง = generalization ผิด\n\n💡 Tx: enteral feeding (E-tube/G-tube) + L-carnitine + B12',
    verified: 'nutrition 1 hr.pdf + master p.36' },
  ...
  { id: 848, subject: 'com3', topic: 'nutrition', year: 4, source: 'nutrition 1 hr.pdf',
    ...
    options: ['< 5% ของ kcal ทั้งคู่', 'Dog ~25-35% / Cat ~30-40%', '50% ของ kcal ทั้งคู่', 'Dog 5-10% / Cat 10-15%'],
    answer: 1, explain: 'Critical illness protein: dog ~25-35% (4-6 g/100 kcal)\ncat ~30-40% / 6-8 g/100 kcal (cat = obligate carnivore)\nลด protein ในกรณี HE (hepatic encephalopathy)\n\n❌ ทำไมข้ออื่นผิด\n— < 5% = under-supplement\n— 50% = excessive (BUN ↑)\n— Dog 5-10% / Cat 10-15% = under-supplement',
    verified: 'nutrition 1 hr.pdf + master p.36' },
  ...
  { id: 850, subject: 'com3', topic: 'neuro-exam', year: 4, source: 'neuro_exam 1 hr.pdf',
    ...
    options: ['CN II → cerebellum → CN VII', 'CN V → brainstem → CN VII', 'CN III → midbrain → CN VI', 'CN I → forebrain → CN V'],
  ...
  { id: 851, subject: 'com3', topic: 'neuro-exam', year: 4, source: 'neuro_exam 1 hr.pdf',
    ...
    options: ['CN V → brainstem → VII', 'CN II → midbrain → III', 'CN IV → midbrain → VI', 'CN II → III ข้างเดียว'],
  ...
  { id: 853, subject: 'com3', topic: 'neuro-exam', year: 4, source: 'neuro_exam 1 hr.pdf',
    ...
    options: ['ลูบขนเบาๆ แล้วดูปฏิกิริยาการสะดุ้ง', 'Pinch periosteum/digit + ดู conscious response', 'ทดสอบการดมกลิ่นอาหารที่คุ้นเคย', 'ดึงผิวหนังหลังเพื่อบอกระดับ vision'],
  ...
  { id: 854, subject: 'com3', topic: 'spinal', year: 4, source: 'Spinal disorder 2 hr.pdf',
    ...
    options: ['Strict cage rest 4-6 weeks + multimodal analgesia', 'NSAIDs only (carprofen 4 mg/kg q12h)', 'Steroid high-dose (prednisolone 2 mg/kg)', 'Surgery ทันทีภายใน 6 ชั่วโมง'],
  ...
  { id: 857, subject: 'com3', topic: 'spinal', year: 4, source: 'Spinal disorder 2 hr.pdf',
    ...
    options: ['Hypovolemic shock — duration < 1 hr', 'Septic shock จาก myelitis 48-72 hr', 'Transient areflexia below lesion หลัง SC injury', 'Permanent loss of all reflex > 7 วัน'],
    answer: 2, explain: 'Spinal shock: transient loss of spinal reflex below lesion หลัง acute SC injury (temporary areflexia)\n24 hr in dog (longer in human)\nneed to repeat exam at 24 hr\nถ้าหลัง 24h ยังไม่มี DPP = poor prognosis\n\n❌ ทำไมข้ออื่นผิด\n— Hypovolemic/Septic shock = circulation, ไม่ใช่ neuro\n— Permanent loss > 7 d = SC severance ไม่ใช่ spinal shock\n\n💡 ก่อนประเมิน DPP/prognosis ต้องรอ 24 hr\n\n💡 ~24 hr ในสุนัข',
    verified: 'Spinal disorder 2 hr.pdf + master p.6' },
  ...
  { id: 860, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'neuro_ataxia_tremor 1 hr.pdf',
    ...
    options: ['Hereditary single-gene defect', 'Feline panleukopenia (FPV) in utero', 'Vitamin B1 deficiency ในแม่แมว', 'Birth trauma ขณะคลอด', 'Bacterial meningitis แรกเกิด'],
  ...
  { id: 861, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'neuro_ataxia_tremor 1 hr.pdf',
    ...
    options: ['Whole-body fine tremor ในสุนัขขาวตัวเล็ก', 'ภาวะ endocrine ต้องให้ insulin', 'อาการของ heart failure', 'Vestibular signs ต้องให้ antibiotic'],
    answer: 0, explain: 'WSTS: 1-3 yo small white dog (Maltese, Westie, Poodle)\nidiopathic cerebellitis\nresponds prednisolone 1-2 mg/kg/d\ntaper slowly\nDDx organophosphate, pyrethrin toxicity\n\n❌ ทำไมข้ออื่นผิด\n— Insulin = endocrine ไม่เกี่ยว\n— Heart failure = ไม่ใช่ tremor cause\n— Antibiotic = no role\n\n💡 steroid-responsive\n\n💡 Maltese, Westie, Poodle',
    verified: 'neuro_ataxia_tremor 1 hr.pdf' },
  ...
  { id: 872, subject: 'com3', topic: 'neuro-er', year: 4, source: 'neuroER 1 hr.pdf',
    ...
    options: ['ให้กิน paracetamol 10 mg/kg ลดไข้', 'ฉีด dexamethasone IM 1 mg/kg', 'ให้กิน phenobarb 5 mg/kg ทันที', 'Per-rectal diazepam หรือ intranasal midazolam', 'ห้ามทำอะไร รอถึงคลินิกเท่านั้น'],
    answer: 3, explain: 'Owner-administered: rectal diazepam 1-2 mg/kg (preloaded syringe)\nintranasal midazolam 0.2 mg/kg\nขั้นแรกใน cluster ก่อนพามา\nลด cluster severity\n\n❌ ทำไมข้ออื่นผิด\n— Paracetamol = ไม่ใช่ AED\n— Dexa IM = ไม่ใช่ AED\n— Phenobarb PO = ช้าเกิน home rescue\n— "ห้ามทำ" = miss window\n\n💡 มียาฉุกเฉินไว้ที่บ้าน',
  ...
  { id: 873, subject: 'com3', topic: 'neuro-er', year: 4, source: 'neuroER 1 hr.pdf',
    ...
    options: ['Active cooling ถึง 39.5°C แล้วหยุด', 'ห่อผ้าหนาให้อบอุ่นจนถึง 38°C', 'รอให้อุณหภูมิลดเอง > 1 ชม.', 'ไม่ต้อง intervention ภายใน 4 ชม.'],
    answer: 0, explain: 'Hyperthermia from prolonged seizure → DIC + multi-organ failure\nactive cooling aggressively จนอุณหภูมิ 39.5°C then STOP (overshoot risk)\nmonitor temp continuous\n\n❌ ทำไมข้ออื่นผิด\n— ห่อผ้าหนา = warming = แย่ลง\n— รอเอง > 1 hr = organ damage\n— ไม่ทำ 4 hr = lethal',
    verified: 'neuroER 1 hr.pdf' },
  ...
  { id: 876, subject: 'com3', topic: 'ai-vet', year: 4, source: 'COM III ตารางเรียน',
    ...
    options: ['AI ปฏิเสธที่จะตอบคำถามที่ถาม', 'AI หยุดประมวลผลกะทันหันกลางคัน', 'AI สร้างคำตอบดูน่าเชื่อแต่ผิดข้อเท็จจริง', 'AI ตอบสนองช้ากว่าปกติมาก', 'AI ประมวลผลภาพผิดเพี้ยนเป็นวัตถุอื่น'],
  ...
  { id: 877, subject: 'com3', topic: 'ai-vet', year: 4, source: 'COM III ตารางเรียน',
    ...
    options: ['ห้ามบอก context ใดๆ แก่ AI', 'ระบุ context + ถามเจาะจง + ขอ citation', 'ใช้ภาษากำกวมให้ AI ตีความเอง', 'ใช้แค่คำคีย์เวิร์ดเดียว', 'ถามเปิดกว้างสั้นๆ ว่าหมาเป็นโรคอะไร'],
    answer: 1, explain: 'Good prompt: ระบุ context + ask specific question + request format/citation\nเช่น "Dachshund 6 yr, sudden HL plegia, no DPP — DDx + initial workup with citation"\niterative refinement\n\n❌ ทำไมข้ออื่นผิด\n— "ห้ามบอก context" = ผิด\n— "กำกวมให้ตีความ" = hallucination เพิ่ม\n— keyword เดียว = vague\n— "เปิดสั้น" = generic answer',
  ...
  { id: 881, subject: 'com3', topic: 'ai-vet', year: 4, source: 'COM III ตารางเรียน',
    ...
    options: ['ลบคำตอบทิ้งทันที', 'Verify ด้วย primary source', 'ส่งต่อให้เพื่อนร่วมงาน', 'Copy-paste ไปใช้ได้เลย'],
  ...
  { id: 883, subject: 'com3', topic: 'triage', year: 4, source: 'COM III FINAL 86 + Aj. Chutirat lecture',
    ...
    options: ['X-ray ช่องท้อง หา free fluid', 'CBC + chemistry รอผล lab', 'Primary survey ABCDE + fluid resuscitation', 'ซัก history + signalment ให้ครบก่อน'],
    answer: 2, explain: 'Triage > Primary survey ABCDE → identified shock/hypovolemia → immediate fluid resuscitation ก่อน\nhistory/secondary survey หลัง stabilize\nsx/imaging มาทีหลัง',
  ...
  { id: 885, subject: 'com3', topic: 'cpcr', year: 4, source: 'COM III FINAL 86 + RECOVER',
    ...
    options: ['Start CPR ทันที + เตรียม defib', 'IV fluid bolus ขยาย volume', 'Atropine 0.04 mg/kg IV', 'รอดู rhythm 30 วินาทีก่อนตัดสินใจ'],
    answer: 0, explain: 'VF + no pulse + EtCO₂ drop = cardiac arrest\nStart CPR ทันที + prep defibrillator (shockable)\n2-4 J/kg biphasic\nห้าม atropine ใน VF\nห้ามรอ\n\n❌ ทำไมข้ออื่นผิด\n— IV fluid bolus = ไม่ relevant ใน arrest\n— Atropine = ห้ามใน VF\n— รอ 30 sec = miss window',
    verified: 'CPCR 1 hr.pdf + RECOVER 2024' },
  ...
  { id: 888, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'metabolic',
    ...
    options: ['Steroid IV (dexamethasone 0.5 mg/kg)', 'IV NSS → replace K → insulin CRI หลัง K ขึ้น', 'Dextrose 50% bolus 2 ml/kg ทันที', 'Insulin SC 1 U/kg ทันทีทุก 12 ชม.'],
    answer: 1, explain: 'DKA order: IV NSS bolus → correct K (insulin shifts K → fatal hypoK ถ้าไม่แก้ก่อน, replace จน K ≥ 3.5) → Regular insulin CRI 1.1 U/kg/d cat (NOT SC)\nmonitor q1-2h\ncerebral edema risk\n\n❌ ทำไมข้ออื่นผิด\n— Steroid = no role ใน DKA\n— Dextrose bolus = ↑ glucose แย่ลง\n— Insulin SC = K ตก, route ผิด (ต้อง CRI)',
    verified: 'metabolic and endocrine and UT 1 hr.pdf + master p.33' },
  ...
  // ============================================================
  // Phase 3 (v5.8.0): COM III Final 2019/2020 (75-Q paper)
  // 33 high-quality items matching 2026 syllabus, position-balanced
  // ============================================================
  { id: 1360, subject: 'com3', topic: 'cpcr', year: 4, source: 'COM III Final 86',
    ...
    options: [
      ...
      'ประเมิน CPA จากการหายใจไม่เต็มที่ (agonal) หรือหยุดหายใจ (apnea)',
      'เตรียม crash cart, algorithm chart และ dosing chart ให้พร้อมใช้งานเสมอ',
      'จัดอบรม CPR ให้ทีมปฏิบัติการเพื่อเพิ่มความพร้อมตอบสนองได้เร็วเสมอ',
    ],
    answer: 0, explain: 'RECOVER 2012 guideline ห้ามคลำชีพจรเพื่อยืนยัน CPA — เพราะ:\n• กินเวลานาน (ทำให้กดหน้าอกช้าลง)\n• Femoral pulse ไม่ reliable ในสัตว์ที่ shock\n• False negative สูง\n\n✓ ใช้ unconscious + apnea/agonal breathing เป็น signal ที่เพียงพอแล้ว → เริ่ม CPR ทันที\n\n💡 "If in doubt, start CPR" — RECOVER 2012',
    verified: 'CPCR 1 hr.pdf, RECOVER 2012, COM III Final 86' },
  ...
  { id: 1361, subject: 'com3', topic: 'cpcr', year: 4, source: 'COM III Final 86',
    ...
    options: [
      ...
      'ทำ chest compression ติดต่อกัน 2 นาที แล้วจึงหยุดประเมิน rhythm หนึ่งครั้ง',
      'เริ่มช่วยหายใจ (rescue breathing) ทันทีเมื่อพบ apnea ในสัตว์ป่วย',
      'เริ่มกดหน้าอก (chest compression) ทันทีเมื่อพบหมดสติ + ไม่ตอบสนอง',
    ],
    answer: 1, explain: 'RECOVER 2012: ห้ามหยุด CPR เพื่อเช็ค ROSC ทุกครั้ง เพราะการหยุดทำให้ coronary perfusion ตกลงทันที (ใช้เวลา 60 วินาทีกว่าจะกลับมา baseline)\n\n✓ Cycle ปกติ: compress 2 นาที → pause สั้นๆ ตรวจ rhythm + ROSC ครั้งเดียว → กลับไปกด\n\n💡 Push hard, push fast, minimize interruption, ความสำคัญของ uninterrupted compression > pulse check',
    verified: 'CPCR 1 hr.pdf, RECOVER 2012, COM III Final 86' },
  ...
  { id: 1362, subject: 'com3', topic: 'triage', year: 4, source: 'COM III Final 86',
    ...
    options: [
      ...
      'Febantel ในเคส severe trichuriasis-induced pseudo-Addison syndrome',
      'Cooling body temperature ใน heat stroke (active cooling protocol)',
      'Thoracocentesis ในเคส simple pneumothorax (relieve pleural pressure)',
    ],
    answer: 2, explain: 'Resuscitation = การช่วยเหลือเร่งด่วนเพื่อ stabilize physiology ที่กำลังจะ failure (ABCD)\n\n✗ Febantel = anthelmintic (ยาถ่ายพยาธิ) — เป็น definitive treatment ของ root cause ไม่ใช่ resuscitation\n\n✓ Resuscitation steps:\n• Airway: intubation, suction\n• Breathing: O2, thoracocentesis\n• Circulation: fluid, blood products, vasopressor\n• Disability: mannitol, anti-seizure\n• Exposure: cooling/warming',
    verified: 'triage 1 hr.pdf, COM III Final 86' },

  { id: 1363, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'COM III Final 86',
    tags: ['acute-abdomen', 'surgical-decision', 'pancreatitis'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'สาเหตุของ acute abdomen ในข้อใด ไม่จำเป็น ต้องได้รับการผ่าตัดด่วน',
    options: [
      'Septic peritonitis (พบ neutrophil + bacteria ใน abdominocentesis fluid)',
      'Hemoabdomen + persistent hypotension แม้ให้ fluid resuscitation เต็มที่',
      'Gastric dilatation-volvulus (GDV — life-threatening surgical emergency)',
      'Acute pancreatitis (medical management — NPO, IV fluid, analgesia, antiemetic)',
      'Penetrating abdominal trauma (GI perforation จากบาดแผลทะลุ)',
    ],
    answer: 3, explain: 'Acute pancreatitis = medical management เป็นหลัก:\n• NPO (rest pancreas) → reintroduce slowly\n• Aggressive IV fluid (crystalloid)\n• Analgesia (opioid)\n• Antiemetic (maropitant, ondansetron)\n• Plasma transfusion ถ้า severe\n\n✗ Surgery มีบทบาทเฉพาะ:\n• Pancreatic abscess\n• Necrotic pancreatitis ที่ไม่ตอบสนอง\n• Biliary obstruction\n\n💡 อีก 4 ข้อ = surgical emergency ทั้งหมด',
    verified: 'acute abdomen 1 hr.pdf, COM III Final 86' },

  { id: 1364, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'COM III Final 86',
    tags: ['hemoabdomen', 'physical-exam'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'แมวอายุ 3 ปี มีบาดเจ็บที่ท้อง, ข้อใด ไม่สอดคล้อง กับการวินิจฉัย hemoabdomen',
    options: [
      'เก็บของเหลวจาก abdominocentesis: PCV ของเหลวสูงกว่าใน peripheral PCV',
      'AFAST ที่ splenorenal view ได้ผลบวก (free fluid pocket ระหว่าง spleen-kidney)',
      'เยื่อเมือกซีดและชีพจรเบาเร็ว (sign of hypovolemic shock จากเสียเลือด)',
      'มีอาการ guarding และ pain เมื่อคลำช่องท้อง (peritoneal irritation จากเลือด)',
      'พบรอยช้ำ (bruising / petechiae) ที่หนังบริเวณหลังของแมว',
    ],
    answer: 4, explain: 'Bruising / petechiae ที่หนัง = sign ของ coagulopathy (DIC, rodenticide, immune-mediated thrombocytopenia) — ไม่ใช่ hemoabdomen โดยตรง\n\n✓ Hemoabdomen findings:\n• Abdominal effusion ที่ AFAST\n• Tap fluid: PCV > peripheral, non-clotting\n• Pale mm + weak pulse + tachycardia (shock)\n• Distended/painful abdomen + guarding\n• Pulse deficit, fluid wave\n\n💡 ตรวจ coagulation profile ทุกเคส hemoabdomen — แยก primary trauma vs coagulopathy',
    verified: 'acute abdomen 1 hr.pdf, COM III Final 86' },

  { id: 1365, subject: 'com3', topic: 'shock', year: 4, source: 'COM III Final 86',
    tags: ['fluid-therapy', 'colloid'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'สารน้ำชนิดใดต่อไปนี้มี volume effect ดีที่สุด เมื่อเทียบกับปริมาตรของ plasma',
    options: [
      'HES / Voluven 6% (synthetic colloid — hold volume ใน intravascular นานสุด)',
      'Lactated Ringer\'s solution (isotonic crystalloid — รั่วเข้า ECF เกิน 70%)',
      '0.9% NaCl / Normal saline (isotonic crystalloid — distribute ECF เร็ว)',
      'D5 1/2NS (hypotonic — distribute ทั่ว total body water)',
      '20% Mannitol (hyperosmotic — ดึงน้ำจาก cell แต่ขับออกเร็ว)',
    ],
    answer: 0, explain: 'Volume effect = เปอร์เซ็นต์ของปริมาตรที่ infuse แล้วยังอยู่ใน intravascular หลัง 1 ชม.\n\n✓ Colloid (HES, albumin): 70-100% — molecule ใหญ่ผ่าน vessel ยาก\n✓ Crystalloid (LRS, NSS): 20-25% — กระจายเร็วเข้า interstitium\n✗ Hypotonic (D5W, D5 1/2NS): <10% — กระจายทั่ว total body water\n\n💡 Colloid ใช้เมื่อต้อง rapid volume restoration ใน severe shock — แต่ระวัง renal injury (HES) และ allergic reaction',
    verified: 'shock 1 hr.pdf, COM III Final 86' },
  ...
  { id: 1366, subject: 'com3', topic: 'shock', year: 4, source: 'COM III Final 86',
    ...
    options: [
      ...
      'Pallor — pale paw pad / mucous membrane ที่ขาที่ blocked',
      'Paralysis — LMN sign ที่ขาที่ blocked (ไม่มี motor function)',
      'Pain — severe pain โดยเฉพาะตอนที่จับคลำ ขาที่ blocked',
    ],
    answer: 1, explain: '5Ps ของ ATE = Pain, Pallor, Pulselessness, Paralysis, Poikilothermia (ขาเย็น)\n\n✗ Poikilocytosis = ความผิดปกติของรูปร่าง RBC (เช่น schistocyte, acanthocyte) — ไม่ใช่ส่วนของ ATE criteria\n\n💡 ATE ใน cat (saddle thrombus) มักเกิดจาก HCM → left atrial thrombus → embolize ลง iliac trifurcation → block ทั้ง 2 hindlimb, ตรวจ:\n• ดู cold paw pad\n• คลำ pulse ทั้ง 4 limb\n• ดู nail bed bleed test',
    verified: 'shock 1 hr.pdf, COM III Final 86' },

  { id: 1367, subject: 'com3', topic: 'shock', year: 4, source: 'COM III Final 86',
    tags: ['cardiogenic', 'fluid-decision'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'ผู้ป่วยที่มาด้วย shock ในข้อใดต้องการ aggressive crystalloid resuscitation น้อยที่สุด',
    options: [
      'GDV (gastric dilatation-volvulus) — third-spacing + obstructive component',
      'Anaphylactic shock จาก vaccine — distributive (massive vasodilation)',
      'Dilated cardiomyopathy (DCM) — cardiogenic, fluid loading ทำให้ pulmonary edema',
      'Parvoviral enteritis severe — hypovolemic (severe diarrhea + vomiting)',
      'Paracetamol toxicity — hepatic injury + Heinz body anemia (volume support)',
    ],
    answer: 2, explain: 'Cardiogenic shock (DCM) → ปั๊มไม่ออก ไม่ใช่ขาด volume → ให้ fluid เพิ่มทำให้ pulmonary edema แย่ลง\n\n✓ Cardiogenic shock treatment:\n• Inotrope (dobutamine, pimobendan IV)\n• Diuretic (furosemide) ถ้า edema\n• O2 supplementation\n• Cardiac monitoring (ECG, BP)\n• Fluid restrict — ให้น้อยที่สุดที่จำเป็น\n\n💡 อีก 4 ข้อ = hypovolemic / distributive shock → ต้อง aggressive fluid bolus',
    verified: 'shock 1 hr.pdf, COM III Final 86' },

  { id: 1368, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'COM III Final 86',
    tags: ['breathing-pattern', 'restrictive'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'สาเหตุ respiratory distress ในข้อใดทำให้สัตว์มีอาการแบบ restrictive breathing pattern',
    options: [
      'Feline asthma (lower airway constriction — expiratory effort, prolonged exp.)',
      'Pharyngeal tumor (upper airway obstruction — inspiratory stridor / stertor)',
      'Laryngeal paralysis (upper airway — inspiratory stridor + voice change)',
      'Diaphragmatic hernia (restrictive — chest cavity fills with abdominal content)',
      'Tracheal collapse (large airway obstruction — honking cough + dyspnea)',
    ],
    answer: 3, explain: 'Restrictive pattern = ปอดขยายไม่ได้เต็มที่ → rapid shallow breathing\n\n✓ Restrictive causes (ปอดขยายไม่ได้):\n• Pleural effusion / pneumothorax\n• Diaphragmatic hernia ← classic\n• Severe pulmonary fibrosis\n• Massive abdominal distension (push diaphragm cranially)\n\n✗ อีก 4 ข้อ = obstructive pattern (airway แคบ — เร็ว เบา หรือ effort เพิ่ม):\n• Upper airway → inspiratory stridor\n• Lower airway → expiratory wheeze',
    verified: 'resp-cv-er 1 hr.pdf, COM III Final 86' },

  { id: 1369, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'COM III Final 86',
    tags: ['heart-failure', 'small-breed', 'dmvd'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'โรคหัวใจล้มเหลวเฉียบพลันที่พบบ่อยที่สุด ในสุนัขพันธุ์เล็ก อายุมาก คือข้อใด',
    options: [
      'Hypertrophic cardiomyopathy (HCM — พบเป็นหลักในแมว ไม่ใช่สุนัขเล็ก)',
      'Pericardial effusion (มักพบใน large breed สูงอายุจาก hemangiosarcoma)',
      'Ventricular septal defect (VSD — congenital, มักพบในสัตว์อายุน้อย)',
      'Dilated cardiomyopathy (DCM — large breed dog เช่น Doberman, Boxer)',
      'Degenerative mitral valve disease (Cavalier, Poodle, Chihuahua สูงอายุ)',
    ],
    answer: 4, explain: 'DMVD (degenerative / myxomatous mitral valve disease) = #1 cause of CHF ในสุนัขพันธุ์เล็กสูงอายุ\n\n✓ Predisposed breeds:\n• Cavalier King Charles Spaniel (50% by age 5)\n• Poodle, Chihuahua, Maltese, Yorkshire\n• Schnauzer, Pomeranian\n\n✓ Pathophys: chronic valve degeneration → mitral regurgitation → LA enlarge → pulmonary edema → CHF\n\n💡 Auscultation: systolic murmur left apex (PMI of MV)\n💡 Stage B2 (asymptomatic but enlarged) → start pimobendan',
    verified: 'resp-cv-er 1 hr.pdf, COM III Final 86' },

  { id: 1370, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'COM III Final 86',
    tags: ['oxygen-supplementation', 'flow-rate'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'วิธีการให้ออกซิเจนกับสัตว์ป่วยข้อใดต้องการ flow rate น้อยที่สุด เพื่อให้ FiO2 ที่เพียงพอ',
    options: [
      'Oxygen cage (sealed environment, retain O2; flow 0.5-2 L/min ก็พอ)',
      'Intranasal cannula (semi-controlled; ต้องให้ flow 1-3 L/min เพื่อ FiO2 30-50%)',
      'E-collar oxygen canopy (semi-sealed; ต้องการ flow 5-10 L/min)',
      '(Fit) face mask (ใช้ flow 5-10 L/min เพื่อ FiO2 50-80%)',
      'Flow-by oxygen (ลม blow ใกล้จมูก; ต้อง flow 2-5 L/min และ FiO2 ต่ำสุด)',
    ],
    answer: 0, explain: 'Oxygen cage = sealed system → ออกซิเจนสะสมในกรง → ใช้ flow น้อยสุดยังคง FiO2 30-50%\n\n✓ ลำดับ flow rate ที่ต้องการ (น้อย → มาก):\n1. Oxygen cage (0.5-2 L/min)\n2. Intranasal cannula (1-3 L/min)\n3. Face mask (5-10 L/min)\n4. E-collar canopy (5-10 L/min)\n5. Flow-by (2-5 L/min, แต่ FiO2 ต่ำสุดเพราะกระจายไปกับอากาศ)\n\n💡 Flow-by ใช้ชั่วคราว stabilize ก่อนหา definitive method',
    verified: 'resp-cv-er 1 hr.pdf, COM III Final 86' },

  { id: 1371, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'COM III Final 86',
    tags: ['fluid-calculation', 'dehydration'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'แมวเพศผู้ 4 กก. ขาดน้ำ 7%, ต้องการแก้ deficit ใน 4 ชม. + maintenance 8 ml/hr, IV rate ที่ตั้งคือ',
    options: [
      '68 ml/hr (deficit ÷ 4 + half maintenance — calculation off)',
      '78 ml/hr (deficit 280 ml ÷ 4 hr = 70 + maintenance 8 = 78 ml/hr)',
      '88 ml/hr (deficit หน่วยผิดเป็น × 1.1 — over-estimate)',
      '98 ml/hr (deficit ÷ 3 + maint = wrong time interval)',
      '108 ml/hr (deficit ÷ 2 + maint = ทำใน 2 hr — เร็วเกินไป)',
    ],
    answer: 1, explain: 'สูตรคำนวณ:\n• Deficit (ml) = BW (kg) × % dehydration × 1000\n  = 4 × 0.07 × 1000 = 280 ml\n• Deficit rate = deficit ÷ time = 280 ÷ 4 = 70 ml/hr\n• Total IV rate = deficit rate + maintenance\n  = 70 + 8 = 78 ml/hr\n\n💡 Tips ป้องกัน volume overload:\n• แมวระวังกว่าหมา (heart smaller)\n• Recheck PCV/TP, lung sound ทุก 1-2 hr\n• ปรับลดลงเมื่อ rehydrated',
    verified: 'fluid therapy 1 hr.pdf, COM III Final 86' },
  ...
  { id: 1372, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'COM III Final 86',
    ...
    options: [
      ...
      'ส่งผ่าตัด exploratory laparotomy ทันที โดยไม่ stabilize ก่อน (รีบเกินไป)',
      'ทำ AFAST ทันทีเพื่อยืนยันมี free abdominal effusion (rapid bedside imaging)',
      'ทำ abdominocentesis + ตรวจ K + creatinine (fluid:serum ratio วินิจฉัย)',
    ],
    answer: 2, explain: 'Uroabdomen ผ่าตัดทันทีเป็นการผิด — ต้อง stabilize ก่อน:\n1. Drain abdomen (peritoneal catheter / abdominocentesis)\n2. Correct hyperkalemia (Ca gluconate, insulin+dextrose, NaHCO3)\n3. IV fluid (normal saline ลด K, แก้ acidosis)\n4. Recheck K, ECG\n5. แล้วจึงผ่าตัด anesthesia (เมื่อ K < 6 mEq/L)\n\n✓ วินิจฉัย: K ใน fluid > serum > 1.4× หรือ creatinine fluid > serum > 2×\n\n💡 ผ่าตัดก่อน stabilize → cardiac arrest ใต้ anesthesia',
    verified: 'metabolic and endocrine and UT 1 hr.pdf, COM III Final 86' },

  { id: 1373, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'COM III Final 86',
    tags: ['dka', 'cerebral-edema', 'mechanism'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'ทำไม insulin ในการรักษา DKA จึงทำให้เกิดภาวะ brain edema ได้',
    options: [
      'Insulin กระตุ้น Na/K ATPase pump → Na ไหลเข้า neuron พร้อมน้ำตาม Na',
      'Insulin กระตุ้นให้ neuron บวมโดยตรงจาก action mechanism ของ insulin',
      'Ketone bodies ลด osmolality ของพลาสมาเร็ว → น้ำ osmosis เข้า neuron',
      'ระดับน้ำตาลในเลือดลดเร็วเกินไป → osmolality พลาสมาตก → น้ำเข้า neuron',
      'การให้ fluid resuscitation มากเกินไปจาก correct hypovolemia → fluid shift',
    ],
    answer: 3, explain: 'Cerebral edema ใน DKA treatment เป็น complication ที่กลัวที่สุด:\n\n• ก่อนรักษา: brain neurons สร้าง "idiogenic osmoles" เพื่อต้านน้ำที่จะดึงออก (เพราะ plasma osmolality สูง จาก hyperglycemia)\n• ลด BG เร็วเกินไป → plasma osmolality drop fast → idiogenic osmoles ใน neuron ยังเหลืออยู่ → น้ำ osmosis เข้า neuron → cerebral edema\n\n✓ ป้องกัน:\n• ลด BG ช้าๆ: 50-100 mg/dL/hr\n• ใช้ regular insulin CRI (0.05-0.1 U/kg/hr)\n• Switch fluid → 5% dextrose เมื่อ BG < 250',
    verified: 'metabolic and endocrine and UT 1 hr.pdf, COM III Final 86' },

  { id: 1374, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'COM III Final 86',
    tags: ['dka', 'priority', 'volume-resuscitation'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'การรักษา DKA ที่มี severe metabolic acidosis, ขั้นแรกที่สำคัญที่สุดคือข้อใด',
    options: [
      'Insulin supplementation (regular insulin CRI 0.05-0.1 U/kg/hr ลด BG)',
      'Mannitol administration เพื่อลด cerebral edema (preventive)',
      'Acid-base correction (sodium bicarbonate IV แก้ severe acidosis)',
      'Correction of electrolyte imbalance (K, P, Mg ก่อน insulin start)',
      'Volume resuscitation (IV crystalloid restore perfusion ก่อนให้ insulin)',
    ],
    answer: 4, explain: 'ลำดับการรักษา DKA (priority):\n1. Volume resuscitation — restore perfusion (ส่วนใหญ่ severe dehydration 8-10%)\n2. Correct K (เช็คก่อน insulin — insulin ดึง K เข้า cell → hypoK)\n3. Insulin CRI start (หลัง K > 3.5 mEq/L)\n4. Monitor BG q1-2 hr, switch to dextrose เมื่อ BG < 250\n5. Address acid-base (มักแก้เอง when fluid + insulin)\n\n✗ NaHCO3 ไม่จำเป็นปกติ — insulin + fluid แก้ acidosis เอง\n\n💡 "Fluid before insulin" = motto ของ DKA management',
    verified: 'metabolic and endocrine and UT 1 hr.pdf, COM III Final 86' },

  { id: 1375, subject: 'com3', topic: 'nutrition', year: 4, source: 'COM III Final 86',
    tags: ['rer', 'calculation'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'RER (resting energy requirement) ของสุนัขน้ำหนัก 20 กก. ใกล้เคียงข้อใดมากที่สุด',
    options: [
      '660 kcal (คำนวณ 70 × 20^0.75 ≈ 660 หรือ shortcut 30×BW+70 = 670)',
      '360 kcal (under-estimate — น้อยกว่าครึ่งของค่าจริง)',
      '460 kcal (ใกล้แต่ยัง under — ต่ำกว่าจริงประมาณ 30%)',
      '560 kcal (under-estimate — ขาดไปประมาณ 100 kcal)',
      '760 kcal (over-estimate — เกินจริงประมาณ 100 kcal)',
    ],
    answer: 0, explain: 'RER formula:\n• Standard: RER = 70 × BW(kg)^0.75\n• Linear shortcut (สำหรับ 2-30 kg): RER = (30 × BW) + 70\n\n✓ คำนวณสำหรับ 20 kg dog:\n• Standard: 70 × 20^0.75 = 70 × 9.46 = 662 kcal\n• Linear: (30 × 20) + 70 = 670 kcal\n\n💡 Tips:\n• ใช้ RER สำหรับ critically ill (ไม่ใส่ illness factor)\n• Reach RER ใน 2-3 วัน (start 1/3, ↑ ทีละ 25-33%)\n• Maintenance Energy = RER × factor (1.4-1.8 ปกติ, 1.0-1.2 ป่วย)',
    verified: 'nutrition 1 hr.pdf, COM III Final 86' },

  { id: 1376, subject: 'com3', topic: 'nutrition', year: 4, source: 'COM III Final 86',
    tags: ['stress-starvation', 'metabolism'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'Underlying mechanism ใดที่พบใน stress starvation แต่ ไม่พบ ใน simple starvation',
    options: [
      'Insulin (ลดในทั้ง 2 ภาวะ — ลดมากกว่าใน simple starvation)',
      'Inflammatory cytokines (TNF-α, IL-1, IL-6 — จาก disease/sepsis เท่านั้น)',
      'Thyroid hormone (ลดในทั้ง 2 — euthyroid sick syndrome)',
      'Glucagon (เพิ่มในทั้ง 2 — gluconeogenesis stimulus)',
      'Glucocorticoid (เพิ่มในทั้ง 2 ภาวะ — stress response)',
    ],
    answer: 1, explain: 'ความแตกต่างหลักของ stress vs simple starvation:\n\n✓ Simple starvation (อด แต่ไม่ป่วย):\n• Body adapt: ↓ metabolic rate, ใช้ ketone\n• Spare protein, ใช้ fat เป็นหลัก\n• ↓ insulin, ↑ glucagon\n\n✓ Stress starvation (ป่วย + อด):\n• Inflammatory cytokines (TNF, IL-1, IL-6) ขับเคลื่อน\n• Hypermetabolism + protein catabolism (muscle wasting)\n• Insulin resistance + hyperglycemia\n• ใช้ amino acid → gluconeogenesis (ไม่ spare protein)\n\n💡 → "ป่วยแล้วขาดอาหาร" muscle ลดเร็วมาก ต้อง early enteral nutrition',
    verified: 'nutrition 1 hr.pdf, COM III Final 86' },

  { id: 1377, subject: 'com3', topic: 'nutrition', year: 4, source: 'COM III Final 86',
    tags: ['refeeding-syndrome', 'prevention'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'การป้องกัน refeeding syndrome ในสัตว์ที่อดอาหารมานาน, ข้อใดเป็นแนวทางที่ถูก',
    options: [
      'ให้ motility modifier (metoclopramide) ก่อนป้อนอาหาร 30 นาที',
      'ให้ prophylactic antibiotic ก่อนการป้อนอาหาร 24 ชม.',
      'เริ่มที่ 1/3-1/4 ของ RER แล้วเพิ่ม calorie ทีละน้อยใน 3-5 วัน',
      'ให้ antacid + acid suppressor 30-60 นาที ก่อนเริ่มอาหาร',
      'เริ่มจาก liquid → semisolid → solid ตามลำดับเวลา',
    ],
    answer: 2, explain: 'Refeeding syndrome เกิดจาก rapid carbohydrate intake → insulin surge → P/K/Mg shift เข้า cell → severe hypoP, hypoK, hypoMg → cardiac arrhythmia, muscle weakness, hemolysis\n\n✓ Prevention:\n• Start LOW: 1/3-1/4 ของ RER ใน Day 1\n• ↑ ทีละ 25% ต่อวันจนถึง full RER (Day 3-5)\n• ตรวจ P, K, Mg ก่อนและระหว่าง refeed (q12-24 hr ใน 3 วันแรก)\n• Supplement หากต่ำ: K-phosphate IV\n\n💡 At-risk: anorexia > 5 วัน, hepatic lipidosis cat, chronic disease, severe weight loss\n\n💡 Watch: weakness, GI signs, ataxia, hemolysis = refeeding signs',
    verified: 'nutrition 1 hr.pdf, COM III Final 86' },

  { id: 1378, subject: 'com3', topic: 'seizure', year: 4, source: 'COM III Final 86',
    tags: ['idiopathic-epilepsy', 'age-onset'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'ช่วงอายุที่บ่งชี้ว่าสุนัขเป็น idiopathic epilepsy คือช่วงใด',
    options: [
      '0-6 เดือน (มัก extracranial: hypoglycemia, congenital, toxic)',
      '10-16 ปี (geriatric: brain tumor, metabolic disease)',
      'มากกว่า 16 ปี (rare onset; ต้อง full workup ทุก ราย)',
      '6 เดือน - 6 ปี (typical onset ของ idiopathic epilepsy ใน dog)',
      '6-10 ปี (older onset → secondary structural disease, brain tumor)',
    ],
    answer: 3, explain: 'Idiopathic epilepsy = inherited / unknown cause, no structural lesion, classic age 6 mo - 6 yr\n\n✓ ลำดับ DDx ตามอายุ:\n• < 6 mo: hypoglycemia, congenital (lissencephaly, hydrocephalus), toxin, infection\n• 6 mo - 6 yr: idiopathic epilepsy (most likely)\n• > 6 yr: brain tumor (meningioma > glioma), metabolic (hepatic encephalopathy), CVA\n\n💡 Diagnostic criteria (Tier 1):\n1. ≥ 2 unprovoked seizures > 24 hr apart\n2. Age 6 mo - 6 yr at onset\n3. Normal interictal exam, normal CBC/chem/UA\n\n💡 Tier 2/3: MRI + CSF normal, no structural lesion',
    verified: 'seizure 1 hr.pdf, COM III Final 86' },

  { id: 1379, subject: 'com3', topic: 'seizure', year: 4, source: 'COM III Final 86',
    tags: ['phenobarbital', 'first-line', 'aed'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'ยาในข้อใดเป็น antiepileptic drug (AED) first-line สำหรับ maintenance phase ในสุนัข',
    options: [
      'Pentobarbital (anesthesia drug — refractory status epilepticus เท่านั้น)',
      'Diazepam (acute rescue / status — short half-life ใช้ maintenance ไม่ได้)',
      'Levetiracetam (alternative ใน hepatic dz; faster steady-state)',
      'Gabapentin (neuropathic pain & adjunct AED — ไม่ใช่ first-line monotherapy)',
      'Phenobarbital (first-line maintenance ใน dog; effective + economical)',
    ],
    answer: 4, explain: 'Phenobarbital = AED first-line สำหรับ maintenance ในสุนัข (>50 ปีที่ใช้กันมา)\n\n✓ Dosing:\n• Start 2-3 mg/kg PO BID\n• Trough level target 25-35 µg/ml (week 2)\n• Increase q14-21 d ตาม level\n\n✓ Side effects:\n• Sedation, PU/PD/polyphagia (early, มักดีขึ้น)\n• Hepatotoxicity (long-term — monitor ALP/ALT)\n• Bone marrow suppression (rare)\n\n✓ Alternatives:\n• Levetiracetam (Keppra) — แมว, hepatic dz, breakthrough\n• Zonisamide — ทุกชนิด, less hepatotoxic\n• KBr — adjunct สุนัขที่ refractory phenobarb\n\n💡 Diazepam ใช้ rescue (rectal/IN) เท่านั้น — short t1/2 + tolerance',
    verified: 'seizure 1 hr.pdf, COM III Final 86' },
  ...
  { id: 1380, subject: 'com3', topic: 'seizure', year: 4, source: 'COM III Final 86',
    ...
    options: [
      ...
      'Ionized calcium (extracranial — eclampsia, hypocalcemic tetany)',
      'Blood glucose level (extracranial — hypoglycemia, insulinoma)',
      'BUN / creatinine (extracranial — uremic encephalopathy, AKI)',
    ],
    answer: 0, explain: 'Extracranial causes ของ seizure = systemic / metabolic ที่ไม่ใช่ภาวะของสมองโดยตรง:\n\n✓ Common extracranial causes:\n• Hypoglycemia (insulinoma, sepsis, neonate)\n• Hepatic encephalopathy (PSS, cirrhosis)\n• Uremic encephalopathy (AKI, CKD end-stage)\n• Hypocalcemia (eclampsia, hypoparathyroid)\n• Toxin (organophosphate, lead, ethylene glycol)\n• Hyperthermia / heatstroke\n\n✗ Serum AED level → ใช้ติดตาม compliance + adjust dose ใน epilepsy ที่ diagnose แล้ว — ไม่ rule out cause\n\n💡 Workup order: PE + history → CBC/chem/UA → MRI/CSF (intracranial)',
    verified: 'seizure 1 hr.pdf, COM III Final 86' },

  { id: 1381, subject: 'com3', topic: 'neuro-er', year: 4, source: 'COM III Final 86',
    tags: ['cranial-nerve', 'tympanic-bulla'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'เส้นประสาทสมองคู่ใด เมื่อมี otitis / tumor ใน tympanic bulla มักโดนผลกระทบ พร้อมกับ CN VIII',
    options: [
      'Trigeminal (CN V — face sensation; ไม่ผ่าน tympanic bulla)',
      'Facial (CN VII — เส้นทางเดินผ่าน tympanic cavity ใกล้ middle ear)',
      'Glossopharyngeal (CN IX — pharynx; ไม่ผ่าน middle ear)',
      'Vagus (CN X — ออกจาก jugular foramen ห่างจาก bulla)',
      'Abducens (CN VI — eye movement; อยู่ใน cavernous sinus)',
    ],
    answer: 1, explain: 'CN VII (facial nerve) ผ่าน petrous temporal bone + middle ear → เมื่อมี otitis media/interna หรือ tumor ใน bulla → CN VII palsy พร้อมกับ vestibulocochlear (CN VIII) deficits\n\n✓ Clinical signs ของ middle ear involvement:\n• Head tilt (CN VIII — peripheral vestibular)\n• Facial paralysis ipsilateral (CN VII):\n  - lip droop\n  - ear droop\n  - inability to blink\n  - deviation of nose\n• Horner\'s syndrome ipsilateral (sympathetic ผ่านใกล้ middle ear)\n• Hearing loss (CN VIII)\n\n💡 รักษา: long-term antibiotic + คุม otitis / surgical drain ถ้ามี mass',
    verified: 'neuro-exam 1 hr.pdf, COM III Final 86' },

  { id: 1382, subject: 'com3', topic: 'neuro-er', year: 4, source: 'COM III Final 86',
    tags: ['tbi', 'cushing-response', 'icp'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'Cushing response ใน TBI (traumatic brain injury) ตาม criteria ที่ถูกต้องคือ',
    options: [
      'Hypotension + bradycardia + decreased ICP (ตรงข้ามกับ pattern จริง)',
      'Hypertension + tachycardia + increased ICP (HR ผิด — ปกติช้าลง)',
      'Hypertension + bradycardia + increased ICP (Cushing\'s triad classic)',
      'Hypotension + bradycardia + increased ICP (BP ผิด — ปกติสูงขึ้น)',
      'Hypotension + tachycardia + increased ICP (Cushing pattern ตรงข้าม)',
    ],
    answer: 2, explain: 'Cushing\'s triad = late sign of severe ↑ ICP / impending herniation:\n\n1. Hypertension (systolic ↑) — sympathetic surge ตอบสนอง brain ischemia\n2. Bradycardia (HR ↓) — baroreflex จาก hypertension activate vagus\n3. Irregular respiration / Cheyne-Stokes — brainstem compression\n\n✓ Pathophys:\n• ↑ ICP → ↓ cerebral perfusion pressure (CPP = MAP - ICP)\n• Brain ischemia → sympathetic ↑ BP เพื่อ maintain CPP\n• ↑ BP → baroreflex → bradycardia\n• Brainstem compression → irregular respiration\n\n💡 Cushing = ใกล้ herniation → emergency:\n• Hyperventilate (PaCO2 30-35)\n• Mannitol 0.5-1 g/kg IV\n• Head elevation 30°\n• Avoid hypoxia/hypotension',
    verified: 'TBI 1 hr.pdf, COM III Final 86' },
  ...
  { id: 1383, subject: 'com3', topic: 'neuro-er', year: 4, source: 'COM III Final 86',
    ...
    options: [
      ...
      'Hypoxia + hypoperfusion (systemic insult ทำให้ neuron ตายเพิ่ม)',
      'Diffuse axonal injury (mechanical shear at moment of impact — PRIMARY)',
      'Excitotoxicity (NMDA receptor over-activation จาก glutamate release)',
    ],
    answer: 3, explain: 'TBI damage แบ่งเป็น 2 phase:\n\n✓ PRIMARY damage = เกิดที่ moment of injury, irreversible:\n• Skull fracture / contusion\n• Brain laceration\n• Diffuse axonal injury (DAI) ← classic primary\n• Direct hemorrhage from vessel rupture\n\n✓ SECONDARY damage = develop ใน minutes-days, preventable:\n• Cerebral edema (cytotoxic + vasogenic)\n• ↑ ICP → ↓ CPP\n• Hypoxia / hypoperfusion (systemic shock)\n• Excitotoxicity (glutamate, Ca²⁺ influx)\n• Inflammatory cascade (cytokine, free radical)\n• Hypoglycemia, hyperthermia, seizure\n\n💡 Goal of treatment = "prevent secondary damage" — ABCDs management',
    verified: 'TBI 1 hr.pdf, COM III Final 86' },
  ...
  { id: 1384, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'COM III Final 86',
    ...
    options: [
      ...
      'Rotary nystagmus (peripheral common; central ก็พบ)',
      'Alert mentation (peripheral มัก preserve; central อาจ obtund)',
      'Positional / vertical nystagmus (CENTRAL specific — ไม่พบใน peripheral)',
    ],
    answer: 4, explain: 'Central vs Peripheral vestibular disorder:\n\n✓ CENTRAL vestibular signs (suggest brainstem/cerebellum lesion):\n• Vertical nystagmus ← classic central\n• Positional / change-direction nystagmus ← classic central\n• Mentation change (obtund, depressed)\n• Other CN deficits (CN V, VII, IX, X, XII)\n• Postural reaction deficit (CP) ipsilateral\n• Paradoxical signs (head tilt opposite from lesion)\n\n✓ PERIPHERAL vestibular (inner ear, CN VIII):\n• Horizontal / rotary nystagmus (fast phase AWAY from lesion)\n• Alert mentation\n• ± CN VII palsy (Horner) ถ้า middle ear involve\n• Head tilt towards lesion\n• No CP deficit\n\n💡 Vertical nystagmus = central until proven otherwise',
    verified: 'vestibular 1 hr.pdf, COM III Final 86' },
  ...
  { id: 1385, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'COM III Final 86',
    ...
    options: [
      ...
      'Right rolling (กลิ้งไปทาง affected side คือขวา)',
      'Right tight circling (เดินวงกลมเล็กๆ ไปทาง lesion ขวา)',
      'Right head tilt (ทาง affected side — เอียงไปทาง lesion ขวา)',
    ],
    answer: 0, explain: 'Vestibular nystagmus rule: fast phase จะชี้ไปทางตรงข้ามของ lesion\n\n✓ ถ้า lesion อยู่ ทางขวา:\n• Head tilt: ขวา (ipsilateral) ✓\n• Strabismus ventrolateral: ขวา (ipsilateral) ✓\n• Rolling: ขวา (ipsilateral) ✓\n• Circling: ขวา tight (ipsilateral) ✓\n• Nystagmus fast phase: ซ้าย (CONTRALATERAL)\n• ดังนั้น "Right horizontal nystagmus" = ผิด!\n\n✗ Paradoxical central vestibular = exception → head tilt จะอยู่ contralateral to lesion (cerebellar peduncle / flocculonodular lobe)\n\n💡 Mnemonic: "Slow-phase TOWARDS, fast-phase AWAY" — เพราะ vestibular drive หาย → ตา drift ช้าๆ ไปข้างที่หาย แล้ว corrective fast phase กลับมา',
    verified: 'vestibular 1 hr.pdf, COM III Final 86' },

  { id: 1386, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'COM III Final 86',
    tags: ['vestibular', 'anatomy', 'detector'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'อวัยวะใดเป็น balance detector หลักของระบบ vestibular',
    options: [
      'Organs of Corti (cochlea — sound transduction, ไม่ใช่ balance)',
      'Semicircular canals (3 ระนาบ — ตอบสนอง angular acceleration)',
      'Tympanic bullae (osseous capsule รอบ middle ear — ไม่ตรวจจับการเคลื่อน)',
      'Incus / Malleus / Stapes (auditory ossicles — sound conduction)',
      'Vomeronasal organs (Jacobson — pheromone/smell receptor)',
    ],
    answer: 1, explain: 'Semicircular canals (3 อัน — anterior, posterior, lateral) ตอบสนอง angular acceleration\n\n✓ Vestibular apparatus 2 ส่วนหลัก:\n• Semicircular canals (3): detect angular acceleration / rotation\n• Otolith organs (utricle + saccule): detect linear acceleration + gravity\n\n✓ Pathway: hair cells → vestibular nerve (CN VIII) → vestibular nuclei (medulla) → cerebellum / spinal cord / oculomotor nuclei\n\n✗ Organs of Corti (cochlea) = hearing\n✗ Ossicles (malleus/incus/stapes) = sound conduction\n✗ Vomeronasal = pheromone (cat — flehmen response)\n\n💡 Damage to semicircular canals → spinning sensation, rotary nystagmus, head tilt',
    verified: 'vestibular 1 hr.pdf, COM III Final 86' },

  { id: 1387, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'COM III Final 86',
    tags: ['white-shaker-syndrome', 'tremor'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'White shaker syndrome ในสุนัข เกิดจากความผิดปกติใดในสมอง',
    options: [
      'Seizure focus + abnormal EEG discharge (ผิดประเภท — ไม่ใช่ seizure)',
      'Imbalance of neurotransmitters (depression-like state — ไม่ใช่ pathology)',
      'Non-suppurative meningoencephalitis (idiopathic CNS inflammation, T-cell)',
      'Lysosomal storage disorder (genetic enzyme deficiency — ผิดประเภท)',
      'Global ischemic hypoxia (cardiac arrest sequela — acute event)',
    ],
    answer: 2, explain: 'White shaker syndrome (= little white shakers, generalized tremor syndrome):\n\n✓ Pathology: non-suppurative (lymphocytic) meningoencephalitis — idiopathic immune-mediated\n\n✓ Signalment: small breed white dog\n• Maltese, West Highland White Terrier\n• Bichon Frise, Poodle (toy)\n• Age 1-5 yr usual onset\n\n✓ Clinical signs:\n• Generalized whole-body tremor\n• Worsen with stress/excitement, ลดเมื่อ rest\n• ± cerebellar signs (intention tremor, ataxia)\n• Mentation normal\n\n✓ Treatment:\n• Prednisone 1-2 mg/kg/day → taper over 3-6 mo\n• ± Diazepam acute calm\n• Most respond well, may need long-term low-dose pred\n\n💡 ไม่ใช่ epilepsy — ไม่มี LOC, mentation ปกติ',
    verified: 'tremor 1 hr.pdf, COM III Final 86' },

  { id: 1388, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'COM III Final 86',
    tags: ['cerebellar', 'abiotrophy', 'progressive'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'ลูกแมวอายุ 2 ปี cerebellar ataxia + intention tremor + dysmetria, กลุ่ม 6 ตัวมีอาการเดียวกัน, มาจาก kennel เดียวกัน, วินิจฉัย',
    options: [
      'Cerebellar trauma (acute injury — ไม่ explain cluster of cases)',
      'FeLV-induced cerebellar degeneration (in utero infection, congenital onset)',
      'Cerebellar infarction (acute event, ไม่ progressive)',
      'Cerebellar abiotrophy (genetic, progressive degeneration หลัง birth)',
      'Cerebellar hypoplasia (congenital — non-progressive, present at birth)',
    ],
    answer: 3, explain: 'Cerebellar abiotrophy = inherited progressive degeneration ของ Purkinje cells (cerebellar cortex):\n\n✓ Onset: หลัง birth (cerebellum normal at birth) → progressive\n• Some breeds: 6-12 wk onset\n• Cluster cases ใน kennel = inherited\n\n✓ Clinical signs (cerebellar ataxia):\n• Dysmetria (hypermetria / goose-stepping)\n• Intention tremor (head, voluntary movements)\n• Wide-based stance\n• Truncal sway\n• Mentation NORMAL\n• No CP deficit (PROPRIOCEPTION normal)\n\n✗ Cerebellar hypoplasia = present at birth, NOT progressive (FPV in utero infection in cat → "wobbly kitten")\n\n✗ FeLV-induced typically congenital + non-progressive\n\n💡 Definitive dx: histopath (Purkinje cell loss)',
    verified: 'ataxia 1 hr.pdf, COM III Final 86' },

  { id: 1389, subject: 'com3', topic: 'spinal', year: 4, source: 'COM III Final 86',
    tags: ['wobbler', 'ccsm', 'large-breed'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'ชื่ออีกชื่อหนึ่งของโรค Wobbler syndrome ในสุนัขพันธุ์ใหญ่คือ',
    options: [
      'Caudal Equine Syndrome (= Cauda Equina; lumbosacral region — ผิดตำแหน่ง)',
      'Cranial Cruciate Ligament Rupture (orthopedic — ไม่ใช่ spinal)',
      'Degenerative Lumbosacral Stenosis (= Cauda Equina, LS region — ผิดตำแหน่ง)',
      'Osteochondritis dissecans of LS junction (focal, OCD — ผิดประเภท)',
      'Caudal Cervical Spondylopathy (CCSM — cervical instability/compression)',
    ],
    answer: 4, explain: 'Wobbler syndrome = Caudal Cervical Spondylomyelopathy (CCSM) = cervical vertebral instability or static stenosis ที่ caudal cervical spine (C5-C7)\n\n✓ Two main types:\n• Disc-associated (DA-CCSM) — Doberman, middle-aged\n• Osseous-associated (OA-CCSM) — Great Dane, young\n\n✓ Predisposed breeds:\n• Doberman Pinscher (#1)\n• Great Dane\n• Mastiff, Rottweiler\n\n✓ Clinical signs:\n• "Wobbly" gait (proprioceptive ataxia)\n• Tetraparesis (hindlimb worse than forelimb early)\n• Neck pain (some cases)\n• 2-engine gait: spastic HL + short-strided FL\n\n✓ Diagnosis: MRI cervical (gold standard)\n💡 Cauda equina syndrome = Degenerative LS stenosis — different region (LS junction)',
    verified: 'spinal 1 hr.pdf, COM III Final 86' },

  { id: 1390, subject: 'com3', topic: 'spinal', year: 4, source: 'COM III Final 86',
    tags: ['ivdd', 'hansen-type-1', 'chondrodystrophic'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'Hansen Type I IVDD (acute extrusion ของ nucleus pulposus) มักเกิดในสุนัขพันธุ์ใด',
    options: [
      'Dachshund + Basset Hound (chondrodystrophic — disc calcify เร็ว, extrude ฉับพลัน)',
      'Pomeranian + Chihuahua (toy breed — IVDD พบน้อยกว่า; รูปร่าง normal)',
      'Bull Terrier + Bulldog (brachycephalic but not chondrodystrophic)',
      'Cocker Spaniel + Collie (medium breed — Hansen Type II พบบ่อยกว่า)',
      'Great Dane + Doberman Pinscher (large breed — เป็น Wobbler / DLSS แทน)',
    ],
    answer: 0, explain: 'Hansen classification ของ IVDD:\n\n✓ Type I (acute extrusion) = chondrodystrophic breeds:\n• Dachshund (#1, lifetime risk 19-24%)\n• Pekingese, Shih Tzu, Lhasa Apso\n• Beagle, Basset Hound\n• French Bulldog, Corgi\n• Cocker Spaniel\n• Pathology: disc calcify ตั้งแต่ <1 ปี → annulus crack → nucleus extrude เข้า canal\n• Onset: acute (sec-hours), severe pain, paresis-paralysis\n• Site: T11-L3 (60-65%) > cervical (15-20%)\n\n✓ Type II (chronic protrusion) = non-chondrodystrophic:\n• German Shepherd, Doberman, Labrador\n• Onset: chronic, progressive\n• Site: lumbosacral common\n\n💡 Type I → emergency, surgical decompression ดีที่สุดถ้า deep pain absent < 48 hr',
    verified: 'spinal 1 hr.pdf, COM III Final 86' },

  { id: 1391, subject: 'com3', topic: 'spinal', year: 4, source: 'COM III Final 86',
    tags: ['gsd', 'paraplegia', 'ivdd-type-i'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'GSD 3 ปี, sudden posterior paraplegia, deep pain (+), UMN reflex hindlimb, diagnosis ที่น่าจะเป็น',
    options: [
      'Coxofemoral osteoarthritis (chronic onset, ไม่ paraplegia, hip pain เด่น)',
      'Intervertebral disk disease type I (sudden onset, T3-L3 sign, deep pain (+))',
      'Vertebral fracture (ต้องมี trauma history; sudden but trauma-related)',
      'Brain tumor (mentation change + cranial nerve deficit; ไม่เลือก lower body)',
      'Cauda Equina Syndrome / DLSS (chronic, LMN sign, urinary incontinence)',
    ],
    answer: 1, explain: 'GSD 3 yr + sudden paraplegia + DP intact + UMN sign hindlimb = T3-L3 lesion (UMN to HL)\n\n✓ Most likely: IVDD Type I (acute extrusion):\n• Sudden onset (sec-hours)\n• T11-L3 most common\n• UMN sign hindlimb (hyperreflexia, spasticity)\n• DP retained → grade 4 (good prognosis)\n\n✓ DDx ที่ต้องตัด:\n• FCE (fibrocartilaginous embolic myelopathy):\n  - Acute, non-painful, lateralize, often non-progressive after 24 hr\n  - GSD/Lab common\n• Trauma (need history)\n• ANNPE (acute non-compressive nucleus pulposus extrusion)\n\n✓ Diagnosis: MRI gold standard\n✓ Treatment: Decompressive surgery (hemilaminectomy)\n\n💡 GSD ไม่ใช่ chondrodystrophic แต่ IVDD type I ก็พบได้ที่ thoracolumbar',
    verified: 'spinal 1 hr.pdf, COM III Final 86' },

  { id: 1392, subject: 'com3', topic: 'er-anes', year: 4, source: 'COM III Final 86',
    tags: ['analgesia', 'shock', 'opioid'], type: 'mcq', examOrigin: 'COM III Final 86',
    q: 'สัตว์ป่วย acute abdomen + hypovolemic / septic shock, ยาในข้อใด ควรเลือก ใช้ลดปวดมากที่สุด',
    options: [
      'Tolfenamic acid (NSAID — ห้ามใน shock เพราะ ↓ renal perfusion → AKI)',
      'Lidocaine CRI (local; high-dose CV depression; OK adjuvant แต่ไม่ first-line)',
      'Fentanyl (mu agonist — minimal CV effect, fast-onset, titratable, opioid first-line)',
      'Morphine (releases histamine → vasodilation + hypotension ใน shock)',
      'Ketamine (sympathomimetic; OK adjunct แต่ caution monotherapy ใน shock)',
    ],
  ...
  // ─── com3-mid additions (auto-injected) ───
  // Source: tmp/y4-patches/com3-mid.json — built 2026-05-17
  // 30 Qs · IDs 94100-94129
  {"id":94100,"subject":"com3","topic":"cornea","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","fluorescein","ophthal-exam"],"type":"mcq","q":"ผล fluorescein stain ที่บวก (+ve) บอกถึงความเสียหายของชั้นใดใน cornea","options":["Epithelium อย่างเดียว — เพราะ fluorescein ติด epithelium ปกติ","Stroma — เพราะ fluorescein เป็น hydrophilic จะติด stroma เมื่อ epithelium หลุด","Descemet's membrane — เพราะเป็นชั้นในสุด ติดสีเข้มกว่า","Endothelium — เพราะมี cell ชั้นเดียวรับสีได้ดี"],"answer":1,"explain":"Fluorescein = hydrophilic dye → ไม่ติด epithelium ปกติ (มี lipid layer) แต่ติด stroma (hydrophilic collagen) เมื่อ epithelium หลุด → +ve = stromal corneal ulcer\n\n✗ ทำไมข้ออื่นผิด:\n— Epithelium ปกติ = lipid → repel fluorescein\n— Descemet's แตก (Descemetocoele) = central area ไม่ติดสี รอบๆติด (donut sign) — emergency!\n— Endothelium อยู่ลึก เข้าไม่ถึงด้วย topical dye\n\n💡 Seidel test = fluorescein เข้มข้น → ถ้า aqueous leak จะเห็น stream สีเขียวจาก perforation","verified":"Aj. Nalinee Q1 + cornea notes p.4 (Kim TJ86 cheat-sheet single source)"},
  {"id":94101,"subject":"com3","topic":"cornea","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","deep-keratitis","vascularization"],"type":"mcq","q":"Deep corneal vascularization (เส้นเลือดสีแดงเข้ม สั้น เริ่มจาก corneal limbus) บ่งบอกพยาธิสภาพแบบใด","options":["Superficial keratitis อย่างเดียว","Conjunctivitis เท่านั้น","Deep keratitis ± anterior uveitis (รอยโรคลึกถึง stroma หรือลึกกว่า)","Allergic reaction ของเยื่อบุตาเท่านั้น"],"answer":2,"explain":"Cornea ปกติไม่มีหลอดเลือด → vascularization เกิดเมื่อ cornea ได้รับความเสียหาย\n— Superficial vsl. = แตกแขนงเป็น tree-like, สีแดงส้ม, ยาว, มาจาก conjunctiva → superficial lesion\n— Deep vsl. = สั้น, แดงเข้ม, ตรง (brush-border), เริ่มที่ corneal limbus → deep lesion (stroma ลึก) เช่น deep keratitis + anterior uveitis\n\n💡 ดูแบบ vsl. ก็พอบอก depth ของ pathology ได้ก่อน fluorescein","verified":"Aj. Nalinee Q2 + cornea notes p.4 (Kim TJ86 cheat-sheet single source)"},
  {"id":94102,"subject":"com3","topic":"uveitis","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","feline-uveitis","herpes"],"type":"mcq","q":"รอยโรค dendritic keratitis (กิ่งก้านคล้ายต้นไม้) ใน feline เป็นลักษณะ pathognomonic ของโรคใด","options":["Feline calicivirus","Feline herpes viral keratitis (FHV-1)","Feline coronavirus","Feline chlamydophila"],"answer":1,"explain":"Feline herpesvirus-1 (FHV-1) → dendritic ulcer (กิ่งก้านสาขา) ติด fluorescein → pathognomonic ของ acute FHV keratitis\nTx: systemic antiviral (famciclovir) — latency ใน trigeminal ganglion จะ reactivate ทุกเครียด\n\n✗ ทำไมข้ออื่นผิด:\n— Calicivirus = oral ulcer + URI + serous discharge (ไม่ใช่ dendritic pattern)\n— Coronavirus = FIP (granulomatous uveitis บุ่งหน้า ไม่ใช่ keratitis)\n— Chlamydophila = conjunctival chemosis + URI ไม่เด่น dendritic","verified":"Aj. Nalinee Q5 + non-ulcerative keratitis notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94103,"subject":"com3","topic":"cornea","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","feline-corneal-sequestrum","cat"],"type":"mcq","q":"รอยโรคสีน้ำตาล-ดำ นูนขึ้นมาที่ cornea ของแมว (เรียกอีกชื่อว่า corneal nigrum) คือภาวะใด","options":["Corneal abscess","Iris prolapse","Feline corneal sequestration (corneal nigrum)","Melanoma ที่กระจกตา"],"answer":2,"explain":"Feline corneal sequestration = unique to cats → เม็ดสีน้ำตาล-ดำที่ cornea, เกิดจากการสะสมของ Fe ใน tear, มีความแข็ง + เจ็บ, สัมพันธ์กับ chronic FHV-1 (> 55% โดยเฉพาะ แมว Persian)\nTx: keratectomy เอาก้อนออก ± lamellar graft\n\n✗ ทำไมข้ออื่นผิด:\n— Corneal abscess = นูนแต่ขุ่นเหลือง ไม่เป็นเม็ดสีน้ำตาล\n— Iris prolapse = พบหลัง perforation (มี iris ทะลุออกมา)\n— Melanoma ที่กระจกตา = ไม่ค่อยพบ corneal-only ในแมว","verified":"Aj. Nalinee Q7 + non-ulcerative keratitis notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94104,"subject":"com3","topic":"cornea","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","refractory-ulcer","debridement"],"type":"mcq","q":"โรค corneal ulcer ใดที่ต้องทำ debridement (และอาจตามด้วย grid/punctate keratotomy) เป็น mainstay treatment","options":["Deep stromal ulcer","Refractory superficial keratitis (indolent ulcer / Boxer ulcer)","Descemetocoele","Melting cornea (keratomalacia)"],"answer":1,"explain":"Refractory superficial keratitis = epithelial lip ที่หลุดออก ไม่ติดกับ stroma → ไม่ลึกแต่ไม่หาย\nTx: debridement of epithelial lip (Betadine ก๊อต) + ถ้าไม่หายอาจทำ superficial keratotomy (punctate หรือ grid pattern) ให้ stroma แตก เพื่อให้ basement membrane เกาะใหม่\n\n✗ ทำไมข้ออื่นผิด:\n— Deep stromal ulcer = ไม่รุนแรง: anti-collagenase + atropine; รุนแรง: 3rd eyelid flap / conjunctival pedicle graft\n— Descemetocoele = emergency surgical repair (conjunctival flap/graft)\n— Melting cornea = anti-collagenase (serum/EDTA) + ABO ไม่ใช่ debride อย่างเดียว","verified":"Aj. Nalinee Q9, Q33 + ulcerative keratitis notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94105,"subject":"com3","topic":"cornea","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","topical-steroid","ulcer"],"type":"mcq","q":"ข้อใด ห้ามใช้ ในการรักษา corneal ulcer ที่ active","options":["Topical antibiotic (เช่น chloramphenicol)","Mydriatic (atropine) เพื่อลด ciliary spasm + pain","Topical steroid","Topical anti-collagenase (serum)"],"answer":2,"explain":"Topical steroid ห้ามใช้กับ active corneal ulcer เพราะ:\n1. Delay healing (ลด epithelialization)\n2. ลด fibroblastic proliferation → stroma ไม่ซ่อม\n3. เพิ่ม activity ของ lysosomal hydrolase → ทะลุได้ (perforation)\n4. เพิ่ม risk ของการติดเชื้อ (immunosuppression)\n\n✓ ใช้ steroid ได้ใน non-ulcerative keratitis (เช่น Pannus, feline eosinophilic keratitis) แต่ต้อง fluorescein -ve เท่านั้น\n\n💡 จำง่ายๆ: fluorescein +ve = no steroid","verified":"Aj. Nalinee Q10 + ulcerative keratitis notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94106,"subject":"com3","topic":"uveitis","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","anterior-staphyloma","perforation"],"type":"mcq","q":"Anterior staphyloma คือภาวะที่เนื้อเยื่อใดทะลุออกมาผ่าน cornea ที่ลึก","options":["Conjunctiva","Iris (iris prolapse)","Lens","Ciliary body"],"answer":1,"explain":"Anterior staphyloma = iris ทะลุออกมาผ่าน cornea ที่ลึก (perforated keratitis with iris prolapse) → aqueous humor ไหลออก, ม่านตาดันไปติดที่กระจกตา\nTx: ถ้ายังสด → กลับเข้าไปคืน; ถ้าแห้ง/necrosis = ตัด iris ส่วนนั้นทิ้ง (iris มีเส้นเลือดมาก ระวังเลือดออก)\n\n✗ ทำไมข้ออื่นผิด:\n— Conjunctiva ไม่ทะลุผ่าน cornea (อยู่ภายนอก)\n— Lens prolapse = เกิดที่ส่วนอื่น ไม่เรียก staphyloma\n— Ciliary body อยู่ลึก ไม่ทะลุออก cornea\n\n💡 ตรงข้ามกับ Descemetocoele (Descemet's bulge แต่ยังไม่ทะลุ)","verified":"Aj. Nalinee Q11 + cornea wound notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94107,"subject":"com3","topic":"uveitis","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","aqueous-humor","function"],"type":"mcq","q":"ข้อใด ไม่ใช่ หน้าที่ของ aqueous humor","options":["Maintain IOP & volume ของ eyeball","Provide สารอาหาร, O₂, electrolyte ให้ avascular structures (cornea, lens)","Remove metabolic waste","นำสัญญาณภาพไปยัง optic nerve"],"answer":3,"explain":"Aqueous humor มี pH ~7.2 หน้าที่:\n1. Maintain IOP & volume ของ eyeball\n2. ให้สารอาหาร + O₂ + electrolyte แก่ avascular structures\n3. Remove metabolic waste\n4. โปร่งใส → ให้แสงผ่าน\n\n✗ การนำสัญญาณภาพ = หน้าที่ของ retina + optic nerve (ไม่เกี่ยว aqueous)\n\n💡 Aqueous สร้างที่ non-pigmented ciliary body epithelium → posterior chamber → ผ่าน pupil → anterior chamber → drain ออก iridocorneal angle","verified":"Aj. Nalinee Q12 + uvea notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94108,"subject":"com3","topic":"uveitis","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","deep-AC","lens-luxation"],"type":"mcq","q":"Anterior chamber ที่ลึกผิดปกติ (deep AC) บอกถึงพยาธิสภาพใด","options":["Corneal perforation","Iris bombé","Anterior lens luxation","Posterior lens luxation หรือ microphakia (small lens)"],"answer":3,"explain":"Deep AC = ห้องหน้าลึกผิดปกติ → lens หล่นไปข้างหลังหรือ lens เล็กผิดปกติ → iris ไม่มี lens รองรับ → iris ยุบลึก\nสาเหตุ: posterior lens luxation, microphakia, aphakia (ไม่มี lens)\n\n✗ ทำไมข้ออื่นผิด (เป็น shallow AC ทั้งหมด):\n— Corneal perforation = aqueous ไหลออก → AC แฟบ\n— Iris bombé = iris โป่งมาด้านหน้าจาก posterior synechia\n— Anterior lens luxation = lens ดันขึ้นข้างหน้า → AC ตื้น\n\n💡 ดู AC depth = quick diagnostic clue ก่อนทำ slit lamp","verified":"Aj. Nalinee Q13 + uvea notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94109,"subject":"com3","topic":"uveitis","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","synechia","uveitis"],"type":"mcq","q":"Posterior synechia คือภาวะที่ iris ติดกับโครงสร้างใด","options":["Cornea (endothelium)","Trabecular meshwork ที่ iridocorneal angle","Lens (anterior capsule)","Vitreous body"],"answer":2,"explain":"Posterior synechia = iris ติดกับ lens (anterior capsule) → ม่านตาติดแก้วตา → เกิดหลัง anterior uveitis (inflammation ทำให้ fibrin เกาะ)\n→ ถ้าวงกว้างจะ block aqueous flow ผ่าน pupil → iris bombé → secondary glaucoma\nป้องกันด้วย mydriatic (atropine) เพื่อ dilate pupil ไม่ให้ติด\n\n✗ ทำไมข้ออื่นผิด:\n— Iris-cornea adhesion = anterior synechia (peripheral anterior synechia, PAS)\n— Iris-trabecular meshwork = PAS ที่ angle\n— Iris-vitreous = ไม่ใช่ term มาตรฐาน","verified":"Aj. Nalinee Q15 + iridocyclitis notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94110,"subject":"com3","topic":"uveitis","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","uveodermatologic","vkh-like"],"type":"mcq","q":"Uveodermatologic syndrome (VKH-like syndrome ในสุนัข) ควรรักษาด้วยข้อใดเป็นหลัก","options":["Topical antibiotic เท่านั้น","Topical mydriatic เท่านั้น","Systemic anti-inflammatory (steroid/immunosuppressant)","Surgical enucleation ทันที"],"answer":2,"explain":"Uveodermatologic syndrome = immune-mediated → ทำลาย melanocyte ใน uvea + skin (eyelid, nose, lip depigmentation) เช่น Akita, Husky, Chow Chow, sheep dogs, Alaskan\n→ ระบบภูมิคุ้มกันโจมตี melanocyte ทั่วร่างกาย → ต้อง systemic immunosuppression (prednisolone, azathioprine, cyclosporine) ไม่ใช่ topical อย่างเดียว\n\n✗ ทำไมข้ออื่นผิด:\n— Topical ABO/mydriatic = adjunct ไม่พอเอาอยู่\n— Enucleation = last resort ถ้าตาบอด + เจ็บ — ไม่ใช่ initial Tx","verified":"Aj. Nalinee Q17 + canine uveitis notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94111,"subject":"com3","topic":"uveitis","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","feline-uveitis","3F-1T-1C"],"type":"mcq","q":"สาเหตุของ feline uveitis ที่จำเป็น mnemonic '3F, 1T, 1C' ประกอบด้วยอะไรบ้าง","options":["FeLV, FIV, FIP, Toxoplasma, Cryptococcus","FeLV, FIV, Feline calicivirus, Toxoplasma, Cryptococcus","FeLV, FIP, Feline herpesvirus, Toxoplasma, Cryptococcus","FeLV, FIV, FIP, Trypanosoma, Coronavirus"],"answer":0,"explain":"Feline uveitis มัก systemic causes:\n3F = FeLV + FIV + FIP\n1T = Toxoplasma (posterior uveitis ได้ด้วย)\n1C = Cryptococcus\n→ work-up: serology + FNA + serum protein electrophoresis\nTx: address underlying + topical/systemic steroid + NSAID + mydriatics\n\n✗ ทำไมข้ออื่นผิด:\n— Calicivirus = oral/URI ไม่ใช่ uveitis primary cause\n— Feline herpesvirus = keratitis ไม่ใช่ uveitis classic\n— Trypanosoma ในแมวไม่ classic","verified":"Aj. Nalinee Q18 + feline uveitis notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94112,"subject":"com3","topic":"uveitis","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","aqueous-flare","tyndall"],"type":"mcq","q":"Aqueous flare (เห็นเป็นลำแสงสะท้อนใน anterior chamber เมื่อส่อง slit lamp) เกิดจากกลไกใด","options":["Lens fiber หลุดออกมา","เลือดออกใน AC (hyphema)","Increased aqueous substances (protein) จากการเสียหายของ blood-aqueous barrier → Tyndall phenomenon","Pigmented cell ของ iris ตกตะกอน"],"answer":2,"explain":"Aqueous flare = blood-aqueous barrier (BAB) เสียหาย (จาก uveitis/trauma) → protein/cell รั่วเข้า aqueous → ลำแสง slit lamp กระจาย = Tyndall phenomenon\n→ classic sign ของ anterior uveitis (ยังไม่จำเป็นต้องมี hypopyon)\n\n✗ ทำไมข้ออื่นผิด:\n— Lens fiber หลุด = phacolytic uveitis (lens-induced) เป็น cause ไม่ใช่กลไก flare\n— Hyphema = เลือดเต็ม AC (มองเห็นด้วยตาเปล่า)\n— Pigmented cell = pigmentary uveitis (specific to certain breeds)\n\n💡 Keratic precipitate = cell ตกตะกอนบน endothelium → spot ดำๆ พบใน FIP","verified":"Aj. Nalinee Q27 + iridocyclitis notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94113,"subject":"com3","topic":"cataract","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","diabetic-cataract","sorbitol"],"type":"mcq","q":"กลไกการเกิด diabetic cataract เกี่ยวข้องกับสารใดที่สะสมใน lens","options":["Galactose","Sorbitol (จาก hyperglycemia + aldose reductase pathway)","Lactate","Cholesterol"],"answer":1,"explain":"Diabetic cataract: Hyperglycemia → aldose reductase converts glucose to sorbitol (molecule ใหญ่ ออกจาก lens ไม่ได้) → osmotic gradient → น้ำเข้า lens จน protein ratio เสียหาย → lens อ้วน (intumescent) → lens fiber rupture → bilateral cataract\n\n✗ ทำไมข้ออื่นผิด:\n— Galactose = galactosemic cataract ไม่ค่อยพบในสุนัข\n— Lactate = ใน anaerobic glycolysis ไม่ใช่ cataract pathway\n— Cholesterol = corneal degeneration (metallic glitter) ไม่ใช่ cataract\n\n💡 ~75% ของ diabetic dogs จะ develop cataract ภายใน 1 ปี","verified":"Aj. Nalinee Q20 + cataract notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94114,"subject":"com3","topic":"cataract","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","lens-luxation","ICCE"],"type":"mcq","q":"กรณี complete lens luxation (lens หลุดออกจาก zonule ทั้งหมด) — เทคนิคผ่าตัดที่เหมาะสมที่สุดคือ","options":["Phacoemulsification + IOL (lens เทียม)","Extracapsular cataract extraction (ECCE)","Intracapsular cataract extraction (ICCE) — เอาทั้ง lens + capsule ออก","ใส่ vitrectomy เอาแก่ vitreous ออก"],"answer":2,"explain":"Lens luxation = zonule ขาดหมด → lens หลุดทั้งก้อน → ปลอม fix lens กลับที่เดิม ไม่ได้ + replace ด้วย lens เทียมยังไม่นิยม → เอา lens ออกดีที่สุดด้วย ICCE\nICCE = เปิด cornea → ใช้ lens loop ตักออกทั้ง lens + capsule\nกลับมามองเห็นต่ำมาก (no IOL) แต่ตาจะไม่บวม + เจ็บลดลง\nPredisposed breeds: Terriers, Westie, Jack Russell, Sharpei, Collie\n\n✗ ทำไมข้ออื่นผิด:\n— Phaco/ECCE = ต้องมี capsule ยังอยู่ → ไม่ได้กับ complete luxation\n— Vitrectomy = ไม่แก้ปัญหา lens","verified":"Aj. Nalinee Q44 + lens position notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94115,"subject":"com3","topic":"glaucoma","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","iop-normal","tonometry"],"type":"mcq","q":"Intraocular pressure (IOP) ค่า 70 mmHg บอกถึงภาวะใด และควรใช้ยาประเภทใด","options":["Hypotony — ใช้ NSAID เพิ่ม IOP","Normal — observation อย่างเดียว","Acute glaucoma — ใช้ osmotic diuretics (mannitol) ลด IOP เร็ว","Chronic uveitis — ใช้ steroid อย่างเดียว"],"answer":2,"explain":"Normal IOP = 13-17 mmHg → 70 mmHg = acute glaucoma (severe, จะ blind ภายใน 4-48 ชม.)\nTx แรก: Osmotic diuretics — Mannitol IV drip 20 min ลด IOP กลับมา <50 mmHg ได้ ~4 ชม. (ระวัง renal/cardiovascular/dehydration)\nหลังจากนั้น: Carbonic anhydrase inhibitor (dorzolamide topical) + beta-blocker (timolol) + prostaglandin analogs (ระวัง uveitis ห้ามใช้)\n\n✗ ทำไมข้ออื่นผิด:\n— 70 mmHg ไม่ใช่ hypotony (= low IOP)\n— ไม่ใช่ normal (สูงมาก, optic n. damage)\n— Chronic uveitis อาจ IOP ขึ้น แต่ 70 = emergency ไม่ใช่ chronic Tx","verified":"Aj. Nalinee Q29 + glaucoma classification notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94116,"subject":"com3","topic":"glaucoma","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","chronic-glaucoma","Haab-striae"],"type":"mcq","q":"Haab's striae (เห็นเป็นรอยร้าวบน cornea) เป็นสัญญาณของภาวะใด","options":["Acute glaucoma (onset < 48 ชม.)","Chronic glaucoma (long-standing)","Acute anterior uveitis","Corneal foreign body"],"answer":1,"explain":"Haab's striae = รอยแตกของ Descemet's membrane เห็นเป็นรอยร้าวบน cornea → เกิดจาก IOP สูงเรื้อรัง → cornea ยืดออก + Descemet's แตก\n= sign ของ chronic glaucoma (พร้อมกับ buphthalmos, lens subluxation, corneal deep vascularization, exposure keratitis, cupped optic disc, retinal degeneration)\n\n✗ ทำไมข้ออื่นผิด:\n— Acute glaucoma signs = severe pain, episcleral injection, corneal edema, mydriasis, vision loss (ไม่ทันเป็น striae)\n— Anterior uveitis = aqueous flare, miosis, hypopyon\n— Corneal FB = ulcer + epiphora ไม่ใช่ striae pattern","verified":"Aj. Nalinee Q28 + chronic glaucoma notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94117,"subject":"com3","topic":"glaucoma","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","cyclocryosurgery","complications"],"type":"mcq","q":"ข้อใด ไม่ใช่ ภาวะแทรกซ้อนจาก cyclocryosurgery ในการรักษา chronic glaucoma","options":["Severe chemosis","Uveitis + retinal detachment + phthisis bulbi","Increased aqueous production","Iris bombé จาก posterior synechia ที่ไม่เกี่ยวข้อง"],"answer":2,"explain":"Cyclocryosurgery = ใช้ความเย็นจี้บางส่วนของ ciliary body ให้ตาย → ลด aqueous production (ไม่เพิ่ม!)\n→ ใช้ลูกตาที่เสีย/บอดไปแล้ว (ไม่นิยมในตาที่ vision still functional)\nClassic complications: severe chemosis, uveitis, retinal detachment, phthisis bulbi (ตาเล็กยุบ)\n\n✗ Increased aqueous production = ตรงข้ามกับ mechanism — ผิดอย่างชัดเจน\n✓ Severe chemosis = complication คลาสสิก\n✓ Uveitis + retinal detachment + phthisis bulbi = complications ทั้งหมด\n✓ Iris bombé = sequelae ของ uveitis ที่อาจเกิดตามมาได้\n\n💡 ตอนหลังนิยม cyclophotocoagulation (laser, more specific, less damage) แทน cyclocryosurgery แต่ราคาแพงกว่า","verified":"Aj. Nalinee Q30 + surgical Tx notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94118,"subject":"com3","topic":"retina","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","FCRD","taurine"],"type":"mcq","q":"Feline central retinal degeneration (FCRD) เกิดจากภาวะใด และรักษาด้วยอะไร","options":["Glucose deficiency — เสริม glucose","Taurine deficiency จากอาหาร — เสริม taurine (lesion จะคงอยู่ตลอดไป)","Vitamin A deficiency — เสริม vitamin A","Hyperthyroidism — methimazole"],"answer":1,"explain":"FCRD = feline-specific → taurine deficiency จากอาหาร (cat food ที่ taurine ต่ำ หรือ dog food)\nSigns: impaired vision → blindness\nLesion: elliptical lesion ที่ retina แล้วลุกลาม (area centralis), optic disc atrophy ไม่มี vsl. มากขึ้น\nTx: เสริม taurine — หยุดการลุกลามได้แต่ lesion เดิมคงอยู่ตลอด (irreversible)\n\n✗ ทำไมข้ออื่นผิด:\n— Glucose/Vit A/Hyperthyroidism ไม่ใช่ classic FCRD cause\n— แมว obligate carnivore → ต้องได้ taurine จากอาหาร (ไม่สังเคราะห์เอง)","verified":"Aj. Nalinee Q25 + FCRD notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94119,"subject":"com3","topic":"retina","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","SARD","ERG"],"type":"mcq","q":"Sudden acquired retinal degeneration (SARD) มีลักษณะอย่างไรในสุนัข","options":["Vision loss แบบช้าๆ ใน 6-12 เดือน, ERG ผิดปกติ partial","Vision loss ทันที (acute blindness), ERG no wave, มักเจอใน overweight middle-aged small breed (เพศเมีย)","Vision loss เฉพาะกลางคืน, fundus ปกติ","Vision loss + corneal opacity"],"answer":1,"explain":"SARD = ตาบอดทันที (acute), photoreceptor ไม่ทำงาน\nDx: ERG (no wave) → confirm photoreceptor failure แม้ fundus ดูปกติ\nPredisposed: overweight + middle-aged + small breed + female ↑\nNo cure → blind ถาวร\n\n✗ ทำไมข้ออื่นผิด:\n— Slow progression (เดือน-ปี) = PRA ไม่ใช่ SARD\n— Night blindness only = early PRA (rod เสื่อมก่อน)\n— Corneal opacity = ไม่ใช่ SARD signs (SARD = retinal-only)\n\n💡 จุดเด่น: ตาบอดทันที + fundus ดูปกติแรกๆ + ERG flat-line","verified":"Aj. Nalinee + SARD notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94120,"subject":"com3","topic":"retina","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","collie-eye-anomaly","CEA"],"type":"mcq","q":"ลักษณะที่พบบ่อยที่สุดใน Collie eye anomaly (CEA) คือ","options":["Optic disc coloboma","Choroidal hypoplasia (เห็น sclera ขาวมากขึ้น ที่ posterior pole)","Retinal detachment","Intraocular hemorrhage"],"answer":1,"explain":"CEA = inherited bilateral disease (autosomal recessive ใน Collie + related breeds)\n4 ลักษณะ — choroidal hypoplasia พบบ่อยสุด:\n1. Choroidal hypoplasia (most common) = choroid พัฒนาไม่สมบูรณ์ → เห็น sclera ขาวขึ้นที่ posterior pole\n2. Coloboma (optic disc) = ปิดไม่สนิท เห็นเป็นหลุม\n3. Retinal detachment\n4. Intraocular hemorrhage\n→ ความรุนแรงไม่ครบทั้ง 4 ข้อก็ได้\n\n💡 จำง่ายๆ: '4-feature inherited Collie defect — แต่ choroidal hypoplasia hallmark'","verified":"Aj. Nalinee + CEA notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94121,"subject":"com3","topic":"ophthal-exam","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","dazzle-reflex","cranial-nerve"],"type":"mcq","q":"การทดสอบ Dazzle reflex ใช้ cranial nerve คู่ใดเป็น afferent และ efferent","options":["Afferent CN I (olfactory), Efferent CN III (oculomotor)","Afferent CN II (optic), Efferent CN VII (facial) — response = blink","Afferent CN V (trigeminal), Efferent CN VI (abducens)","Afferent CN II (optic), Efferent CN III (oculomotor) — response = PLR"],"answer":1,"explain":"Dazzle reflex = ตอบสนองต่อแสงจ้าด้วยการกระพริบตา (blink)\n— Stimuli: bright light\n— Receptor: photoreceptors\n— Afferent: CN II (optic)\n— Efferent: CN VII (facial) → palpebral muscle\n— Response: blink (กระพริบตา ไม่ใช่ pupil constriction)\n→ Subcortical pathway, present แม้จะ blind ใน cortex (cortical blindness)\n\n✗ ทำไมข้ออื่นผิด:\n— PLR (Pupillary light reflex) ใช้ CN II in, CN III out → constriction\n— CN I = smell, CN V = sensory face/cornea, CN VI = abducens (lateral rectus)","verified":"Aj. Aorpharn Q4 + ocular examination notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94122,"subject":"com3","topic":"ophthal-exam","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","seidel-test","perforation"],"type":"mcq","q":"ในการตรวจตา การใช้ Seidel test มีวัตถุประสงค์เพื่อตรวจหาอะไร","options":["วัด tear production","ตรวจ patency ของ nasolacrimal duct","ตรวจหา ocular leak / corneal perforation (เห็น aqueous ไหลออกมาเป็นสาย dilute fluorescein)","วัด tear film stability"],"answer":2,"explain":"Seidel test = ใช้ fluorescein เข้มข้นลงบน cornea แล้วดู:\n— ถ้ามี aqueous leak (perforation) → aqueous จะไหลออกมา dilute fluorescein → เห็นเป็นสาย/stream สีเขียวอ่อน\n→ confirms corneal perforation / ocular leak\n\n✗ ทำไมข้ออื่นผิด:\n— Schirmer tear test (STT) = วัด tear production (mm/min)\n— Jones test = ตรวจ patency ของ nasolacrimal duct (pass → fluorescein ออกที่จมูก)\n— Tear film break-up time (TFBUT) = วัด tear film stability (< 20 sec = orbital trauma/dry eye)\n\n💡 4 routine tests: STT → Jones → TFBUT → Seidel","verified":"Aj. Aorpharn Q3 + ocular exam notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94123,"subject":"com3","topic":"ear","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","otitis-media","infection-route"],"type":"mcq","q":"เส้นทางการติดเชื้อที่พบบ่อยที่สุดของ otitis media คือทางใด","options":["Descending จาก external auditory meatus → tympanic membrane","Ascending จาก nasopharynx → Eustachian tube","Hematogenous distribution จากกระแสเลือด systemic","Lymphogenous spread จาก retropharyngeal lymph node"],"answer":0,"explain":"Otitis media (middle ear infection) → 3 routes:\n1. Descending จาก external auditory meatus → tympanic membrane (most common) — สืบเนื่องจาก chronic otitis externa\n2. Ascending จาก nasopharynx → Eustachian tube\n3. Hematogenous distribution → ผ่านกระแสเลือด systemic\n\n💡 ในแมว middle ear polyps มักเกิดจาก ascending จาก nasopharynx ผ่าน Eustachian tube\n💡 หมา chronic otitis externa → tympanic perforation → otitis media (descending pattern dominates)","verified":"Aj. Kiatpichet otitis media + ear notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94124,"subject":"com3","topic":"ear","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","TECA","horizontal-canal"],"type":"mcq","q":"รอยโรคที่ horizontal ear canal รุนแรงเรื้อรัง (stenosis + เนื้องอก) ควรพิจารณา surgical treatment ใด","options":["Lateral wall resection (Zepp's procedure)","Total ear canal ablation (TECA) ± ventral bulla osteotomy","Ventral bulla osteotomy อย่างเดียว","Vertical canal ablation"],"answer":1,"explain":"Horizontal canal lesion ที่รุนแรง (chronic stenosis + neoplasia + irreversible) → Total ear canal ablation (TECA) ± ventral bulla osteotomy\n→ เอา ear canal ออกหมด + drain bulla ออก\nComplication: facial nerve paralysis (~7% — Horner's-like, constricted pupil + เหล้าน้ำตา), เลียงนอกๆๆ\n\n✗ ทำไมข้ออื่นผิด:\n— Lateral wall resection (Zepp) = สำหรับ vertical canal ตื้นๆเริ่มต้น, ไม่พอกับ horizontal\n— Ventral bulla osteotomy เดี่ยวๆ = สำหรับ middle ear lesion เท่านั้น\n— Vertical canal ablation = เลาะส่วนสูงออก ไม่พอถ้าลึกถึง horizontal\n\n💡 Middle ear lesion → ventral bulla osteotomy; canal lesion → TECA","verified":"Aj. Kiatpichet TECA notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94125,"subject":"com3","topic":"ophthal-exam","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","horner-syndrome","phenylephrine"],"type":"mcq","q":"การวินิจฉัยตำแหน่ง lesion ของ Horner's syndrome ใช้ topical phenylephrine — ถ้าตาที่ผิดปกติ (miosis) ขยาย pupil ภายใน 15 นาที แสดงว่า lesion อยู่ที่ใด","options":["1st order (central CNS lesion)","2nd order (preganglionic, T1-T3 spinal segment)","3rd order (postganglionic, middle ear / cervical sympathetic trunk distal)","ที่ retina"],"answer":2,"explain":"Horner's syndrome = sympathetic loss → 4 signs: miosis + ptosis + enophthalmos + 3rd eyelid protrusion\n— Topical phenylephrine (α-agonist) test:\n  • Dilate ภายใน < 20 min (denervation hypersensitivity) → postganglionic (3rd order) lesion เช่น otitis media/interna (sympathetic chain ผ่าน middle ear)\n  • Dilate ช้า (30-45 min) → preganglionic (2nd order) เช่น brachial plexus injury\n  • Dilate ปกติเหมือนตาอีกข้าง → 1st order central CNS\n\nสาเหตุที่พบบ่อยใน dogs = otitis media (3rd order, postganglionic)\n\n💡 Idiopathic Horner's (Golden Retriever) = postganglionic, self-resolve","verified":"Aj. Nalinee + Horner's notes (Kim TJ86 cheat-sheet single source)"},
  {"id":94126,"subject":"com3","topic":"imaging","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","imaging","radial-nerve"],"type":"mcq","q":"หากต้องการวินิจฉัย ความผิดปกติของ radial nerve (peripheral nerve injury) imaging modality ใดเหมาะที่สุด","options":["Radiography","Ultrasonography","Computed tomography (CT)","Magnetic resonance imaging (MRI)"],"answer":3,"explain":"Soft tissue (nerve, brain, spinal cord) → MRI = gold standard (excellent soft tissue contrast)\nMRI สามารถ visualize peripheral nerve เช่น radial nerve injury, brachial plexus avulsion\n\n✗ ทำไมข้ออื่นผิด:\n— Radiography/Fluoroscopy = bone-focused, ไม่เห็น nerve\n— Ultrasonography = nerve เล็กๆ ทำได้แต่ resolution ต่ำกว่า MRI\n— CT = bone + soft tissue ดี แต่ nerve detail < MRI\n\n💡 Imaging hierarchy for nerve/brain/spinal cord: MRI > CT > US > Radiography","verified":"Diagnostic imaging section Q1 (Kim TJ86 cheat-sheet single source)"},
  {"id":94127,"subject":"com3","topic":"imaging","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","imaging","open-fontanelle"],"type":"mcq","q":"ลูกสุนัขพันธุ์เล็ก อายุ 5 เดือน ตรวจพบ open fontanelle ต้องการประเมินภาวะ hydrocephalus imaging modality ใดที่เหมาะสมในเบื้องต้น","options":["Radiography","Ultrasonography (ผ่าน open fontanelle)","Computed tomography","Magnetic resonance imaging"],"answer":1,"explain":"Open fontanelle = สามารถใช้ ultrasonography ผ่าน fontanelle เพื่อ visualize ventricle ในสมอง (ดูว่ามี hydrocephalus ไหม)\n→ non-invasive + ไม่ต้อง anesthesia + cost-effective + screening test ที่ดี\nถ้าผิดปกติแล้วต้องการรายละเอียดเพิ่มเติม → MRI (definitive)\n\n✗ ทำไมข้ออื่นผิด:\n— Radiography/Fluoroscopy = ไม่เห็น brain ventricle\n— CT/MRI = ต้อง anesthesia, expensive, มัก reserve เป็น confirmatory test\n\n💡 Brachycephalic toy breeds (Chihuahua, Pomeranian) = predisposed hydrocephalus + open fontanelle","verified":"Diagnostic imaging section Q2 (Kim TJ86 cheat-sheet single source)"},
  {"id":94128,"subject":"com3","topic":"imaging","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","imaging","atlantoaxial"],"type":"mcq","q":"การประเมิน atlantoaxial subluxation ก่อนผ่าตัด — imaging modality ใดให้รายละเอียด bony alignment ดีที่สุด","options":["Plain radiography เท่านั้น","Ultrasonography","Computed tomography (CT)","Magnetic resonance imaging"],"answer":2,"explain":"Atlantoaxial subluxation = C1-C2 instability (dens hypoplasia, ligament rupture)\n→ Pre-surgical assessment ต้องรู้ bony detail (screw placement) + 3D reconstruction → CT = ดีที่สุด\nMRI เสริมเพื่อดู spinal cord compression + soft tissue\n\n✗ ทำไมข้ออื่นผิด:\n— Plain radiography = screening ได้ แต่ subluxation บางมุมหายดูยาก, no 3D\n— Fluoroscopy = dynamic imaging มี role ใน flexion view แต่ไม่ใช่ pre-op of choice\n— Ultrasound = ไม่ผ่าน bone\n\n💡 Toy breeds (Yorkie, Chihuahua, Pomeranian) = predisposed AAS","verified":"Diagnostic imaging section Q3 (Kim TJ86 cheat-sheet single source)"},
  {"id":94129,"subject":"com3","topic":"imaging","year":4,"source":"สรุป COM III (mid) Kim -️.pdf","examOrigin":"Kim TJ86","tags":["midterm","imaging","brain-hematoma"],"type":"mcq","q":"หากต้องการวินิจฉัยความแตกต่างของชนิดเลือดออกในเนื้อสมอง (hematoma type ตามอายุ) modality ใดเหมาะสมที่สุด","options":["Radiography","Ultrasonography","Computed tomography","Magnetic resonance imaging (MRI)"],"answer":3,"explain":"Brain hematoma age/type (acute vs subacute vs chronic) → MRI สามารถแยกได้ดีที่สุด เพราะ hemoglobin breakdown products (oxyHb → deoxyHb → metHb → hemosiderin) เปลี่ยน signal intensity บน T1/T2/GRE ตามอายุ\n— Acute (< 3 days): T1 iso, T2 hypo\n— Subacute: T1 hyper, T2 hyper\n— Chronic: hemosiderin = T2 hypointense rim\n\n✗ ทำไมข้ออื่นผิด:\n— CT ดู acute bleed (hyperdense) ได้ แต่ stage chronic แยกยาก\n— Radiography/Fluoroscopy/US = ไม่เห็น brain parenchyma detail\n\n💡 CT = acute trauma screening; MRI = parenchymal lesion characterization","verified":"Diagnostic imaging section Q5 (Kim TJ86 cheat-sheet single source)"},
  // ─── End com3-mid additions ───
];
