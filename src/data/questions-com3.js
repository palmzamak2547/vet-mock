...
export const QB_COM3 = [
  ...
  { id: 702, subject: 'com3', topic: 'triage', year: 4, source: 'triage 1 hr.pdf',
    ...
    answer: 2, explain: '6 perfusion: mentation + MM + CRT + HR + pulse quality + extremity temp · ทุกตัวเข้าได้แม้ไม่มีเครื่องมือ',
  ...
  { id: 705, subject: 'com3', topic: 'triage', year: 4, source: 'triage 1 hr.pdf',
    ...
    options: ['Bradycardia (ตรงข้ามกับสุนัข — แมว shock มัก HR ช้าลง)', 'Arrhythmia เท่านั้น', 'Normal HR', 'Tachycardia (เพราะ sympathetic stimulation)'],
  ...
  { id: 706, subject: 'com3', topic: 'triage', year: 4, source: 'triage 1 hr.pdf',
    ...
    answer: 0, explain: 'Bounding pulse = sepsis signature · Thready pulse = severe vasoconstriction · pulse strong = sys-dias gap > 50',
    verified: 'triage 1 hr.pdf + master p.42' },
  ...
  { id: 707, subject: 'com3', topic: 'triage', year: 4, source: 'triage 1 hr.pdf',
    ...
    answer: 3, explain: 'Red = arrest/critical · Yellow = stable แต่ระวัง · Green = รอได้ 24 ชม.',
  ...
  { id: 710, subject: 'com3', topic: 'shock', year: 4, source: 'SHOCK 1 hr.pdf',
    ...
    answer: 0, explain: 'Shock = imbalance DO₂ vs VO₂ → ATP ไม่พอ → cell ตาย → organ failure · BP ต่ำเป็นแค่ symptom',
  ...
  { id: 711, subject: 'com3', topic: 'shock', year: 4, source: 'SHOCK 1 hr.pdf',
    ...
    options: ['Distributive shock', 'Cardiogenic shock', 'Hypoxic shock', 'Hypovolemic shock'],
  ...
  { id: 712, subject: 'com3', topic: 'shock', year: 4, source: 'SHOCK 1 hr.pdf',
    ...
    answer: 1, explain: 'Distributive: sepsis, SIRS, anaphylaxis · NO → vasodilate → VR ↓ → CO ↓ · "warm shock" — vasodilate',
  ...
  { id: 713, subject: 'com3', topic: 'shock', year: 4, source: 'SHOCK 1 hr.pdf',
    ...
    answer: 0, explain: 'SIRS = ≥ 2/4: temp สูง/ต่ำ · HR สูง/ต่ำ · RR เร็ว · WBC สูง/ต่ำ + bands · MODS เมื่อลามไปอวัยวะอื่น',
    verified: 'SHOCK 1 hr.pdf + master p.16' },
  ...
  { id: 714, subject: 'com3', topic: 'shock', year: 4, source: 'SHOCK 1 hr.pdf',
    ...
    answer: 2, explain: 'Metabolic shock = mitochondrial dysfunction หรือ no glucose · ตัวอย่าง: hypoglycemia, cyanide poisoning · fluid ไม่ช่วย',
    verified: 'SHOCK 1 hr.pdf + master p.16' },
  ...
  { id: 715, subject: 'com3', topic: 'shock', year: 4, source: 'SHOCK 1 hr.pdf',
    ...
    answer: 2, explain: 'Hyperlactatemia ≥ 2.5 mmol/L · type A = O₂ delivery ต่ำ (poor perfusion) · type B = cellular use abnormal',
  ...
  { id: 716, subject: 'com3', topic: 'shock', year: 4, source: 'SHOCK 1 hr.pdf',
    ...
    answer: 3, explain: 'SI = HR/SBP · normal 0.9-1.0 · > 1 มีแนวโน้ม shock',
    verified: 'SHOCK 1 hr.pdf + master p.17' },
  ...
  { id: 717, subject: 'com3', topic: 'shock', year: 4, source: 'SHOCK 1 hr.pdf',
    ...
    options: ['Furosemide', 'Mannitol', 'Norepinephrine', 'Dobutamine'],
    answer: 2, explain: 'Norepinephrine = specific α-agonist → vasoconstriction → ↑ BP · ใช้เมื่อ SAP < 80, MAP < 60 · Dobutamine = inotrope',
  ...
  { id: 722, subject: 'com3', topic: 'cpcr', year: 4, source: 'CPCR 1 hr.pdf',
    ...
    answer: 0, explain: 'Low-dose epi 0.01 mg/kg IV ทุก 3-5 นาที (cycle เว้น cycle) · ห้าม shock asystole + PEA · vasopressor → DBP ↑',
  ...
  { id: 723, subject: 'com3', topic: 'cpcr', year: 4, source: 'CPCR 1 hr.pdf',
    ...
    options: ['Ventricular Fibrillation (VF) + Pulseless VT', 'PEA (Pulseless Electrical Activity)', 'Sinus bradycardia', 'Asystole'],
    answer: 0, explain: 'Shockable: VF + pulseless VT · NON-shockable: asystole + PEA → ให้ epinephrine แทน',
  ...
  { id: 724, subject: 'com3', topic: 'cpcr', year: 4, source: 'CPCR 1 hr.pdf',
    ...
    answer: 3, explain: 'Atropine = parasympatholytic · ให้เฉพาะกรณี vagal tone ↑ (ปวดท้อง, vomit, pancreatitis) · Cycle แรกครั้งเดียว (อยู่นาน)',
    verified: 'CPCR 1 hr.pdf + master p.30' },
  ...
  { id: 725, subject: 'com3', topic: 'cpcr', year: 4, source: 'CPCR 1 hr.pdf',
    ...
    options: ['> 40 mmHg', '> 18 mmHg', '> 100 mmHg', '> 5 mmHg'],
  ...
  { id: 731, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'Acute Abdomen 1 hr.pdf',
    ...
    answer: 3, explain: 'AFAST 4-point: นอน right lateral · DH (diaphragm + liver), SR (spleen + L kidney), CC (UB + colon), HR (liver + R kidney) · score แต่ละจุด มี fluid +1',
    verified: 'Acute Abdomen 1 hr.pdf + master p.22' },
  ...
  { id: 732, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'Acute Abdomen 1 hr.pdf',
    ...
    answer: 0, explain: 'Septic peritonitis: fluid glucose < 50 mg/dL · หรือ blood-fluid glucose gap > 20 (bacteria กิน glucose) · + degenerate neutrophil ± bacteria',
  ...
  { id: 733, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'Acute Abdomen 1 hr.pdf',
    ...
    options: ['Fluid bilirubin > Serum bilirubin', 'Fluid albumin : Serum albumin > 1', 'Fluid PCV > Blood PCV', 'Fluid Cr : Serum Cr > 2 : 1'],
    answer: 3, explain: 'Uroabdomen: fluid Cr : serum Cr > 2:1 · K+ ratio: dog > 1.4, cat > 1.9 · + AFAST อาจเห็น ruptured UB',
    verified: 'Acute Abdomen 1 hr.pdf + master p.23' },
  ...
  { id: 734, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'Acute Abdomen 1 hr.pdf',
    ...
    answer: 0, explain: 'Hemoabdomen: fluid PCV ≈ blood PCV และไม่ clot (factors used up in cavity) · Common: hemangiosarcoma, splenic mass rupture, trauma',
    verified: 'Acute Abdomen 1 hr.pdf + master p.23' },
  ...
  { id: 735, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'Acute Abdomen 1 hr.pdf',
    ...
    options: ['Acetaminophen', 'Opioids (Fentanyl, Morphine, Buprenorphine) — ปลอดภัยใน renal/hepatic impair', 'Aspirin', 'NSAIDs (Meloxicam)'],
  ...
  { id: 736, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'Acute Abdomen 1 hr.pdf',
    ...
    answer: 1, explain: 'Critical (ผ่าด่วน): septic peritonitis (perforate), GDV, mesenteric torsion, uncontrolled bleed · Pancreatitis = medical mgmt',
    verified: 'Acute Abdomen 1 hr.pdf + master p.23' },
  ...
  { id: 740, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    options: ['Cheyne-Stokes', 'Restrictive (rapid shallow)', 'Expiratory dyspnea + wheeze', 'Inspiratory dyspnea + stridor'],
    answer: 3, explain: 'URT obstruction: inspiratory dyspnea + stridor (laryngeal paralysis, brachycephalic) · LRT obstruction: expiratory + wheeze (asthma)',
  ...
  { id: 741, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    answer: 2, explain: 'Paradoxical = abdomen + chest move opposite direction · pleural effusion / pneumothorax / diaphragm fatigue · ต้อง emergency thoracocentesis',
    verified: 'Respiratory and Cardiovascular Emergency 1 hr.pdf' },
  ...
  { id: 742, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    options: ['Bronchodilator inhaler', 'Steroid IV', 'Furosemide IV + O₂ supplementation + minimize stress', 'IV crystalloid bolus'],
    answer: 2, explain: 'Cardiogenic pulmonary edema: Furosemide 1-4 mg/kg IV ± CRI · O₂ + minimize stress · monitor RR · ห้าม IV fluid (ทำให้แย่ลง)',
    verified: 'Respiratory and Cardiovascular Emergency 1 hr.pdf' },
  ...
  { id: 743, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    options: ['Furosemide', 'Defibrillation', 'IV epinephrine', 'Pericardiocentesis'],
    answer: 3, explain: 'Cardiac tamponade → pericardiocentesis ASAP · clinical: muffled heart, pulsus paradoxus, jugular distension · มักเจอ pericardial effusion จาก tumor (HSA)',
    verified: 'Respiratory and Cardiovascular Emergency 1 hr.pdf' },
  ...
  { id: 753, subject: 'com3', topic: 'er-anes', year: 4, source: 'Animal_Emerg_Anes 1 hr.pdf',
    ...
    answer: 3, explain: 'Head trauma: opioid + benzo + anticholinergic · propofol induct · IPPV ETCO₂ ≈ 40 mmHg (ป้องกัน vasodilate → ICP ↑) · ห้าม α2 (depress)',
    verified: 'Animal_Emerg_Anes 1 hr.pdf + master p.46' },
  ...
  { id: 754, subject: 'com3', topic: 'er-anes', year: 4, source: 'Animal_Emerg_Anes 1 hr.pdf',
    ...
    options: ['Local anesthesia', 'α2-adrenergic agonist (xylazine, dexmed)', 'Benzodiazepine', 'Opioid'],
    answer: 1, explain: 'ห้าม α2-agonist เด็ดขาดในแม่ตั้งครรภ์ · ลูกได้ยาด้วย · เลือก propofol/alfaxalone (sedative สั้น) · sx ด่วน เพื่อให้ลูกออกเร็ว',
    verified: 'Animal_Emerg_Anes 1 hr.pdf + master p.46' },
  ...
  { id: 762, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'master p.33',
    ...
    answer: 0, explain: 'DKA tx เร็วเกิน → glucose ลดเร็ว → idiogenic osmoles ใน cell ดึงน้ำเข้า → cerebral edema · ลด glucose ช้าๆ + monitor neuro',
    verified: 'metabolic and endocrine and UT 1 hr.pdf + master p.33' },
  ...
  { id: 763, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'master p.33',
    ...
    options: ['Glucose สูง', 'Na+ < 132 + K+ > 7 (Na+:K+ ratio < 25:1) + hypoglycemia', 'Calcium ต่ำ', 'Na+ สูง / K+ ต่ำ'],
  ...
  { id: 764, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'master p.33',
    ...
    options: ['IV fluid + Dexamethasone + Ca gluconate ถ้า bradyarrhythmia', 'Furosemide', 'NSAIDs', 'Insulin'],
    answer: 0, explain: 'IV NSS (correct hypoNa ช้าๆ < 0.5 mEq/L/hr ป้องกัน pontine myelinolysis) · Dexamethasone (ไม่ interfere ACTH test) · Ca gluconate stabilize myocardium · maintain: prednisolone + fludrocortisone',
    verified: 'master p.33' },
  ...
  { id: 765, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'master p.34',
    ...
    options: ['ให้ steroid', 'ให้ NSAIDs ก่อน', 'Cystocentesis + IV fluid + correct hyperK ก่อนสวน catheter', 'ฉีด catheter ทันที'],
    answer: 2, explain: 'Stabilize first: cystocentesis (decompress) + fluid + correct K · sedation/anes ตอนสวน · post-obstructive diuresis ระวังให้ fluid พอ',
  ...
  { id: 766, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'master p.34',
    ...
    options: ['Dopamine', 'NSAIDs + Aminoglycoside (intrinsic-renal nephrotoxic)', 'Mannitol', 'Furosemide'],
    answer: 1, explain: 'NSAIDs (vasoconstriction) + aminoglycoside (gentamicin nephrotoxic) · เลือก opioid + furosemide + mannitol + dopamine · severe → dialysis',
  ...
  { id: 791, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'neuro_ataxia_tremor 1 hr.pdf',
    ...
    options: ['ลูกแมวมี seizure', 'แมวอ้วน', 'สุนัขแก่, sudden onset head tilt + horizontal nystagmus + ataxia · mental status ปกติ · self-resolve 1-2 weeks', 'สุนัขเด็ก, head tilt + ataxia เป็นๆหายๆ'],
  ...
  { id: 802, subject: 'com3', topic: 'seizure', year: 4, source: 'seizure 1 hr.pdf',
    ...
    options: ['Phenobarbital หรือ Imepitoin · Levetiracetam (KBr ในกรณี renal ปกติ)', 'Acetazolamide', 'Mannitol', 'Diazepam (PO)'],
  ...
  { id: 803, subject: 'com3', topic: 'seizure', year: 4, source: 'seizure 1 hr.pdf',
    ...
    options: ['รอให้หยุดเอง', 'IV access + Diazepam 0.5 mg/kg IV bolus (หรือ rectal 1-2 mg/kg) · per rectum ถ้าไม่มี IV', 'Mannitol bolus', 'ให้ phenobarbital PO'],
  ...
  { id: 814, subject: 'com3', topic: 'spinal', year: 4, source: 'Spinal disorder 2 hr.pdf',
    ...
    options: ['Cervical wobbler', 'Atlantoaxial instability', 'Cauda equina syndrome', 'IVDD type I (T-L) — ตัดด้านข้าง 1/2 ของ lamina ทำได้ยาวสุด 3 vertebrae'],
  ...
  { id: 820, subject: 'com3', topic: 'neuro-er', year: 4, source: 'neuroER 1 hr.pdf',
    ...
    options: ['Diazepam', 'Dexamethasone (steroid)', 'Mannitol 0.5-1 g/kg IV ช้าๆ 15-20 นาที (osmotic diuretic)', 'Furosemide IV'],
  ...
  { id: 826, subject: 'com3', topic: 'shock', year: 4, source: 'SHOCK 1 hr.pdf',
    ...
    answer: 0, explain: 'Dog shock: crystalloid 60-90 ml/kg bolus (titrate, ¼ at a time) · Cat: 30-60 ml/kg (smaller — ระวัง overload) · goal HR<150, SBP>90',
    verified: 'SHOCK 1 hr.pdf + master p.18' },
  ...
  { id: 827, subject: 'com3', topic: 'cpcr', year: 4, source: 'CPCR 1 hr.pdf',
    ...
    options: ['รออีก 24 ชม. ค่อย monitor', 'Hemodynamic optimization (fluid + vasopressor) + maintain PaCO₂ 35-45 + SpO₂ ≥ 94 + treat underlying cause', 'หยุด O₂ ทันที', 'Discharge ทันที'],
  ...
  { id: 828, subject: 'com3', topic: 'cpcr', year: 4, source: 'CPCR 1 hr.pdf',
    ...
    answer: 0, explain: 'Biphasic 2-4 J/kg · monophasic 4-6 J/kg · ถ้าไม่ rhythm กลับ → ↑ 50% next shock · between shocks → CPR 2 min',
  ...
  { id: 831, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'Acute Abdomen 1 hr.pdf',
    ...
    answer: 2, explain: 'GDV: right lateral X-ray = "double bubble" หรือ reverse C sign · stomach rotate clockwise · emergency Sx',
    verified: 'Acute Abdomen 1 hr.pdf + master p.22' },
  ...
  { id: 832, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'Acute Abdomen 1 hr.pdf',
    ...
    answer: 2, explain: 'DPL: ใส่ NSS เข้าช่องท้อง mix แล้วดูดออก → analyze (เพิ่ม sensitivity เมื่อ effusion น้อย) · invasive ระวังโดนอวัยวะ',
    verified: 'Acute Abdomen 1 hr.pdf + master p.23' },
  ...
  { id: 833, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    options: ['Oxygen cage (≈ 30-60%)', 'Tight-fitting mask + high flow (≈ 60-80%) หรือ ETT (≈ 100%)', 'Nasal cannula (≈ 30-50%)', 'Flow-by mask (FiO₂ ≈ 25-40%)'],
    answer: 1, explain: 'FiO₂ scale: room air 21% → flow-by 25-40% → nasal 30-50% → cage 30-60% → tight mask 60-80% → ETT 100% · เลือกตาม severity',
    verified: 'Respiratory and Cardiovascular Emergency 1 hr.pdf' },
  ...
  { id: 834, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    options: ['ใต้ xiphoid', 'Intercostal 7-9, dorsal 1/3 (sit/stand position) สำหรับอากาศ', 'Intercostal 11-12, ventral', 'Intercostal 2-3, dorsal'],
  ...
  { id: 835, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    options: ['O₂ supplement + Terbutaline 0.01 mg/kg SC (β2-agonist) + glucocorticoid (dexamethasone IV)', 'Bronchodilator inhaler ห้ามใช้', 'Antibiotic only', 'Furosemide IV'],
    answer: 0, explain: 'Acute asthma: O₂ + terbutaline (bronchodilator) + dexamethasone IV · long-term: inhaled fluticasone + albuterol PRN',
    verified: 'Respiratory and Cardiovascular Emergency 1 hr.pdf' },
  ...
  { id: 836, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    options: ['Polyuria + polydipsia', 'Sudden hindlimb paresis/plegia + cold limbs + cyanotic pads + absent femoral pulse + severe pain', 'Vomit + diarrhea', 'Cough เด่น'],
  ...
  { id: 837, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    options: ['Atropine', 'Amlodipine 0.625-1.25 mg/cat PO q24h (calcium channel blocker)', 'Spironolactone', 'Furosemide'],
  ...
  { id: 838, subject: 'com3', topic: 'er-anes', year: 4, source: 'Animal_Emerg_Anes 1 hr.pdf',
    ...
    options: ['Fluid + blood transfusion · target: HR < 150, SBP > 90, PCV ≥ 20%, TS ≥ 4 g/dL', 'แค่ steroid IV', 'Anesthesia ทันทีโดยไม่ครอบคุม pain', 'ผ่าทันทีไม่ต้อง stabilize'],
    answer: 0, explain: 'Hemoabdomen: hypovolemia + anemia · stabilize before Sx · เตรียม blood ไว้พร้อม · post-op: continue transfusion ถ้า PCV drop',
    verified: 'Animal_Emerg_Anes 1 hr.pdf + master p.46' },
  ...
  { id: 842, subject: 'com3', topic: 'er-anes', year: 4, source: 'Animal_Emerg_Anes 1 hr.pdf',
    ...
    options: ['เพิ่ม O₂ reserve ใน FRC (functional residual capacity) ลด risk hypoxia ระหว่าง intubation', 'ลดความเจ็บ', 'ลดยา anesthesia', 'ทำให้สัตว์ตื่นมากขึ้น'],
    answer: 0, explain: 'Pre-O₂: 3-5 min mask → fill FRC + denitrogenate · ลด desaturation risk during intubation · สำคัญใน hypovolemic, dyspneic, brachycephalic',
  ...
  { id: 843, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'metabolic and endocrine and UT 1 hr.pdf',
    ...
    options: ['Saline only', 'Insulin', 'Dextrose 50% diluted 1:4 (becomes ~10%) — 0.5-1 ml/kg slow IV จากนั้น CRI 2.5-5%', 'Dextrose 5% 100 ml IV'],
    answer: 2, explain: 'Hypoglycemia: 50% dextrose dilute 1:4 (kg) → 0.5-1 ml/kg slow IV (ป้องกัน vein irritation) · maintain CRI 2.5-5% · monitor q1-2h',
  ...
  { id: 844, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'master p.34',
    ...
    options: ['Atrial flutter', 'Sinus arrest only', 'Bradycardia + absent P wave + tall peaked T + wide QRS (sinoventricular rhythm)', 'Tachycardia + tall narrow QRS'],
    answer: 2, explain: 'HyperK: lose P wave first → wide QRS → tall peaked T → V-fib · K+ > 7 = emergency · Tx: Ca gluconate (stabilize myocardium) + dextrose+insulin (shift K)',
    verified: 'master p.34' },
  ...
  { id: 845, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'metabolic and endocrine and UT 1 hr.pdf',
    ...
    options: ['AKI', 'Hyperkalemia', 'Post-obstructive diuresis (ต้องให้ fluid ตาม UOP)', 'Normal'],
    answer: 2, explain: 'Post-obstructive diuresis: UOP > 2-5 ml/kg/hr · ป้องกัน dehydration → match UOP กับ fluid · monitor electrolyte (hypoK risk)',
    verified: 'metabolic and endocrine and UT 1 hr.pdf + master p.34' },
  ...
  { id: 846, subject: 'com3', topic: 'nutrition', year: 4, source: 'nutrition 1 hr.pdf',
    ...
    options: ['รักษาด้วย NPO', 'เกิดเฉพาะ kitten', 'แมวอ้วน + ไม่กิน 24-48 ชม. → fat mobilization → liver overload · Tx: enteral feeding (E-tube/G-tube) + L-carnitine + B12', 'แมวผอม + อด < 12 ชม. → ไม่เสี่ยง'],
  ...
  { id: 852, subject: 'com3', topic: 'neuro-exam', year: 4, source: 'neuro_exam 1 hr.pdf',
    ...
    options: ['Abnormal — UMN lesion above lumbar · contralateral limb extends when ipsilateral withdrawal stimulated', 'Normal in puppy < 4 wk', 'Pain assessment', 'Normal in adult dog'],
  ...
  { id: 854, subject: 'com3', topic: 'spinal', year: 4, source: 'Spinal disorder 2 hr.pdf',
    ...
    options: ['Strict cage rest 4-6 weeks + analgesia (gabapentin, opioid) ± gabapentin · ห้าม activity + jumping', 'NSAIDs only', 'Steroid high-dose', 'Surgery ทันที'],
  ...
  { id: 856, subject: 'com3', topic: 'spinal', year: 4, source: 'Spinal disorder 2 hr.pdf',
    ...
    options: ['Trauma only', 'Viral', 'Bacterial hematogenous spread (UTI/dental/valve seed)', 'Genetic only'],
  ...
  { id: 857, subject: 'com3', topic: 'spinal', year: 4, source: 'Spinal disorder 2 hr.pdf',
    ...
    options: ['Hypovolemic shock', 'Septic shock จาก myelitis', 'Transient loss of spinal reflex below lesion หลัง acute SC injury (~24 hr ในสุนัข) · ก่อนประเมิน DPP/prognosis ต้องรอ 24 hr', 'Permanent loss of all reflex'],
  ...
  { id: 858, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'neuro_ataxia_tremor 1 hr.pdf',
    ...
    options: ['ทดสอบ corneal reflex', 'ทดสอบ pupillary reflex', 'ทดสอบ vestibular system + brainstem — turn head, eye should track opposite direction · loss in central vestibular', 'ทดสอบ visual cortex'],
  ...
  { id: 860, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'neuro_ataxia_tremor 1 hr.pdf',
    ...
    options: ['Hereditary only', 'Feline panleukopenia (FPV) infection in utero → cerebellum ไม่พัฒนา', 'Trauma', 'Bacterial'],
  ...
  { id: 862, subject: 'com3', topic: 'ataxia-tremor', year: 4, source: 'neuro_ataxia_tremor 1 hr.pdf',
    ...
    options: ['Hyperthermia · cooling only', 'SLUDGE (Salivation, Lacrimation, Urination, Defecation, GI distress, Emesis) + miosis + tremor + seizure. Antidote: Atropine + 2-PAM (organophosphate)', 'Mydriasis · naloxone', 'Bradycardia · atropine'],
  ...
  { id: 865, subject: 'com3', topic: 'seizure', year: 4, source: 'seizure 1 hr.pdf',
    ...
    options: ['Tremor', 'Sudden collapse with sleep / muscle atony triggered by excitement (eating, play) · regain consciousness immediately when stimulated · NO post-ictal', 'Vestibular signs', 'Loss of consciousness with tonic-clonic activity'],
  ...
  { id: 866, subject: 'com3', topic: 'seizure', year: 4, source: 'seizure 1 hr.pdf',
    ...
    options: ['Onset < 1 yr OR > 6 yr · focal seizure · cluster/status · interictal neuro deficit · breed atypical', 'Idiopathic epilepsy ที่คุม PB ได้แล้ว', 'แมวเด็ก', 'ทุก case ที่มี seizure ครั้งแรก'],
  ...
  { id: 869, subject: 'com3', topic: 'neuro-er', year: 4, source: 'neuroER 1 hr.pdf',
    ...
    options: ['ใช้ steroid ดีกว่า', 'ห้ามใช้ทั้งคู่', 'ใช้ทดแทนกันได้ในกรณี ICP สูง · HTS เหมาะใน hypovolemia (ขยาย vol) · Mannitol contraindicated ใน hypovolemia + AKI', 'Mannitol แย่กว่า HTS เสมอ'],
  ...
  { id: 871, subject: 'com3', topic: 'neuro-er', year: 4, source: 'neuroER 1 hr.pdf',
    ...
    options: ['Trendelenburg position', 'Supine flat', 'Head elevated 30° + neck neutral (avoid jugular compression)', 'Lateral recumbency, head down'],
  ...
  { id: 872, subject: 'com3', topic: 'neuro-er', year: 4, source: 'neuroER 1 hr.pdf',
    ...
    options: ['ให้กิน paracetamol', 'ให้กิน phenobarb', 'Per-rectal diazepam 1-2 mg/kg หรือ intranasal midazolam 0.2 mg/kg · มียาฉุกเฉินไว้ที่บ้าน', 'ห้ามทำอะไร'],
    answer: 2, explain: 'Owner-administered: rectal diazepam (preloaded syringe) · IN midazolam · ขั้นแรกใน cluster ก่อนพามา · ลด cluster severity',
  ...
  { id: 873, subject: 'com3', topic: 'neuro-er', year: 4, source: 'neuroER 1 hr.pdf',
    ...
    options: ['Active cooling จนอุณหภูมิ 39.5 °C แล้วหยุด', 'ห่อผ้าหนาให้อบอุ่น', 'รอลดเอง', 'ไม่ต้องทำอะไร'],
  ...
  { id: 874, subject: 'com3', topic: 'neuro-er', year: 4, source: 'neuroER 1 hr.pdf',
    ...
    options: ['Visual only', '3 categories: motor activity + brainstem reflex + level of consciousness · each scored 1-6, total 3-18', 'Pain only', 'Heart rate + blood pressure'],
  ...
  { id: 876, subject: 'com3', topic: 'ai-vet', year: 4, source: 'COM III ตารางเรียน',
    ...
    options: ['AI ปฏิเสธตอบ', 'AI สร้างคำตอบที่ดูสมเหตุสมผลแต่ไม่ตรงข้อเท็จจริง (อ้างอิงผิด, ตัวเลขมั่ว)', 'AI ทำงานช้า', 'AI เห็นภาพจริงจัง'],
  ...
  { id: 877, subject: 'com3', topic: 'ai-vet', year: 4, source: 'COM III ตารางเรียน',
    ...
    options: ['ห้ามบอก context ใดๆ', 'ระบุ context (อายุ/เพศ/breed/clinical signs) + ask specific question + request citation/evidence', 'ใช้แค่คำคีย์เวิร์ดเดียว', 'ถามแบบเปิดสั้นๆ "ตอบหมาเป็นโรคอะไร"'],
  ...
  { id: 884, subject: 'com3', topic: 'shock', year: 4, source: 'COM III FINAL 86 + Aj. Chutirat',
    ...
    answer: 3, explain: 'Severe dehydration + ↓ perfusion (CRT, weak pulse) + แมว shock มัก HR ↓ · BP ตกแล้ว = decompensatory · PCV/Hb ปกติ ไม่ใช่ anemic · ไม่มี cytokine sign → ไม่ใช่ septic',
  ...
  { id: 885, subject: 'com3', topic: 'cpcr', year: 4, source: 'COM III FINAL 86 + RECOVER',
    ...
    answer: 0, explain: 'VF + no pulse + EtCO₂ drop = cardiac arrest · Start CPR + prep defib (shockable) · 2-4 J/kg biphasic · ห้าม atropine ใน VF · ห้ามรอ',
    verified: 'CPCR 1 hr.pdf + RECOVER 2024' },
  ...
  { id: 887, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Resp_CV emergency',
    ...
    options: ['Bronchodilator inhaler ห้ามใช้ในแมว', 'Antibiotic IV', 'Terbutaline 0.01 mg/kg SC + dexamethasone IV + ลด stress', 'Furosemide IV (สงสัย heart failure)'],
  ...
  { id: 888, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'metabolic',
    ...
    options: ['Steroid IV', 'IV NSS bolus → Replace K → Regular insulin CRI หลัง K ≥ 3.5', 'Dextrose 50% bolus', 'Insulin SC 1 U/kg ทันที'],
  ...
  { id: 889, subject: 'com3', topic: 'er-anes', year: 4, source: 'ER anes',
    ...
    options: ['Decompress UB + correct hyperK ก่อน sedate', 'NSAIDs IV ก่อน', 'Atropine + ketamine ทันที', 'Propofol bolus ทันที'],
    answer: 0, explain: 'HyperK 8.0 + ECG change = severe risk asystole ถ้า sedate ทันที · stabilize: Ca gluconate (no shift K, แค่ stabilize membrane) + dextrose+insulin (shift K into cell) + IV fluid · เมื่อ K < 6 + ECG ดีขึ้น ค่อย sedate',
    verified: 'Animal_Emerg_Anes 1 hr.pdf + master p.46' },
  ...
  { id: 892, subject: 'com3', topic: 'seizure', year: 4, source: 'seizure',
    ...
    options: ['Cluster seizure · phenobarb PO', 'Status epilepticus · IV + Diazepam 0.5 mg/kg IV (or rectal 1-2 mg/kg)', 'Narcolepsy · supportive only', 'Isolated seizure · monitor at home'],
