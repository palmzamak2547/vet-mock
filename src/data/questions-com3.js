...
export const QB_COM3 = [
  ...
  { id: 707, subject: 'com3', topic: 'triage', year: 4, source: 'triage 1 hr.pdf',
    ...
    answer: 4, explain: 'Red = arrest/critical · Yellow = stable แต่ระวัง · Green = รอได้ 24 ชม.',
  ...
  { id: 711, subject: 'com3', topic: 'shock', year: 4, source: 'SHOCK 1 hr.pdf',
    ...
    answer: 2, explain: 'Cardiogenic shock = หัวใจ pump ไม่ได้ → fluid เพิ่ม → preload เพิ่ม → cardiac failure แย่ลง · type อื่น fluid ช่วย',
    verified: 'SHOCK 1 hr.pdf + master p.15' },
  ...
  { id: 717, subject: 'com3', topic: 'shock', year: 4, source: 'SHOCK 1 hr.pdf',
    ...
    answer: 3, explain: 'Norepinephrine = specific α-agonist → vasoconstriction → ↑ BP · ใช้เมื่อ SAP < 80, MAP < 60 · Dobutamine = inotrope',
  ...
  { id: 725, subject: 'com3', topic: 'cpcr', year: 4, source: 'CPCR 1 hr.pdf',
    ...
    answer: 2, explain: 'Goal EtCO₂ > 18 mmHg · ค่า EtCO₂ โดดสูง 40 mmHg ทันที = ROSC (Return of Spontaneous Circulation)',
    verified: 'CPCR 1 hr.pdf + master p.30' },
  ...
  { id: 733, subject: 'com3', topic: 'acute-abdomen', year: 4, source: 'Acute Abdomen 1 hr.pdf',
    ...
    answer: 4, explain: 'Uroabdomen: fluid Cr : serum Cr > 2:1 · K+ ratio: dog > 1.4, cat > 1.9 · + AFAST อาจเห็น ruptured UB',
    verified: 'Acute Abdomen 1 hr.pdf + master p.23' },
  ...
  { id: 740, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    answer: 4, explain: 'URT obstruction: inspiratory dyspnea + stridor (laryngeal paralysis, brachycephalic) · LRT obstruction: expiratory + wheeze (asthma)',
  ...
  { id: 742, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    answer: 3, explain: 'Cardiogenic pulmonary edema: Furosemide 1-4 mg/kg IV ± CRI · O₂ + minimize stress · monitor RR · ห้าม IV fluid (ทำให้แย่ลง)',
    verified: 'Respiratory and Cardiovascular Emergency 1 hr.pdf' },
  ...
  { id: 743, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    answer: 4, explain: 'Cardiac tamponade → pericardiocentesis ASAP · clinical: muffled heart, pulsus paradoxus, jugular distension · มักเจอ pericardial effusion จาก tumor (HSA)',
    verified: 'Respiratory and Cardiovascular Emergency 1 hr.pdf' },
  ...
  { id: 765, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'master p.34',
    ...
    answer: 3, explain: 'Stabilize first: cystocentesis (decompress) + fluid + correct K · sedation/anes ตอนสวน · post-obstructive diuresis ระวังให้ fluid พอ',
  ...
  { id: 833, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    answer: 2, explain: 'FiO₂ scale: room air 21% → flow-by 25-40% → nasal 30-50% → cage 30-60% → tight mask 60-80% → ETT 100% · เลือกตาม severity',
    verified: 'Respiratory and Cardiovascular Emergency 1 hr.pdf' },
  ...
  { id: 834, subject: 'com3', topic: 'resp-cv-er', year: 4, source: 'Respiratory and Cardiovascular Emergency 1 hr.pdf',
    ...
    answer: 2, explain: 'Thoracocentesis air: 7-9 IC dorsal · fluid: 7-9 IC ventral · cranial border of rib (avoid neurovascular)',
    verified: 'Respiratory and Cardiovascular Emergency 1 hr.pdf' },
  ...
  { id: 843, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'metabolic and endocrine and UT 1 hr.pdf',
    ...
    options: ['Saline only', 'Mannitol 20% IV', 'Insulin', 'Dextrose 50% diluted 1:4 (becomes ~10%) — 0.5-1 ml/kg slow IV จากนั้น CRI 2.5-5%', 'Dextrose 5% 100 ml IV'],
  ...
  { id: 844, subject: 'com3', topic: 'metabolic-er', year: 4, source: 'master p.34',
    ...
    answer: 3, explain: 'HyperK: lose P wave first → wide QRS → tall peaked T → V-fib · K+ > 7 = emergency · Tx: Ca gluconate (stabilize myocardium) + dextrose+insulin (shift K)',
    verified: 'master p.34' },
  ...
  { id: 866, subject: 'com3', topic: 'seizure', year: 4, source: 'seizure 1 hr.pdf',
    ...
    options: ['Onset < 1 yr OR > 6 yr · focal seizure · cluster/status · interictal neuro deficit · breed atypical', 'Idiopathic epilepsy ที่คุมยาได้ดีอยู่แล้ว', 'Idiopathic epilepsy ที่คุม PB ได้แล้ว', 'แมวเด็ก', 'ทุก case ที่มี seizure ครั้งแรก'],
  ...
  { id: 872, subject: 'com3', topic: 'neuro-er', year: 4, source: 'neuroER 1 hr.pdf',
    ...
    options: ['ให้กิน paracetamol', 'Dexamethasone IM 1 mg/kg', 'ให้กิน phenobarb', 'Per-rectal diazepam 1-2 mg/kg หรือ intranasal midazolam 0.2 mg/kg · มียาฉุกเฉินไว้ที่บ้าน', 'ห้ามทำอะไร'],
