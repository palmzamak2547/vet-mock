...
export const VIDEO_LIBRARY = [
  ...
  },
  {
    ...
    topic: 'POA — Clinical Problem Solving (Companion) — DekDokVet85',
    url: 'https://www.youtube.com/playlist?list=PLaZuHrnxtHBcZQT0g9AcrjwkrdlKYeXUi',
    author: 'DekDokVet85 (Vet 85)',
    duration: 'Playlist',
    tags: ['lecture', 'review', 'dekdok', 'y5-sem1'],
  },
  ...
  {
    subject: 'milk-meat-hygiene',
    topic: 'Milk Hygiene — VET86 (รุ่นปัจจุบัน)',
    url: 'https://www.youtube.com/playlist?list=PLLCu_1UIckNA',
    author: 'WW (VET86)',
    duration: 'Playlist',
  ...
  {
    subject: 'avian-medicine',
    topic: 'Avian Medicine — VET86 (รุ่นปัจจุบัน)',
    url: 'https://www.youtube.com/playlist?list=PLV0M_1h3Ge3M',
    author: 'WW (VET86)',
    duration: 'Playlist',
    tags: ['lecture', 'vet86', 'y5-sem1'],
  },
  {
    subject: 'one-health',
    topic: 'One Health — VET86 (รุ่นปัจจุบัน)',
    url: 'https://www.youtube.com/playlist?list=PLUkxr1h8UGtY',
    author: 'WW (VET86)',
    duration: 'Playlist',
    tags: ['lecture', 'vet86', 'y5-sem1'],
  },
  {
    subject: 'aquatic-clinic',
    topic: 'Aquatic Animal Medicine — VET86 (รุ่นปัจจุบัน)',
    url: 'https://www.youtube.com/playlist?list=PLX_tj_W1SgqE',
    author: 'WW (VET86)',
    duration: 'Playlist',
    tags: ['lecture', 'vet86', 'y5-sem1'],
  },
  {
    subject: 'food-industry',
    topic: 'Food Industry — VET86 (รุ่นปัจจุบัน)',
    url: 'https://www.youtube.com/playlist?list=PLakGwr0kO4UE',
    author: 'WW (VET86)',
    duration: 'Playlist',
    tags: ['lecture', 'vet86', 'y5-sem1'],
  },
  {
    subject: 'zoonoses',
    topic: 'Zoonoses — VET86 (รุ่นปัจจุบัน)',
    url: 'https://www.youtube.com/playlist?list=PLdEGWCa6KP70',
    author: 'WW (VET86)',
    duration: 'Playlist',
    tags: ['lecture', 'vet86', 'y5-sem1'],
  },
  {
    ...
    topic: 'Swine Medicine — VET86 (รุ่นปัจจุบัน)',
    url: 'https://www.youtube.com/playlist?list=PLXVS-5YCQzqk',
    author: 'WW (VET86)',
    duration: 'Playlist',
    tags: ['lecture', 'vet86', 'y5-sem1'],
  },
  {
    subject: 'equine-medicine',
    topic: 'Equine Medicine and Surgery — VET86 (รุ่นปัจจุบัน)',
    url: 'https://www.youtube.com/playlist?list=PLaj5owvXDpPs',
    author: 'WW (VET86)',
    duration: 'Playlist',
    tags: ['lecture', 'vet86', 'y5-sem1'],
  },
  {
    subject: 'epidemiology',
    topic: 'Epidemiology — VET86 (รุ่นปัจจุบัน)',
    url: 'https://www.youtube.com/playlist?list=PLJqWQLtI3Wck',
    author: 'WW (VET86)',
    duration: 'Playlist',
    tags: ['lecture', 'vet86', 'y5-sem1'],
  },
  ...
  // ─── Y5 sem 2 (channel 'Year 5/2' section, 2 subjects) ─────────
  {
    ...
    url: 'https://www.youtube.com/playlist?list=PLaZuHrnxtHBeYIhBPozFiW8O3ehsHL8Ce',
    author: 'DekDokVet85 (Vet 85)',
    duration: 'Playlist',
  ...
  },
  {
    ...
    topic: 'ปฐมนิเทศคลินิก Year 5 — DekDokVet85',
    url: 'https://www.youtube.com/playlist?list=PLaZuHrnxtHBcDxyOlT4XZ_Jjo-FlovXGC',
    author: 'DekDokVet85 (Vet 85)',
    duration: 'Playlist',
    tags: ['lecture', 'review', 'dekdok', 'y5-sem2'],
  },
