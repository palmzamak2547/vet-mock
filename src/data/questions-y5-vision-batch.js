...
export const QB_Y5_VISION_BATCH = [
  {
    ...
    "answer": 4,
    "explain": "ฐานนี้กำหนดให้ใช้น้ำนมในขวดแทนการรีดจากเต้า ขั้นตอน E คือรีดจากเต้าจริงเพื่อส่งเพาะเชื้อ จึงไม่ใช่ขั้นตอนของฐานนี้.\nวัตถุประสงค์ที่จะประเมิน: นิสิตสามารถตรวจ วินิจฉัย และแปลผล รวมถึงให้คำแนะนำเบื้องต้นในโรคเต้านมอักเสบทั้งแบบแสดงและไม่แสดงอาการได้.\nอุปกรณ์ที่ต้องเตรียม: เครื่องเขียนเท่านั้น.",
    "verified": "OSCE prep doc p.9 (station 1 instructions list)",
    "flag": {
      "note": "Extracted via pdfplumber from clean Thai OSCE prep doc — paraphrased to MCQ; verify before student use",
      "severity": "unclear"
    }
  },
  {
  ...
  },
  {
    ...
    "flag": {
      "note": "Administrative info paraphrased from station prep doc — verify dates",
      "severity": "unclear"
    }
  },
  {
    ...
    "answer": 0,
    "explain": "หลังเขย่าเสร็จแล้วไม่ต้องนำแต่ละชั้นมาชั่ง ถือว่าสิ้นสุดส่วนการเลือกตัวอย่างและการเขย่า จากนั้นจึงวิเคราะห์ผลการเขย่าอาหาร TMR ที่กำหนดให้ แล้วบันทึกผลที่แปลได้.\nความหมาย: rubric ประเมินทักษะ sampling + shaking + interpretation จากตัวอย่างที่จัดเตรียมไว้ให้ (ไม่ทดสอบ DM% ที่ต้องชั่ง).\nอุปกรณ์ที่ต้องเตรียม: เครื่องเขียนเท่านั้น.",
    "verified": "OSCE prep doc p.10 (PSPS instructions 2-3)",
    "flag": {
      "note": "Paraphrased from station instruction — verify before student use",
      "severity": "unclear"
    }
  },
  {
    "id": 8556,
    "subject": "livestock-pathology",
    "topic": "lpath-swine-systemic",
    "year": 5,
    ...
    "flag": {
      "note": "Q stem cid:xxx-garbled in PDF; answer choices English + checkmark on choice A. Paraphrased intent — verify before student use",
      "severity": "unclear"
    }
  },
  {
  ...
  },
  {
    ...
    "flag": {
      "note": "Margin annotation \"ETEC heat-labile + heat-stable toxin\" visible in extracted text; Q stem garbled. Paraphrased — verify",
      "severity": "unclear"
    }
  },
  {
    ...
    "flag": {
      "note": "Q stem partially garbled; lesion description + answer mark recoverable. Paraphrased — verify",
      "severity": "unclear"
    }
  },
  {
    ...
    "flag": {
      "note": "High-mortality outbreak Q · mortality 90-100% + splenic infarct = ASF classical. Verify exact wording",
      "severity": "unclear"
    }
  },
  {
    ...
    "flag": {
      "note": "Q stem garbled; lesion phrase + age range recoverable. Paraphrased to standard ddx — verify",
      "severity": "unclear"
    }
  },
  {
    ...
    "flag": {
      "note": "Multi-option parasitology matching; English names clean in extraction. Routes paraphrased from textbook — verify",
      "severity": "unclear"
    }
  },
  {
    ...
    "flag": {
      "note": "Ectoparasite ID Q · English names clean. Trick distractor = labeling flea as louse. Verify",
      "severity": "unclear"
    }
  },
  {
  ...
  },
  {
    ...
    "flag": {
      "note": "Numeric range \"7-10\" visible in extracted text; Q context cid:xxx-garbled. Paraphrased from standard timing — verify",
      "severity": "unclear"
    }
  },
  {
  ...
  },
  {
    ...
    "flag": {
      "note": "Suture type clean in extraction. Verify pattern usage in current practice",
      "severity": "unclear"
    }
  },
  {
    ...
    "flag": {
      "note": "Mechanism clean in extraction. Paraphrased to MCQ — verify",
      "severity": "unclear"
    }
  },
  {
    ...
    "flag": {
      "note": "Antibiotic list with gram tags clean in extraction. Distractor inverts enrofloxacin spectrum. Verify",
      "severity": "unclear"
    }
  },
  {
    ...
    "flag": {
      "note": "Cytology finding clean in extraction. Verify before student use",
      "severity": "unclear"
    }
  },
  {
    ...
    "flag": {
      "note": "Numeric malignancy rates clean in extraction. Verify against current references",
      "severity": "unclear"
    }
  },
  {
    ...
    "flag": {
      "note": "Stain sequence partially recoverable; paraphrased to standard 4-step protocol. Verify",
      "severity": "unclear"
    }
  },
  {
    ...
    "flag": {
      "note": "Q context ambiguous (ET tube vs needle); paraphrased toward ET-tube reading per number match. HIGH-VERIFY before use",
      "severity": "unclear"
    }
  },
  {
    ...
    "flag": {
      "note": "Q context ambiguous (parturition ALP vs prostatic ALP); both contexts explained. HIGH-VERIFY",
      "severity": "unclear"
    }
  },
  {
    ...
    "flag": {
      "note": "Stage 2 threshold \"> 12 hr\" clean in extraction. Verify against current criteria",
      "severity": "unclear"
    }
  },
];
