...
export const QB_Y5_VISION_BATCH = [
  ...
  { id: 8551, subject: 'ruminant-clinical', topic: 'rum-hattakan', year: 5,
    ...
    options: [
      'หาขนาดของอาหารด้วย PSPS · สุ่มเก็บตัวอย่างปริมาณถูกต้อง · แปลผลที่ได้จากการเขย่า',
      'ชั่งน้ำหนักอาหารทุกชั้นหลังเขย่าเสร็จ เพื่อคำนวณ DMI',
      'หาความชื้นของอาหารโดยอบแห้ง 105°C',
      'ตรวจหา mycotoxin ใน TMR ด้วย ELISA',
      'หา rumen pH หลังการกินอาหาร',
    ],
    answer: 0,
    explain: 'เอกสาร p.10 ระบุวัตถุประสงค์ชัดเจน: "หาขนาดของอาหารด้วย PSPS ตามวิธีการที่ถูกต้อง การสุ่มตัวเก็บอย่างอาหารในปริมาณที่ถูกต้อง รวมถึงสามารถแปลผลที่ได้จากเขย่าอาหารด้วยเครื่อง PSPS".\nหมายเหตุสำคัญ: "หลังจากเขย่าเสร็จแล้ว ไม่ต้องนำแต่ละชั้นมาชั่ง" → ตัวเลือก B (ชั่งน้ำหนัก) ผิด เพราะ rubric บอกชัดว่าไม่ชั่ง.\nสถานีนี้ประเมินทักษะ sampling + shaking technique + interpretation — ไม่ใช่ lab analysis.',
  ...
  { id: 8553, subject: 'ruminant-clinical', topic: 'rum-hattakan', year: 5,
    ...
    options: [
      'นำปลายเข็มไปแตะที่ตำแหน่งที่จะฉีดยาเท่านั้น ไม่ต้องแทงเข็มเข้าโมเดล',
      'แทงเข็มเข้าโมเดลโคให้ลึกตามตำแหน่งจริง',
      'ฉีดน้ำกลั่นเข้าโมเดลเพื่อทดสอบ flow',
      'อธิบายตำแหน่งฉีดด้วยปากเปล่า ไม่ต้องสัมผัสโมเดล',
      'ส่งโมเดลให้ผู้คุมสอบฉีดแทน',
    ],
    answer: 0,
    explain: 'เอกสาร p.12 instruction 5 ระบุชัดว่า: "แต่ไม่ต้องแทงเข็มเข้าไปในโมเดลโค ให้เพียงนำปลายเข็มไปแตะที่ตำแหน่งที่จะฉีดยาเท่านั้น เมื่อปฏิบัติเสร็จสิ้นแล้วให้นิสิตวางอุปกรณ์ทั้งหมดลงบนโต๊ะสอบ".\nหมายเหตุเพิ่ม: หากจำเป็นต้องแบ่งฉีดเป็น 2 จุด ต้องทำให้เห็นชัดเจน (ไปแตะทั้ง 2 จุด).\nเตรียมตัว: ฝึกกับโมเดลโคที่ห้อง skill lab ชั้น 8 ตึก 60 ปี + playlist บน myCV.',
