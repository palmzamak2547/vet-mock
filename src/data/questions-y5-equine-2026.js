...
export const QUESTIONS_Y5_EQUINE_2026 = [
  ...
  },
  {
    ...
    "answer": 1,
    "explain": "เอกสารเขียนว่า microbial population ใช้เวลา 2-3 สัปดาห์ในการปรับตัวกับอาหารชนิดใหม่ แม้จะเป็นหญ้าคนละล็อตก็ตาม จึงเป็นเหตุผลที่การเปลี่ยนอาหารต้องค่อยเป็นค่อยไป และสอดคล้องกับวิธีปล่อยแปลงในเอกสารเดียวกันที่ให้ไล่เพิ่มวันละ 15 นาทีจนครบ 20 วัน\n\n❌ ทำไมข้ออื่นผิด\n— 2-3 ชั่วโมง = เป็นระดับเวลาของการผ่านของอาหาร ไม่ใช่การเปลี่ยนประชากรจุลชีพ\n— 2-3 วัน = สั้นกว่าที่เอกสารกำหนด ดูหมายเหตุด้านล่าง\n— 2-3 เดือน = ยาวเกินเกณฑ์ที่ใช้จริง\n\n⚠️ ทำไมบางแหล่งตอบ 2-3 วัน ตัวเลขทั้งสองมาจากการวัดคนละอย่าง งานที่เปลี่ยนจากหญ้าแห้งไปแปลงหญ้าสด ซึ่งเป็นหยาบไปหยาบเหมือนโจทย์ข้อนี้ พบว่ากลุ่มแบคทีเรียเข้าที่ภายในราว 4 วันแล้วนิ่งยาวถึงวันที่ 21 และผู้วิจัยเองระบุว่าเร็วกว่าที่เคยรายงานไว้ ส่วนงานที่เปลี่ยนจากหยาบไปอาหารข้นแบบกะทันหันพบว่าชุมชนจุลชีพถูกรบกวนชัดภายใน 2 วัน แต่กว่าจะกลับสู่ระดับเดิมใช้เวลา 3-4 สัปดาห์ เกณฑ์ 2-3 สัปดาห์จึงเป็นค่าที่เผื่อกรณีหนักไว้แล้ว และเป็นค่าที่เอกสารของรายวิชาสอน\n\n💡 เวลาสอบตอบตามเอกสารคือสัปดาห์ เวลาใช้จริงให้ดูด้วยว่าเปลี่ยนจากอะไรไปเป็นอะไร",
    "verified": "Equine Med 85 น.8",
    "sourceType": "lecture-derived",
    "source": "Equine Med deck (Vet 85)"
  },
