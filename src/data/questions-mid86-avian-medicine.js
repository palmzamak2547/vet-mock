...
export const QUESTIONS_MID86_AVIAN_MEDICINE = [
  ...
  },
  {
    ...
    "keywords": [
      ...
      "ต้องมีมาตรการเฝ้าระวัง", "28 วันหลัง stamping out ตาม Code ฉบับปัจจุบัน"
    ],
  ...
  },
  {
    ...
    "answer": true,
    "explain": "ถูก ปัจจุบัน P. multocida มีอย่างน้อย 20 ซีโรไทป์ ตัวเลข 15-16 ซีโรไทป์เป็นข้อมูลเก่า วัคซีนแบคทีเรียที่ไม่ตรง serotype หรือ antigen จึงให้ cross protection ต่ำ ฟาร์มที่ไม่พบโรค 5-6 ปีจึงอาจถอดวัคซีนนี้ออก หมายเหตุ: ตัวเลขอ้างอิงสากล (Merck) ยังนับ P. multocida เป็น 16 somatic serotypes กับ 5 capsular types ตัวเลขมากกว่า 20 เป็นตามที่แก้ในคาบ",
    "source": "สรุปรวมรุ่นพี่ Avian Medicine (Fowl cholera)",
  ...
  },
  {
    ...
    "answer": false,
    "explain": "ผิด ยากลุ่มซัลฟาโดยเฉพาะซัลฟาไดเมทอกซินตกผลึกในไตได้ จึงควรให้ 2 วันหยุด 1 วัน ไม่ให้ติดต่อกัน 3-4 วัน และในไก่ไข่ต้องระวัง withdrawal time เพราะยาถ่ายทอดไปในฟองไข่ได้ ยาอื่นที่เอ่ยคือแอมพิซิลลินและอะม็อกซีซิลลินตามผล sensitivity หมายเหตุ: ฉลากยา sulfadimethoxine กำหนดให้ 6 วันติดต่อกัน การให้ 2 วันหยุด 1 วันเป็นแนวปฏิบัติที่แนะนำในคาบเพื่อลดพิษต่อไต ไม่ใช่ขนาดยาตามฉลาก",
    "source": "VET86 คาบ Colibacillosis, Fowl cholera, Infectious coryza 18 ส.ค. (อ.สมศักดิ์)",
  ...
  },
  {
    ...
    "answer": false,
    "explain": "ผิด การควบคุม AE ทำที่ไก่พ่อแม่พันธุ์ ให้พ่อแม่มีภูมิแล้วส่งภูมิให้ลูกป้องกันช่วงแรกที่ไวต่อโรค วัคซีนเชื้อเป็นให้ในไก่รุ่นของฝูงพันธุ์ (ในคาบระบุราว 6 สัปดาห์ ตำราให้ที่ 8 สัปดาห์ขึ้นไปและก่อนเริ่มไข่อย่างน้อย 4 สัปดาห์) ส่วนวัคซีนที่ทำในไก่เนื้อมีเพียง ND, IB และ IBD",
    "source": "บันทึกหลังสอบ Avian Medicine (AE)",
  ...
  },
  {
    ...
    "answer": false,
    "explain": "ผิด ไก่พ่อแม่พันธุ์ที่ติด AE ระหว่างให้ไข่ พบเพียงไข่ลดเล็กน้อย (ในคาบระบุราว 15% ตำราระบุ 5-10% นานไม่เกิน 2 สัปดาห์) เพราะไก่มีไข้เล็กน้อยขณะสร้างภูมิสู้ไวรัส ไม่มีอาการทางประสาทในไก่โต แต่ส่งเชื้อไปให้ลูกจนลูกป่วยและตายได้",
    "source": "VET86 คาบ Omphalitis, Ascites, Staphylococcus, AE, Adenovirus, Salmonella 15 ก.ย. (อ.เกรียงวิชญ์)",
