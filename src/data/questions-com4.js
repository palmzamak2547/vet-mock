...
export const QB_COM4 = [
  ...
  },
  {
    ...
    "imageAlt": "แผนภาพวงจรการเจริญของขนสามระยะ ได้แก่ Anagen, Catagen และ Telogen วางเป็นวง พร้อมคำอธิบายสั้นใต้ชื่อแต่ละระยะ",
  ...
  },
  {
    ...
    "imageAlt": "ภาพวาดเปรียบเทียบรูปร่างเม็ดเลือดแดงสองแบบใน blood smear วางซ้ายและขวา พร้อมคำบรรยายลักษณะใต้แต่ละกลุ่ม",
  ...
  },
  {
    ...
    "answer": 3,
    "explain": "Cyclosporine ใน IBD: 3-7 mg/kg PO BID, alternative ใน steroid-refractory IBD, onset 4-6 wk, ระวัง side effects (gum hyperplasia, GI, papillomatosis), monitor blood level ในกรณี severe, alternative cyclosporine: chlorambucil 2 mg/m² (cat), azathioprine 2 mg/kg (dog only)\n\n❌ ทำไมข้ออื่นผิด\n— 1 mg/kg = ต่ำเกิน\n— 50 mg/kg = สูงเกินอันตราย\n— IV only = ผิด, oral standard",
  ...
  },
  {
    ...
    "answer": 2,
    "explain": "Azathioprine ห้ามใช้ในแมว ★★ เพราะแมวขาด thiopurine S-methyltransferase (TPMT) → metabolize ไม่ได้ → severe bone marrow suppression (pancytopenia) + acute pancreatic necrosis, ใน cat ใช้ Chlorambucil แทน (alkylating, steroid-sparing for feline IMHA/IBD/PF)\n\n❌ ทำไมข้ออื่นใช้ได้\n— Cyclosporine = ใช้ได้ทั้งสุนัขและแมว\n— MMF = ใช้ได้, GI side effect\n— Chlorambucil = TOC ในแมวสำหรับ steroid-sparing\n— Leflunomide = ใช้ได้",
  ...
  },
  {
    ...
    "answer": 4,
    "explain": "Clopidogrel (Plavix) 1-3 mg/kg PO q24h = first-line antiplatelet ใน IMHA, ± low-dose aspirin 0.5 mg/kg/day ★, ลด platelet aggregation ที่กระตุ้นจาก inflammatory state, LMWH สามารถใช้ adjunct ได้ในกรณี acute, monitoring: TEG, anti-Xa\n\n❌ ทำไมข้ออื่นผิด\n— Heparin alone = ไม่ block platelet aggregation, ใช้ adjunct\n— Warfarin = แคบ therapeutic window, ตรวจ INR ยาก, ไม่ first-line in vet\n— Vitamin K = antidote rodenticide, ตรงข้าม\n— tPA = thrombolytic, severe PTE acute, ไม่ใช่ prophylaxis",
