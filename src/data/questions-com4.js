...
export const QB_COM4 = [
  ...
  { id: 1101, subject: 'com4', topic: 'sle', year: 4, source: 'TJ86 GN T/F',
    tags: ['gn', 'tf', 'nephrotic-syndrome', 'tj86'], type: 'mcq',
    q: '[T/F] สัตว์ที่ป่วยด้วยโรคในกลุ่ม Nephrotic Syndrome จะพบว่ามีอัลบูมินในเลือดต่ำ ไขมันในเลือดสูง ระดับคลอเลสเตอรอลในเลือด และมีของเหลวสะสมในส่วนต่างๆ ของร่างกาย',
    options: ['ถูก (True)', 'ผิด (False)'],
    answer: 1, explain: '❌ ผิด (TJ86 ระบุ F — น่าจะจาก wording ของโจทย์ที่ระบุ "ระดับคลอเลสเตอรอลในเลือด" โดยไม่บอก "**สูง**" จึงไม่ครบ tetrad)\n\n💡 **Nephrotic Syndrome tetrad** (4 ข้อต้องครบ):\n1. **Proteinuria** > 3.5 g/day (in human; UPC > 3.5 in vet)\n2. **Hypoalbuminemia** (อัลบูมินต่ำ < 2.0 g/dL)\n3. **Hypercholesterolemia / Hyperlipidemia** (ไขมัน + cholesterol สูง — liver compensates by ↑ lipoprotein synthesis)\n4. **Edema / Effusion** (ของเหลวสะสม — ascites, peripheral edema, pulmonary edema)\n\n💡 ข้อความใน TJ86 ขาดคำว่า "**สูง**" ก่อน "ระดับคลอเลสเตอรอล" → incomplete tetrad → marked F\n\n💡 ถ้าโจทย์ระบุครบ "Hypoalbuminemia + **Hyper**cholesterolemia + Edema + (Proteinuria implied)" → จะเป็น True',
    verified: 'TJ86 รวบรวมโพยรุ่นพี่ p.2 GN #8 (F — incomplete tetrad in wording)' },
  ...
  { id: 1110, subject: 'com4', topic: 'sle', year: 4, source: 'TJ86 SLE T/F',
    tags: ['sle', 'tf', 'lymphopenia', 'tj86', 'critical'], type: 'mcq',
    q: '[T/F] ในสุนัขที่ป่วยด้วยโรค SLE จะตรวจพบมีภาวะ "Lymphocytosis" ร่วมกับมีค่า CD4:CD8 ที่ต่ำกว่าปกติ',
    options: ['ถูก (True)', 'ผิด (False)'],
    answer: 1, explain: '❌ ผิด · **SLE → Lymphopenia (ไม่ใช่ Lymphocytosis!)** ★ พลาดง่าย\n\n💡 **CBC findings in canine SLE**:\n— **Lymphopenia** (anti-lymphocyte antibody → destruction)\n— **Anemia** (immune-mediated hemolytic — IMHA component, regenerative)\n— **Thrombocytopenia** (IMT component)\n— **Neutropenia** (anti-neutrophil antibody, sometimes)\n\n💡 **Immunologic findings**:\n— **CD4:CD8 ratio ต่ำกว่าปกติ** (TJ86 ส่วนนี้ถูก) — เพราะ CD4+ T-cells preferentially destroyed\n— Hypergammaglobulinemia (polyclonal B-cell activation)\n— Hypocomplementemia (consumed in immune complex formation)\n— Positive ANA test (sensitivity ~ 60-100%, depends on substrate)\n— Anti-dsDNA (specific but less sensitive)\n\n💡 ทำไม TJ86 ตอบ F: เพราะ SLE = lymph**openia** (low) ไม่ใช่ lymph**ocytosis** (high) — เป็นจุดพลาดง่ายในข้อสอบ ★',
    verified: 'TJ86 รวบรวมโพยรุ่นพี่ p.2 SLE #20 (F) ★ พลาดง่าย' },
