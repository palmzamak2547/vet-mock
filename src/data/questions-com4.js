...
export const QB_COM4 = [
  ...
  { id: 1000, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Acute GI infection', 'Chronic inflammation ของ stomach/intestine/colon โดย unknown etiology · มี persistent (>3 wk) GI signs · ไม่ตอบ symptomatic Tx', 'Bacterial enteritis', 'Worm infestation'],
  ...
  { id: 1001, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['CBC + chemistry abnormal', '(1) Persistent GI signs > 3 wk · (2) Failure to respond ATB/parasiticide/GI protectants · (3) R/O other GI causes · (4) Histologic Dx ของ benign intestinal inflammation', 'Acute vomiting only', 'Weight gain'],
  ...
  { id: 1002, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Pug, Bulldog', 'Weimaraner, Rottweiler, GSD, Border Collie, Boxer', 'Greyhound', 'Pomeranian'],
  ...
  { id: 1003, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Bacterial overgrowth เท่านั้น', 'Loss of immunologic tolerance to normal bacterial flora/food antigens → abnormal T-cell activation → ↑ inflammatory cytokines', 'Genetic mutation in collagen', 'Hormonal imbalance'],
  ...
  { id: 1004, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Small bowel diarrhea', 'Large bowel diarrhea (colitis)', 'Both equally', 'Foreign body'],
  ...
  { id: 1005, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Distal small intestine (ileum)', 'Proximal small intestine (duodenum, jejunum)', 'Stomach', 'Colon'],
  ...
  { id: 1006, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['ไม่มีประโยชน์', '↓ Cobalamin = distal SI (ileum) disease หรือ EPI (intrinsic factor deficiency) · ต้อง supplement parenteral หรือ oral', 'High = สุขภาพดี', 'ใช้แทน TLI test'],
  ...
  { id: 1007, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Liver disease', 'Exocrine Pancreatic Insufficiency (EPI) — fasting TLI ต่ำ = EPI', 'Renal failure', 'Hyperthyroidism'],
  ...
  { id: 1008, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['IBD เท่านั้น', 'PLE, intestinal lymphangiectasia, ARE (antibiotic-responsive enteropathy), IBD, eosinophilic GE, LPE (lymphocytic plasmacytic enteritis), intestinal lymphoma, EPI', 'Pneumonia', 'Acute pancreatitis'],
  ...
  { id: 1009, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['CBC แค่อย่างเดียว', 'Intestinal biopsy (endoscopic หรือ surgical) + histopathology — confirm benign chronic inflammation + R/O lymphoma', 'X-ray', 'Stool culture'],
  ...
  { id: 1010, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Steroid ทันที', 'Step 1: Diet trial (novel protein/hydrolyzed) → Step 2: + ATB (metronidazole/tylosin) → Step 3: + immunosuppressive (prednisolone)', 'Surgery', 'ATB อย่างเดียว'],
  ...
  { id: 1011, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Cephalexin', 'Metronidazole 10-20 mg/kg BID, Tylosin 25 mg/kg, Oxytetracycline', 'Penicillin G', 'Furosemide'],
  ...
  { id: 1012, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['ไม่มี side effect', 'Keratoconjunctivitis sicca (KCS, dry eye) — ตรวจ Schirmer tear test ก่อน-หลัง', 'Renal failure เท่านั้น', 'Cataract'],
  ...
  { id: 1013, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['1 mg/kg SID', '3-7 mg/kg PO BID', '50 mg/kg BID', 'IV only'],
  ...
  { id: 1014, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Cure ได้ในทุก case', 'Short-term good-to-excellent · cure rare · relapse common · poor outcome ใน PLE form, fibrosis, histiocytic ulcerative colitis', 'Always poor', 'No relapse'],
