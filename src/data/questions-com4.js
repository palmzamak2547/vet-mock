...
export const QB_COM4 = [
  ...
  { id: 983, subject: 'com4', topic: 'imha', year: 4, source: 'Immune-mediated_Hemolytic_anemia.pdf',
    ...
    options: ['1 type — autoimmune ทั้งหมด ไม่มี subtype แยก', '2 types: Primary (idiopathic, autoimmune) + Secondary (known infection, drug, neoplasia trigger)', '3 types ตาม clinical course: Peracute, Acute, Chronic (≥ 30 d)', '4 types ตาม Ig subclass: IgG-, IgM-, IgA-, complement-mediated'],
  ...
  { id: 984, subject: 'com4', topic: 'imha', year: 4, source: 'Immune-mediated_Hemolytic_anemia.pdf',
    ...
    options: ['Greyhound, Whippet, Saluki — sighthound กลุ่มเสี่ยง autoimmune โรคเลือด', 'Cocker Spaniel, English Springer Spaniel, Old English Sheepdog, Standard Poodle, Irish Setter', 'Pug, French Bulldog, Boston Terrier — brachycephalic แพ้ภูมิตนเองง่าย', 'Pomeranian, Chihuahua, Yorkshire Terrier — toy breed มี IMHA สูงในเอเชีย'],
  ...
  { id: 987, subject: 'com4', topic: 'imha', year: 4, source: 'Immune-mediated_Hemolytic_anemia.pdf',
    ...
    options: ['Acute kidney injury จาก hemoglobinuria pigment nephropathy', 'Pulmonary thromboembolism (PTE) + DIC + thromboembolic disease', 'Severe hyperkalemia + cardiac arrhythmia จาก mass RBC lysis', 'Hepatic failure จาก bilirubin overload + cholestatic injury'],
  ...
  { id: 988, subject: 'com4', topic: 'imha', year: 4, source: 'Immune-mediated_Hemolytic_anemia.pdf',
    ...
    options: ['0.5 mg/kg/d — anti-inflammatory dose ใช้ใน mild flare เท่านั้น', '2-3 mg/kg/d (หรือ 50-60 mg/m² for dogs > 25 kg) — immunosuppressive dose', '5-6 mg/kg/d — pulse therapy ในรายที่ไม่ตอบสนอง steroid ปกติ', 'Dexamethasone IV bolus เท่านั้น — pred PO ห้ามใช้ใน IMHA acute'],
  ...
  { id: 989, subject: 'com4', topic: 'imha', year: 4, source: 'Immune-mediated_Hemolytic_anemia.pdf',
    ...
    options: ['NSAIDs (carprofen, meloxicam) ลด inflammation ของ RBC membrane', 'Azathioprine (dog only) / Cyclosporine / Mycophenolate mofetil / Leflunomide / IVIG', 'Doxycycline + chloramphenicol ครอบคลุม secondary infection trigger', 'Erythropoietin + iron dextran SC กระตุ้น erythropoiesis ทดแทน RBC'],
  ...
  { id: 990, subject: 'com4', topic: 'imha', year: 4, source: 'Immune-mediated_Hemolytic_anemia.pdf',
    ...
    options: ['CBC + bone marrow biopsy ทุก 6 mo เป็นเวลา 5 ปี', 'PCV/Hct ทุก 3 wk + bilirubin + UA q8-12 wk + watch relapse 11-15%', 'Coombs test ทุกเดือน + ANA titer ทุก 3 mo ไปตลอดชีวิต', 'CBC + chemistry ทุก 1 ปี ก็เพียงพอเมื่อ stable'],
  ...
  { id: 992, subject: 'com4', topic: 'sle', year: 4, source: 'Systemic_Lupus_Erythematosus.pdf',
    ...
    options: ['1 organ involved + ANA positive titer ≥ 1:40 ก็เพียงพอแล้ว', '≥ 2 organ system dysfunction + high ANA titer + most have polyarthritis', 'Coombs positive + thrombocytopenia (อย่างใดอย่างหนึ่ง) เพียงพอ', 'Skin biopsy พบ interface dermatitis + lupus band เท่านั้น'],
  ...
  { id: 993, subject: 'com4', topic: 'sle', year: 4, source: 'Systemic_Lupus_Erythematosus.pdf',
    ...
    options: ['Pug, French Bulldog, Boston Terrier — brachycephalic แพ้ภูมิตนเอง', 'German Shepherd, Shetland Sheepdog, Collie, Beagle, Poodle, Afghan Hound', 'Greyhound, Whippet, Saluki — sighthound กลุ่มเสี่ยง autoimmune', 'Labrador, Golden Retriever, Lab cross — large breed prevalence สูง'],
  ...
  { id: 994, subject: 'com4', topic: 'sle', year: 4, source: 'Systemic_Lupus_Erythematosus.pdf',
    ...
    options: ['Generalized pruritus + alopecia เป็นอาการหลัก (เหมือน atopic dermatitis)', 'Polyarthritis (most common) + skin lesion ที่ MC junction + proteinuria → glomerulonephritis + cytopenias', 'PU/PD + truncal alopecia + pendulous abdomen (เหมือน hyperadrenocorticism)', 'Persistent vomiting + chronic diarrhea + weight loss (GI predominant)'],
  ...
  { id: 995, subject: 'com4', topic: 'sle', year: 4, source: 'Systemic_Lupus_Erythematosus.pdf',
    ...
    options: ['CBC + serum chemistry + thyroid panel เป็น minimum workup เพียงพอ', 'Coombs\' test + blood chem + UA + skin biopsy + radiography + synovial fluid analysis + ANA test', 'Skin scraping + dermatophyte culture + Wood\'s lamp + cytology (parasitic R/O)', 'Fecal float + endoscopic biopsy + cobalamin/folate (GI workup)'],
  ...
  { id: 997, subject: 'com4', topic: 'sle', year: 4, source: 'Systemic_Lupus_Erythematosus.pdf',
    ...
    options: ['พบบ่อยกว่าสุนัข + breed prevalence: DSH > Siamese · onset 5-10 yr', 'Extremely rare · ต้อง FeLV-/FIV- · breeds Siamese/Persian/Persian-mixed · paronychia + small crusts ventrum', 'พบเฉพาะแมวอ้วน + วัยกลางคน + outdoor exposure (UV-induced)', 'ไม่พบใน cat — เป็น species-specific โรคของสุนัขเท่านั้น'],
  ...
  { id: 998, subject: 'com4', topic: 'sle', year: 4, source: 'Systemic_Lupus_Erythematosus.pdf',
    ...
    options: ['Specific 100% — ANA positive titer ≥ 1:160 = SLE definite ไม่ต้อง workup เพิ่ม', 'Sensitive ~60-90% in dog SLE · titer สูงสำคัญ · false-positive ใน infection/neoplasia/cat · ใช้ร่วม clinical criteria', 'ใช้ใน cat เท่านั้น — dog SLE ใช้ direct Coombs test แทน ANA', 'Replace clinical signs — ANA positive ก็ไม่จำเป็นต้องดูอาการแล้ว'],
  ...
  { id: 999, subject: 'com4', topic: 'sle', year: 4, source: 'Systemic_Lupus_Erythematosus.pdf',
    ...
    options: ['ไม่ต่างกัน — ทั้ง SLE และ erosive ทำลาย cartilage เหมือนกัน', 'SLE polyarthritis = non-erosive (ไม่มี joint destruction บน X-ray) · vs. erosive arthritis = bone erosion + joint deformity', 'SLE = erosive type — ทำลาย bone + cartilage รุนแรงกว่า rheumatoid', 'SLE ไม่มี polyarthritis — ออกแค่ skin + kidney เท่านั้น'],
  ...
  { id: 1002, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Pug, French Bulldog, Boston Terrier — brachycephalic GI motility ผิดปกติ', 'Weimaraner, Rottweiler, GSD, Border Collie, Boxer — large breed predisposed', 'Greyhound, Whippet, Saluki — sighthound แพ้อาหารง่ายตามสายพันธุ์', 'Pomeranian, Chihuahua, Yorkshire Terrier — toy breed sensitivity GI'],
    answer: 1, explain: 'IBD predisposed (UK study, OR vs mixed-breed): Weimaraner OR 3.68 · Rottweiler OR 2.97 · GSD OR 2.41 · Border Collie OR 1.99 · Boxer OR 1.70 · genetic + immune + environmental component (gut microbiota dysbiosis)\n\n❌ ทำไมข้ออื่นผิด\n— Pug/Bulldog = brachycephalic\n— Greyhound = sighthound\n— Pomeranian = small breed concerns',
  ...
  { id: 1003, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Small intestinal bacterial overgrowth (SIBO) เท่านั้นเป็นกลไกหลักของ IBD', 'Loss of immunologic tolerance to normal flora/food antigens → T-cell activation → ↑ inflammatory cytokines', 'Mutation in mucin gene (MUC2) → loss of mucus barrier → chronic ulcer formation', 'Cortisol deficiency → ลด regulatory effect ต่อ gut immune system (Addisonian-like)'],
    answer: 1, explain: 'IBD immunologic mechanism: gut หลุดความ tolerance ต่อ commensal bacteria + food antigens → indirect T-cell activation → cytokine over-production (IL-1, IL-6, TNF-α, IL-17) → mucosal inflammation + ↑ permeability + dysbiosis · innate + adaptive immune both involved · genetic + environmental triggers\n\n❌ ทำไมข้ออื่นผิด\n— Bacterial overgrowth = SIBO (different syndrome)\n— Collagen mutation = ไม่เกี่ยว\n— Hormonal = endocrine',
  ...
  { id: 1004, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Small bowel diarrhea — large volume + watery + melena + weight loss', 'Large bowel diarrhea (colitis) — mucus + tenesmus + frequent small + hematochezia', 'Mixed bowel (small + large) — generalized GI inflammation pattern', 'Foreign body obstruction — acute focal pain + episodic vomiting + anorexia'],
    answer: 1, explain: 'Large bowel diarrhea (colitis) signs: mucus + tenesmus + frequent small volumes + fresh blood (hematochezia) · vs. Small bowel: large volume + watery + melena (digested blood) ± weight loss + hypoalbuminemia · localization helps differential\n\n❌ ทำไมข้ออื่นผิด\n— Small bowel = large volume + melena\n— Both = ไม่ใช่ pattern เฉพาะ\n— FB = acute, focal',
  ...
  { id: 1005, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Distal small intestine (ileum) — folate absorbed via intrinsic factor pathway', 'Proximal small intestine (duodenum + proximal jejunum) — folate absorbed here', 'Stomach (gastric body + fundus) — folate absorbed before entering SI', 'Colon (proximal + distal) — folate absorbed by colonocyte ผ่าน bacteria'],
    answer: 1, explain: 'Folate = absorbed in proximal SI (duodenum + proximal jejunum) → ↑ folate = SIBO (bacteria สร้าง folate) · ↓ folate = proximal SI mucosal disease (IBD, lymphoma) · Cobalamin = absorbed in distal SI (ileum) ผ่าน intrinsic factor → ↓ B12 = distal SI disease (EPI ก็ทำให้ ↓ จาก IF deficiency) · folate + B12 ใช้ localize disease\n\n❌ ทำไมข้ออื่นผิด\n— Distal SI / ileum = cobalamin\n— Stomach = gastric biopsy\n— Colon = distal large bowel',
  ...
  { id: 1007, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Liver disease — TLI ต่ำใน hepatic failure (decreased clearance)', 'Exocrine Pancreatic Insufficiency (EPI) — fasting TLI ต่ำ = EPI confirmed', 'Renal failure — TLI สูงเพราะ kidney clear enzyme ไม่ออก (false elevation)', 'Hyperthyroidism (cat) — TLI ต่ำเพราะ pancreatic atrophy จาก thyroid'],
    answer: 1, explain: 'TLI: ↓ TLI fasting = EPI (atrophy ของ pancreatic acinar cells, ส่วนใหญ่ใน GSD ตามพันธุกรรม) · classic signs: chronic diarrhea + weight loss แม้กินเยอะ + steatorrhea + cobalamin ต่ำ (ขาด IF) · Tx: pancreatic enzyme replacement (Viokase, Pancrezyme) + B12 supplementation\n\n❌ ทำไมข้ออื่นผิด\n— Liver = ALT/ALP/bile acids\n— Renal = BUN/Cr\n— Hyperthyroid = T4 (cat)',
  ...
  { id: 1008, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['IBD เท่านั้น — chronic diarrhea = IBD by default ใน dog ไม่ต้อง R/O อื่น', 'PLE, lymphangiectasia, ARE, IBD, eosinophilic GE, LPE, intestinal lymphoma, EPI', 'Hyperthyroidism + diabetes mellitus + Cushing\'s — endocrine causes เป็นหลัก', 'Acute pancreatitis + cholecystitis + hepatic lipidosis — hepatobiliary causes'],
    answer: 1, explain: 'Chronic diarrhea DDx: PLE (protein-losing enteropathy) · intestinal lymphangiectasia · lesion of intestinal crypts · maldigestion (EPI) · malabsorptive SI disease · ARE (antibiotic-responsive enteropathy) · IBD · eosinophilic GE · LPE (lymphocytic plasmacytic enteritis = histopath subtype of IBD) · intestinal lymphoma (อาจ mimic IBD ใน histopath)\n\n❌ ทำไมข้ออื่นผิด\n— "IBD เท่านั้น" = ผิด, broad differential\n— Pneumonia / acute pancreatitis = ไม่ใช่ chronic diarrhea',
  ...
  { id: 1009, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['CBC + serum chemistry + albumin level + cobalamin/folate panel เพียงพอ', 'Intestinal biopsy (endoscopic หรือ surgical) + histopathology — confirm benign chronic inflammation + R/O lymphoma', 'Abdominal radiograph + barium contrast study ดู mucosal pattern', 'Fecal culture + fecal PCR + parasitology — R/O infectious causes'],
    answer: 1, explain: 'IBD definitive Dx: full-thickness biopsy (surgical) หรือ endoscopic biopsy (multi-site, multiple specimens) → histopath: inflammatory infiltrate (lymphocytic, plasmacytic, eosinophilic) + villus atrophy/fusion + crypt distortion · grade severity (mild/mod/severe) · ต้อง R/O lymphoma (PARR test, IHC for clonality) · CBC/chem/UA, US ใช้ supportive\n\n❌ ทำไมข้ออื่นผิด\n— CBC alone = supportive\n— X-ray = limited info\n— Stool culture = R/O bacterial',
    verified: 'INFLAMATORY_BOWEL_Disease.pdf p.21' },
  ...
  { id: 1012, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['ไม่มี side effect significant — ปลอดภัยมาก ไม่ต้อง monitor เป็นพิเศษ', 'Keratoconjunctivitis sicca (KCS, dry eye) — ต้อง Schirmer tear test ก่อน + ทุก 2 wk', 'Acute renal failure — ต้องวัด BUN/Cr ทุก 2 wk เป็น dose-limiting toxicity', 'Cataract bilateral progressive — ต้อง fundoscopy + slit lamp ทุก 1 mo'],
    answer: 1, explain: 'Sulfasalazine 10-25 mg/kg PO TID-QID dog (used in large bowel IBD/colitis) · metabolize เป็น 5-aminosalicylate (anti-inflammatory @ colon) + sulfapyridine · side effect dog: KCS (sulfa-induced) → ต้อง monitor Schirmer tear test ก่อน + ทุก 2 wk · cat: salicylate toxicity → ใช้ low dose 5-12.5 mg/kg PO TID อย่างระวัง\n\n❌ ทำไมข้ออื่นผิด\n— "ไม่มี" = ผิด\n— Renal only = ไม่ใช่ classic side effect\n— Cataract = unrelated',
  ...
  { id: 1013, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['1 mg/kg PO SID — maintenance dose only หลัง induction หาย', '3-7 mg/kg PO BID — induction + maintenance dose ตาม Aj. Rosama', '20-30 mg/kg PO BID — high-dose protocol สำหรับ refractory IBD', 'IV bolus 5 mg/kg q24h — oral absorption ของ cyclosporine ไม่แน่นอน'],
    answer: 1, explain: 'Cyclosporine ใน IBD: 3-7 mg/kg PO BID (ข้อสอบ Aj. Rosama) · alternative ใน steroid-refractory IBD · onset 4-6 wk · ระวัง side effects (gum hyperplasia, GI, papillomatosis) · monitor blood level ในกรณี severe · alternative cyclosporine: chlorambucil 2 mg/m² (cat), azathioprine 2 mg/kg (dog only)\n\n❌ ทำไมข้ออื่นผิด\n— 1 mg/kg = ต่ำเกิน\n— 50 mg/kg = สูงเกินอันตราย\n— IV only = ผิด, oral standard',
  ...
  { id: 1014, subject: 'com4', topic: 'ibd', year: 4, source: 'INFLAMATORY_BOWEL_Disease.pdf',
    ...
    options: ['Cure ได้ในทุก case ภายใน 6 เดือนถ้าเริ่ม Tx ทันท่วงที + diet เคร่งครัด', 'Short-term good-to-excellent · cure rare · relapse common · poor ใน PLE form, fibrosis, histiocytic ulcerative colitis', 'Always poor — IBD = terminal disease, mortality > 80% ภายใน 1 ปี', 'No relapse ตลอดชีวิตหลังจาก Tx 4 wk + diet trial — chronic แต่ไม่ recurrent'],
    answer: 1, explain: 'IBD prognosis: short-term response 70-90% ดี · cure rare · relapse common (need long-term Tx, monitoring) · poor prognostic factors: PLE (hypoalbuminemia → ascites), severe fibrosis, histiocytic ulcerative colitis (Boxer), severe hypocobalaminemia, eotaxin, Beagle/GSD with refractory disease · client compliance critical\n\n❌ ทำไมข้ออื่นผิด\n— "Cure ทุก case" = ผิด\n— "Always poor" = ผิด, มัก stable\n— "No relapse" = ผิด, common',
  ...
  { id: 1019, subject: 'com4', topic: 'peds-geri', year: 4, source: 'Pediatrics_and_Geriatrics.pdf',
    ...
    options: ['ไม่จำเป็นต้องได้', 'Within 24 hr (gut closure 48-72 hr) → IgG + IgA absorption · ถ้าไม่มี colostrum ใช้ maternal serum oral', '1 สัปดาห์', '1 เดือน'],
    answer: 1, explain: 'Colostrum: critical within 24 hr of birth (gut permeability declines after 8 hr, closes 48-72 hr) · IgG + IgA passively absorbed (IgM too large) · maternal serum (from healthy adult dog) PO เป็น alternative ถ้า colostrum ไม่มี · check ALP/GGT — high ในช่วง 2 wk แรก (เป็น marker ของ colostrum intake) · failure of passive transfer = ↑ neonatal mortality\n\n❌ ทำไมข้ออื่นผิด\n— "ไม่จำเป็น" = ผิด\n— "1 wk" / "1 mo" = สายเกิน, gut closed แล้ว',
  ...
  { id: 1021, subject: 'com4', topic: 'peds-geri', year: 4, source: 'Pediatrics_and_Geriatrics.pdf',
    ...
    options: ['10-20 ml/kg/d', '120-180 ml/kg/d (neonate); 80-120 ml/kg/d (pediatric)', '300 ml/kg/d', 'No fluids needed'],
    answer: 1, explain: 'Neonate maintenance: 120-180 ml/kg/d · Pediatric (older): 80-120 ml/kg/d · Higher than adult เพราะ: ↑ body surface area : weight ratio · ↑ extracellular fluid · less body fat · ↑ metabolic + respiratory rate · ↓ renal concentrating ability · severe dehydration shock dose: 30-45 ml/kg dog · 20-30 ml/kg cat · routes: oral-gastric (NOT in hypothermic), SC/IP (no dextrose, normothermic), IV/IO (jugular, tibial crest, humerus)\n\n❌ ทำไมข้ออื่นผิด\n— 10-20 = adult maintenance\n— 300 = สูงเกินไป\n— No fluids = ผิด',
  ...
  { id: 1022, subject: 'com4', topic: 'peds-geri', year: 4, source: 'Pediatrics_and_Geriatrics.pdf',
    ...
    options: ['Asymptomatic', 'Lethargy, decreased suckle, crying, limp, tremors, seizures, coma · Tx: milk replacer/corn syrup PO ถ้า conscious; dextrose IV CRI ถ้า severe', 'Aggressive behavior', 'Hypertension'],
    answer: 1, explain: 'Hypoglycemia ใน neonate: signs anorexia, lethargy, ↓ suckle, crying, limp body, tremors, coma, seizures · cause: insufficient hepatic gluconeogenesis + low glycogen + immature insulin/glucagon feedback · Tx if conscious: milk replacer, corn syrup, glucose solution PO · IV: 0.5-1 ml/kg of 50% dextrose dilute 1:4 → CRI 2.5-5% · monitor q1-2h · prevent recurrence (frequent feeding 8-12 ×/d in first wk)\n\n❌ ทำไมข้ออื่นผิด\n— "Asymptomatic" = ผิด, มี neurologic\n— Aggressive = ไม่ใช่ pattern\n— Hypertension = ตรงข้าม',
  ...
  { id: 1023, subject: 'com4', topic: 'peds-geri', year: 4, source: 'Pediatrics_and_Geriatrics.pdf',
    ...
    options: ['สุนัข บ่อย', 'แมว type B blood (British Shorthair, Persian, Rex, Ragdoll, Abyssinian) — kitten type A/AB กิน colostrum จากแม่ type B → anti-A antibody → RBC lysis', 'ไม่เกิดในสัตว์', 'หมูพันธุ์ใหญ่'],
    answer: 1, explain: 'NEI in cats: queen blood type B (British Shorthair, Devon/Cornish Rex, Abyssinian, Persian, Himalayan, Angora, Exotic, Ragdoll) มี strong anti-A IgG ใน colostrum · kitten type A/AB ที่กิน colostrum จาก B queen → severe IMHA · signs hours-days: hemoglobinuria, jaundice, anemia, sudden death, ear/tail tip necrosis · prevention: blood type ก่อนผสมพันธุ์ · ถ้า mismatch detected ก่อน 24 hr → แยก kitten นมตู้/foster type A queen · severe → transfusion\n\n❌ ทำไมข้ออื่นผิด\n— สุนัข = rare (no naturally occurring isoantibody at high titer)\n— "ไม่เกิด" = ผิด\n— หมู = ไม่ใช่ companion animal',
  ...
  { id: 1024, subject: 'com4', topic: 'peds-geri', year: 4, source: 'Pediatrics_and_Geriatrics.pdf',
    ...
    options: ['ลูกสัตว์ที่ขนเปลี่ยนสีเป็นจาง', 'Litter ที่ดูปกติแรกๆ แล้วค่อยๆ fade + die ใน 0-9-10 wk · multifactorial: maternal/neonate/environment/infection (virus, bacteria)', 'Hereditary albinism', 'อายุมากขึ้น'],
    answer: 1, explain: 'Fading puppy/kitten syndrome: multifactorial mortality · ดูปกติแรกเกิด → fade gradually → die · เกิด birth - 9-10 wk · causes: maternal (mastitis, poor mothering, nutritional) + neonatal (low BW, congenital defects, NEI) + environmental (cold, dirty) + infectious (CHV, CDV, CPV, FPV, FHV, FCV, bacteria, mycoplasma) · prevention: dam health pre-mating, strict hygiene, monitor weight daily, prompt vet care\n\n❌ ทำไมข้ออื่นผิด\n— "ขนเปลี่ยนสี" = ไม่ใช่\n— Hereditary albinism = different\n— "อายุมาก" = ตรงข้าม',
    verified: 'Pediatrics_and_Geriatrics.pdf p.30' },
  ...
  { id: 1028, subject: 'com4', topic: 'peds-geri', year: 4, source: 'Pediatrics_and_Geriatrics.pdf',
    ...
    options: ['ทุก 5 ปี', 'อย่างน้อยปีละครั้ง · ทุก 6 เดือนแนะนำ + comprehensive geriatric screening (CBC, chem, UA, BP, BCS/MCS, thyroid)', 'ไม่ต้องตรวจ', 'ทุก 1 สัปดาห์'],
    answer: 1, explain: 'Geriatric check-up: minimum yearly · recommended every 6 months · comprehensive: PE (head-to-tail) + BCS (1-9 scale) + MCS (muscle condition score) + CBC + chemistry (BUN/Cr/ALT/ALP/glucose/cholesterol/electrolytes) + UA + thyroid (T4 — esp. cat) + BP (hypertension common in CKD/Cushing\'s) + imaging (US, X-ray) PRN · early detection: CKD, hyperthyroid (cat), hypothyroid (dog), DM, HAC, neoplasia\n\n❌ ทำไมข้ออื่นผิด\n— "5 ปี" = นานเกินไป miss disease\n— "ไม่ตรวจ" = ผิด\n— "ทุก สัปดาห์" = บ่อยเกินจำเป็น',
  ...
  { id: 1032, subject: 'com4', topic: 'imha', year: 4, source: 'Immune-mediated_Hemolytic_anemia + FINAL 86',
    ...
    options: ['Heparin alone (LMWH หรือ UFH) — direct anticoagulant primary therapy', 'Clopidogrel (Plavix) ± low-dose aspirin (0.5-1 mg/kg/d) — antiplatelet first-line', 'Warfarin PO 0.1 mg/kg titrate ถึง INR 2-3 — long-term anticoagulant', 'Vitamin K1 5 mg/kg PO q24h — antidote ห้าม secondary clotting cascade', 'tPA (tissue plasminogen activator) IV bolus thrombolytic เพื่อสลายลิ่ม PTE'],
