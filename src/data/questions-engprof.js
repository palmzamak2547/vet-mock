...
export const QB_ENGPROF = [
  ...
  { id: 51004, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    answer: 2, explain: 'Discussion = interpret + compare to prior literature + state limitations of the study + recommend further research. The Methods section holds recruitment; Results holds mean/SD; the Introduction defines terms.',
  ...
  { id: 51007, subject: 'engprof', topic: 'research-design', year: 4,
    ...
    options: ['Retrospective case series', 'Cross-sectional survey', 'Prospective cohort study', 'Randomized Controlled Trial'],
  ...
  { id: 51010, subject: 'engprof', topic: 'paraphrasing', year: 4,
    ...
    options: [
      ...
      'Inventing new information not stated',
      'Changing sentence structures',
    ],
    answer: 2, explain: '5 techniques = synonyms / active↔passive / parts of speech / sentence markers / sentence structures, NEVER invent material not in the original',
  ...
  { id: 51015, subject: 'engprof', topic: 'summary-writing', year: 4,
    ...
    options: [
      ...
      'Content 7 + Org & Grammar 5 + Paraphrasing 3',
      'Main idea 7 + Word choice 8 (no grammar)',
      'Reading 10 + Writing 5 (no paraphrasing)',
    ],
    answer: 1, explain: '15 pts = Content 7 (main idea 1-2 + key details 1 each) + Organization & Grammar 5 + Paraphrasing 3',
    verified: 'Final Exam Spec p.2' },
  ...
  { id: 51016, subject: 'engprof', topic: 'summary-writing', year: 4,
    ...
    options: ['The main idea of the original', 'Major supporting details', 'Your own opinion or judgement', 'A clear opening statement'],
    answer: 2, explain: 'Summary = objective condensation of the original, ห้ามใส่ความเห็นหรือ judgement ของเรา และห้าม invent material',
  ...
  { id: 51017, subject: 'engprof', topic: 'academic-writing', year: 4,
    ...
    answer: 2, explain: 'Review article: Intro (problem + scope) → Body paragraphs (organized with subheadings) → Conclusion',
  ...
  { id: 51018, subject: 'engprof', topic: 'academic-writing', year: 4,
    ...
    options: ['(Author surname, Year)', 'Author surname (Year)', 'Superscript Arabic numbers', '[Author surname] [Page no.]'],
    answer: 2, explain: 'AMA = superscript Arabic numbers, ordered by appearance in paper. (Author, Year) and Author (Year) are APA/Harvard styles, not AMA.\n\n💡 ¹ ² ³',
...
Word-count Penalty: > 180 words → −1 / > 200 words → −2`,
  ...
  { id: 51033, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: 'study aim → test hypothesis that older baboons of both sexes experience meaningful bone loss meeting human-comparable osteopenia/osteoporosis definitions' },
  ...
  { id: 51035, subject: 'engprof', topic: 'research-design', year: 4,
    ...
    explain: '"Quantitative research design (Observational study)" — no intervention, just measurement' },
  ...
  { id: 51036, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: '"2 sets of samples — 1) The sample (460 females, 207 males) ranging in age from 5 to 30 years... 2) 54 females over the age of 19.0 years"' },
  ...
  { id: 51037, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: '"All animals were a part of the breeding colony at the SNPRC/SFBR. The baboons were captured from Kenya for biomedical research..."' },
  ...
  { id: 51038, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: 'Descriptive statistics: T-score, Qualitative comparisons of inter-site correspondence and bivariate correlations' },
  ...
  { id: 51039, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    answer: false, explain: 'False — the Results show variable prevalence by skeletal site, not a single one-fourth figure across "any" sites' },
  ...
  { id: 51041, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    answer: true, explain: 'True — when osteopenia was identified at one skeletal site, it was likely to also occur at other bones of the same anatomical region (regional patterning)' },
  ...
  { id: 51042, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: '"The baboon and related species experience bone loss with age, particularly in females..."' },
  ...
  { id: 51043, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: '"This would result in artificial selection for healthier animals in the oldest age ranges, and could explain our high incidence of osteopenia, but absence of osteoporosis"' },
  ...
  { id: 51044, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: '"Ultimately our results validate the use of the baboon as an appropriate and valuable animal model of human bone maintenance and turnover"' },
...
Word-count Penalty: > 180 → −1 / > 200 → −2`,
  ...
  { id: 51046, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: '"to determine the seroprevalence of NDV antibodies and the herd-level risk factors associated with ND outbreaks in backyard chicken flocks in Oman"' },
  ...
  { id: 1161, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: 'vaccination is the primary control approach' },
  ...
  { id: 1162, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: '"1. the trajectory of migratory birds; 2. the growing trade between Oman and neighboring countries"' },
  ...
  { id: 1163, subject: 'engprof', topic: 'research-design', year: 4,
    ...
    explain: 'Survey study (questionnaire + serum collection from backyard flocks)' },
  ...
  { id: 1164, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: '"383 serum samples were collected from chickens from 139 flocks; 875 poultry farmers"' },
  ...
  { id: 1165, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: '"the Sultanate of Oman... within the nine governorates of Oman... duration was from June 2016 to September 2016"' },
  ...
  { id: 1166, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: 'descriptive stats / Pearson Chi-square / Spearman / logistic / univariate / multivariate' },
  ...
  { id: 1169, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    answer: false, explain: 'False — NDV seroprevalence varied substantially across regions; it was not uniform across all sampled flocks/birds/locations' },
  ...
  { id: 1170, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    answer: true, explain: 'True — 3/5 of products produced by respondents\' farms = chicken meat' },
  ...
  { id: 1171, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    answer: true, explain: 'True — respondents most commonly reported stopping product sales and restricting production over other practices (e.g., culling)' },
  ...
  { id: 1172, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: 'vital data + high seroprevalence + potential source to commercial flocks + factors that could reduce exposure' },
  ...
  { id: 1173, subject: 'engprof', topic: 'research-paper-structure', year: 4,
    ...
    explain: '"identify the circulating virus genotypes and models of transmission for better understanding of ND epidemiology in backyard chickens in Oman"' },
