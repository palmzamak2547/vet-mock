...
export const QB_COM5 = [
  ...
  { id: 541, subject: 'com5', topic: 'cve', year: 4, source: 'CVE.pdf',
    ...
    answer: 3, explain: 'Parenteral preferred (GI absorption ไม่ดี) · combo cover G+ G- · ระวัง: aminoglycoside ห้ามใน dehydrated (nephrotoxic), enrofloxacin ระวัง cartilage ในลูกสุนัข',
  ...
  { id: 542, subject: 'com5', topic: 'cve', year: 4, source: 'COM V FINAL 86',
    ...
    answer: 2, explain: 'Puppy < 12 weeks มี severe infection (mortality ~70%) · Adult dogs มัก subclinical (mortality ~1%)',
  ...
  { id: 509, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    answer: 3, explain: 'Direct contact with infected cat = major mode to humans (ต้องมีแผลจึงติดง่าย) · primary mode in env = traumatic inoculation',
  ...
  { id: 511, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    answer: 3, explain: 'LCAT = Latex Cryptococcal Antigen Test · ตรวจซีรั่ม, CSF, ปัสสาวะ · ใช้ติดตามผลรักษาด้วย',
  ...
  { id: 513, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    answer: 2, explain: 'Nasal = Most common · chronic sinonasal disease + nasofacial swelling = "Roman nose" (มักข้างเดียว)',
  ...
  { id: 566, subject: 'com5', topic: 'gi-protozoa', year: 4, source: 'GI_protozoa.pdf',
    ...
    answer: 3, explain: 'C. parvum (cattle) = major zoonotic in humans · C. canis (dog) และ C. felis (cat) เป็น rare zoonoses',
  ...
  { id: 572, subject: 'com5', topic: 'gi-protozoa', year: 4, source: 'GI_protozoa.pdf',
    ...
    answer: 4, explain: 'A, B = zoonotic genotypes · พบในทั้งคนและสัตว์ · classification ใช้ PCR (GDH, ef1-α, TPI, rDNA)',
  ...
  { id: 525, subject: 'com5', topic: 'rabies', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    answer: 2, explain: 'สัตว์ปกติที่กัดคน: ขังกรงดูอาการ 10 วัน · ห้ามฉีด vaccine ทับเพราะอาจสับสนกับ adverse effect',
  ...
  { id: 526, subject: 'com5', topic: 'rabies', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    answer: 3, explain: 'No vaccine: euthanize หรือ restricted quarantine 180 วัน · Vaccinated: ฉีดกระตุ้น + monitor 45 วัน',
  ...
  { id: 531, subject: 'com5', topic: 'vaccine', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['CPV, CDV, Rabies', 'CPV, CDV, Bordetella, Rabies', 'CPV, CDV, CAV, Rabies', 'CPV, CDV, CAV, Leptospirosis*, Rabies* (with conditions)', 'CPV, CDV, CAV, CCV, Rabies'],
  ...
  { id: 532, subject: 'com5', topic: 'vaccine', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['FPV, FIV, FIP, Rabies', 'FPV, FCV, FHV, Bordetella', 'FPV, FHV, FCV (always) + Rabies* + FeLV*** (with conditions)', 'FPV, FHV, FeLV, Rabies', 'FPV, FIV, FeLV, Rabies'],
    answer: 2, explain: 'VPAT 2024: FPV/FCV/FHV always core + Rabies* (endemic) + FeLV*** (endemic + อายุ < 2 ปี หรือเสี่ยง expose) · ตรวจ FeLV-ve ก่อนฉีด FeLV',
  ...
  { id: 611, subject: 'com5', topic: 'feline-uri', year: 4, source: 'Feline_Upper_Respiratory_Infection.pdf',
    ...
    answer: 3, explain: 'Bordetella: cough เป็น prominent sign · colonize ciliated respiratory epithelium → cilia stasis · ติดจากสุนัขได้ + zoonotic ในเจ้าของ immunocompromised',
