...
export const QB_COM5 = [
  ...
  { id: 500, subject: 'com5', topic: 'cve', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['Family Parvoviridae, non-enveloped, single-stranded DNA', 'Family Herpesviridae, enveloped, double-stranded DNA', 'Family Coronaviridae, enveloped, RNA', 'Family Adenoviridae, enveloped'],
    answer: 0, explain: 'CPV: Parvoviridae, non-enveloped, ssDNA · ทนในสิ่งแวดล้อม 5-7 เดือน',
  ...
  { id: 501, subject: 'com5', topic: 'cve', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    answer: 0, explain: 'Risk factors: young dog 6 wk-6 mo, unvaccinated, crowded/unsanitary, co-infection, certain breeds (Rottweiler/Doberman/Lab/GSD/Pit/Yorkie) · adult ที่ฉีดวัคซีนครบ = low risk',
  ...
  { id: 502, subject: 'com5', topic: 'cve', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['Diarrhea: foul-smelling, bloody', 'Skin lesion', 'Vomiting อย่างเดียว', 'Constipation'],
  ...
  { id: 505, subject: 'com5', topic: 'cve', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    answer: 0, explain: 'CCV = Coronaviridae, enveloped, ssRNA · 2 biotypes: enteric α-CoV และ respiratory β-CoV (CRCoV)',
  ...
  { id: 538, subject: 'com5', topic: 'cve', year: 4, source: 'CVE.pdf',
    ...
    answer: 0, explain: 'CPV incubation 4-14 วัน · Ingestion → infection → viremia → replication → shedding (up to 10-12 วัน post-infection)',
  ...
  { id: 539, subject: 'com5', topic: 'cve', year: 4, source: 'CVE.pdf',
    ...
    answer: 0, explain: 'Low viral load = false **negative** ไม่ใช่ false positive · ใช้ PCR แยก vaccine strain ออกจาก natural infection',
    verified: 'CVE.pdf p.14' },
  ...
  { id: 541, subject: 'com5', topic: 'cve', year: 4, source: 'CVE.pdf',
    ...
    options: ['Sulfa-Trimethoprim PO เดี่ยว', 'Doxycycline + Metronidazole PO', 'Beta-lactam + Aminoglycoside / Enrofloxacin (IV/IM)', 'Amoxicillin PO เดี่ยว'],
  ...
  { id: 542, subject: 'com5', topic: 'cve', year: 4, source: 'COM V FINAL 86',
    ...
    options: ['เท่ากันที่ ~40%', 'Puppy 70% / Adult 1%', 'Puppy 30% / Adult 50%', 'Puppy 1% / Adult 70%'],
  ...
  { id: 543, subject: 'com5', topic: 'cve', year: 4, source: 'CVE.pdf',
    ...
    answer: 1, explain: 'CPV เป็น non-enveloped → ทนต่อ alcohol/chlorhex/QUAT · ต้องใช้ NaOCl 1:30-32 หรือ accelerated H2O2',
  ...
  { id: 545, subject: 'com5', topic: 'cve', year: 4, source: 'CVE.pdf',
    ...
    options: ['6-8 wk (start) แล้ว boost ทุก 2-4 wk จน ≥16 wk', '12-16 wk เท่านั้น', '20 wk ขึ้นไป', '4-6 wk'],
    answer: 0, explain: 'WSAVA 2024: start no earlier than 6 wks (suggested 8 wks) · revaccinate every 3-4 weeks until 16 wks of age',
  ...
  { id: 548, subject: 'com5', topic: 'cve', year: 4, source: 'COM V FINAL 86',
    ...
    answer: 2, explain: 'rFeIFN-ω 2.5 MU/kg IV × 3 d, Oseltamivir 2 mg/kg PO q12 × 5 d · ongoing: nitazoxanide, mAb, FMT',
  ...
  { id: 509, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['ผ่านพาหะแมลง', 'กินอาหารปนเปื้อน', 'การสัมผัสกับแมวที่ติดเชื้อ (zoonotic)', 'สูดดมสปอร์'],
    answer: 2, explain: 'Direct contact with infected cat = major mode to humans (ต้องมีแผลจึงติดง่าย) · primary mode in env = traumatic inoculation',
  ...
  { id: 510, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    answer: 2, explain: 'Itraconazole 5-10 mg/kg q24h PO = TOC ในแมว · ต่อเนื่อง 1 เดือนหลังแผลหายสนิท · monthly liver enzyme monitoring',
  ...
  { id: 511, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['PCR', 'Blood culture', 'Antigen detection (LCAT)', 'Skin biopsy'],
    answer: 2, explain: 'LCAT = Latex Cryptococcal Antigen Test · ตรวจซีรั่ม, CSF, ปัสสาวะ · ใช้ติดตามผลรักษาด้วย',
  ...
  { id: 512, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    answer: 0, explain: 'Fluconazole 50 mg/cat q12h PO · good absorption · ตรวจตับเป็นระยะ · กินจนกว่า antigen test negative (หลายเดือน–ปี) · CNS/systemic ใช้ Amphotericin B แทน',
  ...
  { id: 513, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['Disseminated', 'Nasal form ("Roman nose")', 'CNS form', 'Cutaneous form'],
  ...
  { id: 549, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Sporotrichosis and Cryptococcosis.pdf',
    ...
    answer: 2, explain: 'เรียงตาม timeline: Cutaneous → Cutaneolymphatic (เข้าต่อมน้ำเหลือง) → Disseminated (preferred sites: lung, liver) · disseminated มัก FIV+',
  ...
  { id: 550, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'COM V FINAL 86',
    ...
    answer: 2, explain: 'S. schenckii = species ในไทย · S. brasiliensis พบในบราซิล · S. globosa พบที่อื่น',
  ...
  { id: 554, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Sporotrichosis and Cryptococcosis.pdf',
    ...
    options: ['Potassium iodide (KI) supersaturated solution 2.5-20 mg/kg q24h PO', 'Griseofulvin', 'Amphotericin B', 'Itraconazole'],
  ...
  { id: 556, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Sporotrichosis and Cryptococcosis.pdf',
    ...
    answer: 0, explain: 'ต่อยา ≥1 เดือนหลัง clinical cure · เพื่อกัน relapse · ระวัง: zoonosis ใส่ถุงมือเสมอ',
  ...
  { id: 557, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Sporotrichosis and Cryptococcosis.pdf',
    ...
    options: ['ดินที่ปนเปื้อนมูลนกพิราบ', 'พืชผักผลไม้', 'อากาศในอาคาร', 'น้ำในคลอง'],
    answer: 0, explain: 'C. neoformans พบในดินปนเปื้อน pigeon droppings · transmission = inhalation ของ basidiospores · nasal cavity = primary site',
  ...
  { id: 561, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Sporotrichosis and Cryptococcosis.pdf',
    ...
    answer: 2, explain: 'Amphotericin B = TOC สำหรับ CNS/systemic · มักใช้ร่วมกับ Flucytosine (synergistic) · ไม่ใช้ flucytosine เดี่ยว',
  ...
  { id: 517, subject: 'com5', topic: 'gi-protozoa', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['Centrifugal flotation', 'Direct fecal smear (wet mount) — เห็น trophozoite เคลื่อนไหวแบบ erratic jerky', 'Formalin-ether sedimentation', 'Simple sedimentation'],
    answer: 1, explain: 'T. foetus มีแค่ trophozoite (NO cyst) → flotation ตรวจไม่ได้ · Direct wet mount sensitivity ต่ำ <14% · gold standard = InPouch TF-Feline',
  ...
  { id: 520, subject: 'com5', topic: 'gi-protozoa', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    answer: 3, explain: 'T. gondii sporulated: 1 oocyst : 2 sporocyst : 4 sporozoite (each) = 1:2:4 · ขนาด 10×12 μm',
  ...
  { id: 563, subject: 'com5', topic: 'gi-protozoa', year: 4, source: 'GI_protozoa.pdf',
    ...
    answer: 1, explain: 'Mucosoflagellate: Giardia + T. foetus + Entamoeba · Coccidia (Apicomplexa): Cystoisospora, Crypto, Toxo, Neospora, Sarcocystis, Hammondia, Besnoitia',
  ...
  { id: 564, subject: 'com5', topic: 'gi-protozoa', year: 4, source: 'GI_protozoa.pdf',
    ...
    answer: 0, explain: 'Crypto: tiny (3-5 μm), 1:0:4 (no sporocyst), sporulated already in host · sporulation ในตัว host · ชอบเกาะ brush border microvillus',
  ...
  { id: 566, subject: 'com5', topic: 'gi-protozoa', year: 4, source: 'GI_protozoa.pdf',
    ...
    options: ['C. felis', 'C. baileyi', 'C. parvum (จากโค)', 'C. canis'],
  ...
  { id: 568, subject: 'com5', topic: 'gi-protozoa', year: 4, source: 'GI_protozoa.pdf',
    ...
    answer: 0, explain: 'Direct wet mount sensitivity <14% · Fecal culture (InPouch TF) sensitivity ~55% · PCR sensitivity สูงสุด',
    verified: 'GI_protozoa.pdf p.20 + COM V FINAL 86 p.18',
  ...
  { id: 569, subject: 'com5', topic: 'gi-protozoa', year: 4, source: 'GI_protozoa.pdf',
    ...
    options: ['Fenbendazole 50 mg/kg SID', 'Ronidazole 30 mg/kg PO q24h × 10 d (use with caution: neurologic AE)', 'ไม่มียาเฉพาะ — รอหายเอง', 'Metronidazole 22 mg/kg PO BID'],
    answer: 1, explain: 'Ronidazole = effective แต่ไม่มี approval + neurologic AE · Most cats spontaneous resolution ใช้เวลานานถึง 2 ปี',
  ...
  { id: 570, subject: 'com5', topic: 'gi-protozoa', year: 4, source: 'GI_protozoa.pdf',
    ...
    answer: 3, explain: 'T. foetus: 1 nucleus, axostyle, 3 anterior flagella + undulating membrane, **NO cyst stage**, erratic/jerky motility · Giardia: 2 nuclei, sucking disc, **มี cyst stage**, **falling-leaf motility**',
  ...
  { id: 571, subject: 'com5', topic: 'gi-protozoa', year: 4, source: 'GI_protozoa.pdf',
    ...
    options: ['10-100 cysts', '1,000 cysts', '10,000 cysts', '1 cyst'],
    answer: 0, explain: '10-100 cysts → infection in human · waterborne (resistant to most disinfectants), fecal-oral, fomites',
  ...
  { id: 572, subject: 'com5', topic: 'gi-protozoa', year: 4, source: 'GI_protozoa.pdf',
    ...
    options: ['ไม่มี assemblage zoonotic', 'Assemblage F เท่านั้น', 'Assemblage C เท่านั้น', 'Assemblage A และ B (zoonotic) — สุนัข: A,B,C,D · แมว: A,B,F'],
    answer: 3, explain: 'A, B = zoonotic genotypes · พบในทั้งคนและสัตว์ · classification ใช้ PCR (GDH, ef1-α, TPI, rDNA)',
  ...
  { id: 522, subject: 'com5', topic: 'rabies', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    answer: 2, explain: 'พรบ.โรคพิษสุนัขบ้า: อายุ 2-4 เดือน · ไม่จัดให้สัตว์ฉีดปรับไม่เกิน 200 บาท',
  ...
  { id: 525, subject: 'com5', topic: 'rabies', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['30 วัน', '10 วัน', '14 วัน', '7 วัน'],
  ...
  { id: 526, subject: 'com5', topic: 'rabies', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['45 วัน', '365 วัน', '180 วัน หรือ euthanize', '10 วัน'],
  ...
  { id: 580, subject: 'com5', topic: 'rabies', year: 4, source: 'Rabies.pdf',
    ...
    answer: 0, explain: 'Non-bite: scratch (เลีบที่เลียมา), lick to mucus membrane/open wound, trans-placenta · Bite = หลัก',
  ...
  { id: 583, subject: 'com5', topic: 'rabies', year: 4, source: 'Rabies.pdf',
    ...
    options: ['ถูกเลียที่ผิวหนังปกติโดยไม่มีรอยถลอก', 'ถูกกัดทะลุผิวหนังมีเลือดออก หรือ น้ำลายสัมผัสเยื่อบุตา ปาก จมูก', 'ถูกข่วนเป็นรอยถลอก ไม่มีเลือดออก', 'ถูกต้องตัวสัตว์โดยไม่มีแผลที่ผิวหนัง'],
    answer: 1, explain: 'Cat. 3: ถูกกัดมีเลือด, ถูกข่วนจนผิวหนังขาดมีเลือด, สัมผัสเยื่อบุ → ล้างแผล + วัคซีน + อิมมูโนโกลบูลิน · Cat. 1 = ไม่ติด · Cat. 2 = ฉีดวัคซีน (ไม่อิมมูโน)',
  ...
  { id: 586, subject: 'com5', topic: 'rabies', year: 4, source: 'Rabies.pdf',
    ...
    answer: 2, explain: '6 criteria ใช้ประเมินสุนัขที่ยังมีชีวิตว่ามีโอกาสเป็น rabies หรือไม่ · definitive Dx ยังต้อง post-mortem DFA brain',
  ...
  { id: 530, subject: 'com5', topic: 'vaccine', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    answer: 2, explain: 'WSAVA 2024: start 6-8 wk → revaccinate every 3-4 wk จนถึง ≥16 wk · MDA persist up to 16 wk',
    verified: 'Vaccination_guideline.pdf p.9' },
  ...
  { id: 531, subject: 'com5', topic: 'vaccine', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['CPV, CDV, Rabies', 'CPV, CDV, CAV, Rabies', 'CPV, CDV, CAV, Leptospirosis*, Rabies* (with conditions)', 'CPV, CDV, CAV, CCV, Rabies'],
    answer: 2, explain: 'VPAT 2024: CDV/CPV/CAV (core) + Rabies* (endemic = ไทยเป็น) + Lepto** (endemic country with known serogroups & available vaccine)',
  ...
  { id: 532, subject: 'com5', topic: 'vaccine', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['FPV, FIV, FIP, Rabies', 'FPV, FHV, FCV (always) + Rabies* + FeLV*** (with conditions)', 'FPV, FHV, FeLV, Rabies', 'FPV, FIV, FeLV, Rabies'],
  ...
  { id: 533, subject: 'com5', topic: 'vaccine', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    answer: 2, explain: 'VPAT 2024 + Thai Rabies CPG: เริ่ม 12 wk · 2nd dose 2-4 wk later · 1 yr booster · annual · ปีแรกแนะนำ monovalent rabies',
  ...
  { id: 592, subject: 'com5', topic: 'vaccine', year: 4, source: 'Vaccination_guideline.pdf',
    ...
    answer: 0, explain: 'Sejroe, Icterohaemorrhagiae, Bataviae, Canicola, Australis · ⚠️ Commercial vaccines (2-/4-serovar) ใน TH ไม่ครอบคลุม top serogroups (Sejroe, Bataviae)',
  ...
  { id: 594, subject: 'com5', topic: 'vaccine', year: 4, source: 'Vaccination_guideline.pdf',
    ...
    answer: 0, explain: 'CPV: HI ≥ 80 = protective, HI ≤ 10 = no interference · Window = ช่วงที่ MDA ลดต่ำกว่า protective แต่ยัง interfere vaccine → ต้องฉีดซ้ำทุก 2-4 wk จน 16 wk',
  ...
  { id: 597, subject: 'com5', topic: 'vaccine', year: 4, source: 'Vaccination_guideline.pdf',
    ...
    answer: 3, explain: 'Gonzalez 2023: CDV ≥ 32, CAV2 ≥ 16, CPV ≥ 80 · 62-92% ของสุนัขยังมี protective titer ที่ >5 ปีหลังวัคซีน · WSAVA สนับสนุนการตรวจ titer ตั้งแต่ 20 wks',
  ...
  { id: 598, subject: 'com5', topic: 'vaccine', year: 4, source: 'Vaccination_guideline.pdf',
    ...
    options: ['ไม่ต้อง booster', '24 เดือน', '6 เดือน (แทน 12-16 เดือน) → จากนั้น revaccinate ที่ 3 ปี + ทุก 3 ปี', '12 เดือน เหมือนเดิม'],
    answer: 2, explain: 'WSAVA 2024: 6-month booster (revised) · จากนั้น 3-yr intervals · VPAT ยังคง annual (อย่างน้อยจนถึงครึ่งปี-1ปี + ทุกปีหรือทุก 3 ปี)',
  ...
  { id: 599, subject: 'com5', topic: 'vaccine', year: 4, source: 'Vaccination_guideline.pdf',
    ...
    answer: 0, explain: 'Not recommended (WSAVA 2024): Killed CPV, CCoV, Giardia, Microsporum · insufficient scientific evidence',
  ...
  { id: 602, subject: 'com5', topic: 'vaccine', year: 4, source: 'Vaccination_guideline.pdf',
    ...
    answer: 0, explain: 'Low-risk cat: revacc ทุก 3 ปี · High-risk cat: annual revaccination · เปลี่ยน boost 6 เดือนแทน 1 ปี เพิ่มจาก 2016',
  ...
  { id: 606, subject: 'com5', topic: 'feline-uri', year: 4, source: 'Feline_Upper_Respiratory_Infection.pdf',
    ...
    answer: 0, explain: 'FHV-1 = dsDNA enveloped · latent ใน trigeminal ganglia + cornea · stress reactivation → intermittent shedding · easily killed by disinfectants',
  ...
  { id: 609, subject: 'com5', topic: 'feline-uri', year: 4, source: 'Feline_Upper_Respiratory_Infection.pdf',
    ...
    answer: 1, explain: 'VS-FCV mortality ≈ 30-70% · severe vasculitis → cutaneous edema/ulcer (head, limbs), hepatic necrosis, DIC · รุนแรงในแมวโต > kitten · core vaccine ไม่ป้องกัน',
  ...
  { id: 611, subject: 'com5', topic: 'feline-uri', year: 4, source: 'Feline_Upper_Respiratory_Infection.pdf',
    ...
    options: ['Skin pustules', 'Polyuria', 'Cough', 'Vomiting'],
    answer: 2, explain: 'Bordetella: cough เป็น prominent sign · colonize ciliated respiratory epithelium → cilia stasis · ติดจากสุนัขได้ + zoonotic ในเจ้าของ immunocompromised',
  ...
  { id: 614, subject: 'com5', topic: 'feline-uri', year: 4, source: 'Feline_Upper_Respiratory_Infection.pdf',
    ...
    answer: 2, explain: 'Famciclovir 90 mg/kg PO q8-12h × 7-21 d · ปลอดภัยในแมว (ทดลอง > 4 เดือน ไม่มี AE สำคัญ) · Acyclovir/Ribavirin = พิษกับแมว · Ophthalmic options: Cidofovir q12, Trifluridine q4, Idoxuridine q4',
  ...
  { id: 617, subject: 'com5', topic: 'feline-uri', year: 4, source: 'Feline_Upper_Respiratory_Infection.pdf',
    ...
    options: ['4–6 สัปดาห์', '2–10 วัน', '14–21 วัน', '1–3 วัน'],
  ...
  { id: 618, subject: 'com5', topic: 'feline-uri', year: 4, source: 'Feline_Upper_Respiratory_Infection.pdf',
    ...
    answer: 1, explain: 'หลัก: direct contact + droplets + fomites + caregivers · ไม่มี vector-borne · ระวังโดยเฉพาะ multi-cat household + shelter',
