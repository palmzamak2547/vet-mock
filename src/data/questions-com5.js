...
export const QB_COM5 = [
...

  {
    ...
    answer: 0,
    explain: "Risk factors: young dog 6 wk-6 mo, unvaccinated, crowded/unsanitary, co-infection, certain breeds (Rottweiler/Doberman/Lab/GSD/Pit/Yorkie)\nadult ที่ฉีดวัคซีนครบ = low risk\n\n❌ ทำไมข้ออื่นผิด\n— แออัด/co-parasite/6wk-6mo = risk factor จริง\n— \"vaccinated adult indoor\" = low risk = คำตอบที่ถาม",
...

  {
    ...
    options: ["Diarrhea: foul-smelling, bloody","Pruritus + alopecia ทั่วทั้งตัว","Skin lesion: ตุ่มหนองที่ผิวหนัง","Vomiting อย่างเดียวไม่มีถ่ายเหลว","Constipation: อุจจาระแข็งคั่งค้าง"],
    answer: 0,
    explain: "Crypt damage → villi atrophy/collapse → bloody, foul-smelling diarrhea + dehydrate + hypovolemic shock\n\n❌ ทำไมข้ออื่นผิด\n— Pruritus/Skin lesion = ผิวหนัง ไม่ใช่ GI\n— Vomiting อย่างเดียว = incomplete picture\n— Constipation = ตรงข้าม",
...

  {
    ...
    answer: true,
    explain: "False neg: low viral load + Ab จับ Ag ใน bloody stool\nFalse pos: 3-10 วันหลัง MLV vaccine — แยกได้ด้วย PCR",
...

  {
    ...
    options: ["Antibiotic ฆ่าเชื้อไวรัสโดยตรง","Restoration of fluid + electrolyte","Vaccine therapy ขณะป่วยเฉียบพลัน","Antiviral specific drug เฉพาะ CPV"],
    answer: 1,
    explain: "NO specific Tx → Supportive: IV crystalloid (LRS/NSS) + glucose/K + nutrition (feeding tube) + broad-spectrum ABO + antiemetic\n\n💡 Rehydration",
...

  {
    ...
    options: ["Enveloped, single-stranded RNA","Non-enveloped, single-stranded RNA","Enveloped, double-stranded DNA","Non-enveloped, double-stranded DNA"],
    answer: 0,
    explain: "CCV = Coronaviridae, enveloped, ssRNA\n2 biotypes: enteric α-CoV และ respiratory β-CoV (CRCoV)\n\n❌ ทำไมข้ออื่นผิด\n— Non-env RNA = Picornaviridae\n— Env DNA = Herpesvirus\n— Non-env DNA = Parvovirus",
...

  {
    ...
    options: ["Lymphocytes ใน lymph node + thymus","Mature enterocyte บริเวณ villi tips","Hepatocytes ใน periportal zone","Crypt cells บริเวณฐาน villi (เหมือน CPV)"],
    answer: 1,
    explain: "CCV โจมตี mature enterocyte ที่ปลายยอดของ villi (ต่างจาก CPV ที่โจมตี crypt) → necrosis/hemorrhage rare\n\n❌ ทำไมข้ออื่นผิด\n— Lymphocytes = CDV target\n— Hepatocytes = CAV-1\n— Crypt cells = CPV (ไม่ใช่ CCV)",
...

  {
    ...
    answer: 2,
    explain: "CPV-1 (original) ส่วนใหญ่ subclinical (อาจรุนแรงในลูก 5-21 วัน)\nCPV-2 highly contagious, มี subtypes 2a/2b/2c (2c รุนแรงสุด)",
...

  {
    ...
    options: ["Renal tubular epithelial cells","Pancreatic acinar + islet cells","Lymphoid tissue + bone marrow precursors","Hepatocytes บริเวณ periportal"],
    answer: 2,
    explain: "CPV ชอบ rapidly dividing cells: lymph nodes/thymus + intestinal crypt + bone marrow precursor + (rare) myocardium\n\n❌ ทำไมข้ออื่นผิด\n— Renal tubules / Pancreatic acini / Hepatocytes = ไม่ใช่ rapidly dividing tissue",
...

  {
    ...
    options: ["สุนัขโตเต็มวัยที่ฉีดวัคซีนไม่ครบเท่านั้น","สุนัขโตอายุมากกว่า 1 ปีที่ภูมิคุ้มกันตกหลังป่วย","การติดเชื้อ in utero หรือภายใน 2 สัปดาห์แรกหลังคลอด","ลูกสุนัขติดเชื้อได้ทุกช่วงอายุโดยไม่จำกัด"],
    answer: 2,
    explain: "CPV ชอบ actively dividing cells — myocardium proliferate active แค่ <2 wks after birth → infection in utero / first 2 weeks → myocarditis\n\n❌ ทำไมข้ออื่นผิด\n— \"Adult เท่านั้น\" = ผิด (adult มัก subclinical)\n— \"> 1 ปี\" = ผ่าน proliferative phase แล้ว\n— \"ทุกอายุ\" = generalize ผิด",
...

  {
    ...
    options: ["Leukopenia + hypoproteinemia + hypoglycemia + electrolyte imbalance","Eosinophilia + hyperphosphatemia + hyperproteinemia + alkalosis","Polycythemia + hypernatremia + hyperglycemia + ↑albumin","Leukocytosis + hyperalbuminemia + hyperglycemia + ↑calcium"],
    answer: 0,
    explain: "Leukopenia (lymphopenia ± neutropenia) + hypoproteinemia + prerenal azotemia + ↑CRP + ↑liver enzymes\n\n❌ ทำไมข้ออื่นผิด\n— Eosinophilia = parasite/allergy\n— Polycythemia = dehydration only\n— Leukocytosis = bacterial (ตรงข้าม CPV)",
...

  {
    ...
    answer: 2,
    explain: "MDA persist up to 16 wk → จึงต้องฉีดเข็มสุดท้ายอายุ ≥16 wk (WSAVA แนะนำ start 6-8 wk q2-4 wk จนถึง ≥16 wk)\n\n❌ ทำไมข้ออื่นผิด\n— 12/8/6 wk = สั้นเกิน — เข็มสุดท้ายต้องอย่างน้อย 16 wk จึงครอบคลุม MDA",
...

  {
    ...
    options: ["6-8 wk start, boost q2-4 wk ≥16 wk","10 wk เข็มเดียวจบ ไม่ต้อง boost","12-16 wk เริ่มเข็มแรกเท่านั้น","20 wk ขึ้นไปจึงเริ่มได้","4-6 wk เข็มเดียวคุ้มตลอดชีวิต"],
    answer: 0,
    explain: "WSAVA 2024: start no earlier than 6 wks (suggested 8 wks)\nrevaccinate every 3-4 weeks until 16 wks of age\n\n❌ ทำไมข้ออื่นผิด\n— \"10 wk เข็มเดียว\" / \"12-16 wk เท่านั้น\" / \"20 wk ขึ้นไป\" / \"4-6 wk\" = ไม่ตรง guideline (start ≤8 wk + boost q2-4 wk จน ≥16 wk)",
...

  {
    ...
    options: ["Double-stranded DNA, enveloped, severe enteritis","พบเฉพาะใน puppy < 4 wk เท่านั้น","Segmented double-stranded RNA, non-enveloped (Reoviridae)","Single-stranded RNA, enveloped (Coronaviridae)"],
    answer: 2,
    explain: "CRV: Reoviridae\nsegmented dsRNA\ninfect mature enterocytes\nmild self-limiting\n\n💡 mild self-limiting diarrhea ใน enterocytes",
...

  {
    ...
    options: ["ผ่านพาหะแมลงดูดเลือด","Tick-borne ผ่านการกัดของเห็บ","กินอาหารหรือน้ำที่ปนเปื้อน","การสัมผัสกับแมวที่ติดเชื้อ","สูดดมสปอร์จากอากาศในห้อง"],
    answer: 3,
    explain: "Direct contact with infected cat = major mode to humans (ต้องมีแผลจึงติดง่าย)\nprimary mode in env = traumatic inoculation\n\n❌ ทำไมข้ออื่นผิด\n— แมลง/Tick/อาหาร = ไม่ใช่ mode หลัก\n— สูดดมสปอร์ = environmental ไม่ใช่ cat-to-human\n\n💡 zoonotic",
...

  {
    ...
    options: ["PCR","Stool ova-parasite exam","Blood culture","Antigen detection","Skin biopsy"],
    answer: 3,
    explain: "LCAT = Latex Cryptococcal Antigen Test\nตรวจซีรั่ม, CSF, ปัสสาวะ\nใช้ติดตามผลรักษาด้วย\n\n❌ ทำไมข้ออื่นผิด\n— PCR = ไม่ available routine\n— Stool O&P = parasite\n— Blood culture = bacterial\n— Skin biopsy = หลัง suspect แล้ว",
...

  {
    ...
    options: ["Local / Regional / Metastatic","Pulmonary / Gastrointestinal / CNS","Cutaneous / Cutaneolymphatic / Disseminated","Nasal / Cutaneous / CNS involvement"],
    answer: 2,
    explain: "เรียงตาม timeline: Cutaneous → Cutaneolymphatic (เข้าต่อมน้ำเหลือง) → Disseminated (preferred sites: lung, liver)\ndisseminated มัก FIV+\n\n❌ ทำไมข้ออื่นผิด\n— Local/Regional/Metastatic = cancer-style staging\n— Pulmonary/GI/CNS = wrong organ system\n— Nasal/Cutaneous/CNS = Cryptococcus pattern\n\n💡 systemic",
...

  {
    ...
    options: ["Spherules with endospores 30-60 μm","Oval-shaped to tear drop, single round pink nucleus","Hyphae septate branching at 45° angle","Round, narrow-neck budding, thick clear capsule 4-15 μm (Cryptococcus)"],
    answer: 1,
    explain: "Sporo: oval/teardrop, 2-5 μm, มักอยู่ใน macrophage\nCrypto: round budding กับ thick mucopolysaccharide capsule (clear halo), 4-15 μm\n\n❌ ทำไมข้ออื่นผิด\n— Spherules + endospores 30-60 μm = Coccidioides\n— Hyphae 45° = Aspergillus\n— Round narrow-neck budding 4-15 μm = Cryptococcus\n\n💡 blue cytoplasm, non-staining cell wall (2-5 μm + 1 μm clear capsule), มักอยู่ใน macrophage",
...

  {
    ...
    answer: false,
    explain: "False! Ketoconazole common ในสุนัข แต่ ห้ามใช้ในแมว เพราะ hepatotoxic มาก (cholangiohepatitis + ↑ liver enzyme)",
...

  {
    ...
    options: ["Potassium iodide (KI) 2.5-20 mg/kg q24h PO","Penicillin G 22,000 IU/kg IM q12h","Griseofulvin 25 mg/kg PO q12h","Amphotericin B 0.25 mg/kg IV q48h","Itraconazole 10 mg/kg PO q24h"],
    answer: 0,
    explain: "KI = TOC ในสุนัข ใช้รูป supersaturated solution (SSKI)\nในแมวใช้ได้แต่ระวัง mild ↑ liver enzyme + hepatotoxicity",
...

  {
    ...
    options: ["ต่ออีก 1 เดือนหลังแผลหายสนิท","ต่ออีก 1 สัปดาห์หลังแผลหาย","ต่ออีก 1 ปีเต็มหลังแผลหาย","หยุดยาทันทีที่แผลปิดสนิท"],
    answer: 0,
    explain: "ต่อยา ≥1 เดือนหลัง clinical cure\nเพื่อกัน relapse\nระวัง: zoonosis ใส่ถุงมือเสมอ\n\n❌ ทำไมข้ออื่นผิด\n— \"1 สัปดาห์\" = สั้นเกิน → relapse\n— \"1 ปี\" = นานเกินจำเป็น\n— \"หยุดทันที\" = relapse risk",
...

  {
    ...
    options: ["ดินที่ปนเปื้อนมูลนกพิราบ","น้ำทะเล / brackish water","พืชผักผลไม้สดที่ไม่ล้าง","อากาศในอาคารที่อับชื้น","น้ำในคลองที่ปนเปื้อน"],
    answer: 0,
    explain: "C. neoformans พบในดินปนเปื้อน pigeon droppings\ntransmission = inhalation ของ basidiospores\nnasal cavity = primary site\n\n❌ ทำไมข้ออื่นผิด\n— น้ำทะเล / พืช / อากาศ / น้ำคลอง = ไม่ใช่ source หลัก (Crypto = pigeon droppings + decaying wood)",
...

  {
    ...
    answer: 1,
    explain: "4 forms (ไม่จำเป็นต้องเรียงตามเวลาเหมือน sporotrichosis): Nasal (most common) → CNS via cribriform plate → Cutaneous (non-pruritic nodules) → Systemic\n\n❌ ทำไมข้ออื่นผิด\n— \"Acute/Chronic/Latent/Reactivation\" = clinical timeline\n— \"Local/Regional/Distant\" = cancer staging\n— \"Cutaneolymphatic\" = Sporotrichosis pattern",
    verified: "Sporotrichosis and Cryptococcosis.pdf p.61",
    wikiRefs: [
          {
                "pageId": "com5-systemic-mycoses-and-protozoa",
...

  {
    ...
    answer: 2,
    explain: "Local dissemination ผ่าน cribriform plate → sudden blindness (optical neuritis), seizure, behavior change\n\n❌ ทำไมข้ออื่นผิด\n— Lymphatic = ไม่ใช่ pathway หลัก ใน Crypto\n— Direct inoculation = ผิวหนัง ไม่ใช่ CNS\n— Hematogenous = secondary mode\n\n💡 จมูก → สมอง",
...

  {
    ...
    answer: 1,
    explain: "H&E เห็น eosinophilic body กับ clear halo, Mayer's mucicarmine = ย้อม mucopolysaccharide capsule เฉพาะ\n\n❌ ทำไมข้ออื่นผิด\n— H&E only = capsule ไม่เห็นชัด\n— Gram = bacterial\n— Ziehl-Neelsen = AFB (TB)",
...

  {
    ...
    answer: 0,
    explain: "Giardia cyst: 9-13 × 7-9 μm, 4 nuclei, median bodies, axoneme\nลอย ZnSO4 ได้ดี",
...

  {
    ...
    options: ["Giardia spp. (cyst 8-12 µm)","Tritrichomonas foetus (trophozoite 8-15 µm, no cyst)","Cystoisospora canis, Neospora caninum","Cryptosporidium spp. (oocyst 4-6 µm)"],
    answer: 2,
    explain: "Apicomplexa enteric coccidia: 1 oocyst : 2 sporocyst : 4 sporozoite (ยกเว้น Cryptosporidium = 1:0:4)\n\n❌ ทำไมข้ออื่นผิด\n— Giardia = trophozoite/cyst (no sporocyst)\n— Tritrichomonas = trophozoite only\n— Crypto = 1:0:4 (no sporocyst)\n\n💡 ratio 1:2:4\n\n💡 Toxoplasma, Sarcocystis",
...

  {
    ...
    options: ["Centrifugal flotation","Antigen ELISA stool เลย (ข้าม microscopy)","Direct fecal smear (wet mount)","Formalin-ether sedimentation","Simple sedimentation"],
    answer: 2,
...

  {
    ...
    options: ["แอนติบอดีต่อ Giardia ในเลือด","แอนติบอดีต่อ Giardia ในอุจจาระ","Giardia cyst wall protein ในอุจจาระ","การเคลื่อนที่ของ trophozoite"],
    answer: 2,
    explain: "SNAP/FASTest = ELISA ตรวจ cyst wall protein (encystation antigen) ที่ shed ออกมาในอุจจาระ\n\n❌ ทำไมข้ออื่นผิด\n— antibody เลือด/อุจจาระ = passive marker ไม่ specific\n— \"เคลื่อนที่\" = direct smear ไม่ใช่ ELISA",
...

  {
    ...
    answer: 3,
    explain: "T. gondii sporulated: 1 oocyst : 2 sporocyst : 4 sporozoite (each) = 1:2:4\nขนาด 10×12 μm\n\n❌ ทำไมข้ออื่นผิด\n— 2:4:8 = ไม่ใช่ Apicomplexa structure\n— 1:1:1 = no logical\n— 1:0:4 = Cryptosporidium",
...

  {
    ...
    options: ["เล็กมาก 3-5 μm, NO sporocyst","เป็น cyst เดียว ไม่มี sporozoite","มีหาง flagella เคลื่อนไหวเร็ว","ใหญ่ 50 μm มี 2 sporocyst"],
    answer: 0,
    explain: "Crypto: tiny (3-5 μm), 1:0:4 (no sporocyst), sporulated already in host\nsporulation ในตัว host\nชอบเกาะ brush border microvillus\n\n❌ ทำไมข้ออื่นผิด\n— \"Cyst เดียวไม่มี sporozoite\" = non-infective\n— \"หาง flagella\" = trophozoite (Giardia)\n— \"ใหญ่ 50 μm 2 sporocyst\" = Cystoisospora ไม่ใช่ Crypto\n\n💡 4 sporozoites only (ratio 1:0:4), เล็กกว่าเม็ดเลือดแดง",
...

  {
    ...
    options: ["C. felis","C. muris","C. baileyi","C. parvum","C. canis"],
    answer: 3,
    explain: "C. parvum (cattle) = major zoonotic in humans\nC. canis (dog) และ C. felis (cat) เป็น rare zoonoses\n\n❌ ทำไมข้ออื่นผิด\n— C. felis = mostly cat-restricted\n— C. muris = rodent\n— C. baileyi = avian\n— C. canis = mostly dog\n\n💡 จากโค",
...

  {
    ...
    options: ["InPouch TF-Feline (fecal culture) หรือ PCR","Centrifugal flotation ด้วย ZnSO4","Serology ตรวจแอนติบอดีในเลือด","Direct fecal smear (wet mount)"],
    answer: 0,
...

  {
    ...
    options: ["Fenbendazole 50 mg/kg SID","Praziquantel 5 mg/kg PO ครั้งเดียว","Ronidazole 30 mg/kg PO q24h × 10 d","ไม่มียาเฉพาะ — รอหายเอง","Metronidazole 22 mg/kg PO BID"],
    answer: 2,
    explain: "Ronidazole = effective แต่ไม่มี approval + neurologic AE\nMost cats spontaneous resolution ใช้เวลานานถึง 2 ปี\n\n❌ ทำไมข้ออื่นผิด\n— Fenbendazole = Giardia\n— Praziquantel = cestode\n— \"ไม่มียา\" = ผิด (Ronidazole มี off-label)\n— Metronidazole = ไม่ effective\n\n💡 use with caution: neurologic AE",
...

  {
    ...
    options: ["Nucleus เดี่ยวกลางลำตัว","Pear-shaped body รูปลูกแพร์","Anterior flagella หลายเส้น","Cyst stage และ falling-leaf motility"],
    answer: 3,
    explain: "T. foetus: 1 nucleus, axostyle, 3 anterior flagella + undulating membrane, NO cyst stage, erratic/jerky motility\nGiardia: 2 nuclei, sucking disc, มี cyst stage, falling-leaf motility\n\n❌ ทำไมข้ออื่นผิด\n— 1-2 nuclei / Pear-shaped / Anterior flagella = ทั้งคู่มีลักษณะคล้ายกัน — cyst stage + falling-leaf motility = Giardia เท่านั้น",
...

  {
    ...
    options: ["ทุกครั้งที่กินเนื้อดิบ shed นานกว่า 30 วัน","ไม่ shed oocyst เลยในอุจจาระ (< 1 วัน)","หลัง infection แรกครั้งเดียวในชีวิต ระยะเวลา 7-10 วัน","shed ตลอดชีวิต ทุกวันต่อเนื่อง 365 วัน/ปี"],
    answer: 2,
    explain: "Cat shed oocyst หลัง primary infection ครั้งเดียวในชีวิต × 7-10 วัน\nsporulated 10×12 μm = infective\n\n❌ ทำไมข้ออื่นผิด\n— ทุกครั้งกินเนื้อดิบ > 30 d = ผิด (เฉพาะ primary infection)\n— ไม่ shed เลย = ผิด\n— ตลอดชีวิตทุกวัน = ผิด\n\n💡 millions of oocysts",
    verified: "GI_protozoa.pdf p.40" },

  {
    ...
    options: ["Abortion (พบบ่อยใน goat/sheep, rare ในแมว)","Skin nodules ทั่วตัว + alopecia","Pneumonitis, encephalitis","ท้องเสียอย่างเดียว (mild self-limiting)"],
    answer: 2,
    explain: "Common: pneumonitis, encephalitis, hepatitis, pancreatitis, myocarditis, chorioretinitis\nLab: bilirubinemia, leukopenia, anemia\nAbortion พบใน dog > cat\n\n❌ ทำไมข้ออื่นผิด\n— Abortion = goat/sheep (rare แมว)\n— Skin nodules = ไม่ใช่ multi-organ\n— ท้องเสียอย่างเดียว = mild ไม่ characteristic\n\n💡 hepatitis, chorioretinitis, uveitis",
...

  {
    ...
    pairs: [{"left":"Toxoplasma gondii — Definitive host","right":"Cat"},{"left":"Neospora caninum — Definitive host","right":"Dog"},{"left":"Sarcocystis spp. — Definitive host","right":"Carnivore (predator)"}],
...

  {
    ...
    options: ["ให้ steroid ลดการอักเสบของลำไส้","แยกตัวที่ป่วยออกมาเท่านั้น","Daily fecal removal + disinfectant","ฉีดวัคซีนป้องกัน coccidia"],
    answer: 2,
    explain: "Sporulated oocyst ทน common disinfectants\nDaily fecal removal ก่อน sporulate (อยู่ในสิ่งแวดล้อม < 24 hr) + steam/pressure wash + treat all in-contact",
...

  {
    ...
    answer: false,
    explain: "False! Pseudoparasites: yeast, plant remnants, debris สามารถดูคล้าย cyst ได้\nต้องใช้ Lugol's iodine staining + repeat fecal เพราะ cyst shed intermittent",
...

  {
    ...
    answer: 2,
    explain: "28 กันยายน = World Rabies Day (วันตายของ Louis Pasteur, 28 Sep 1895)",
...

  {
    ...
    options: ["4 เดือนขึ้นไปแต่ไม่เกิน 6 เดือน","6 เดือนขึ้นไปแต่ไม่เกิน 8 เดือน","2 เดือนขึ้นไปแต่ไม่เกิน 4 เดือน","1 เดือนขึ้นไปแต่ไม่เกิน 2 เดือน"],
    answer: 2,
    explain: "พรบ.โรคพิษสุนัขบ้า: อายุ 2-4 เดือน\nไม่จัดให้สัตว์ฉีดปรับไม่เกิน 200 บาท\n\n❌ ทำไมข้ออื่นผิด\n— 4-6 เดือน = ช้าเกินตามกฎหมาย\n— 6 เดือน+ = ผิด\n— 1 เดือน = เร็วเกิน (MDA ยังสูง)",
...

  {
    ...
    pairs: [{"left":"Prodromal","right":"พฤติกรรมเปลี่ยน"},{"left":"Excitative","right":"ดุร้าย/บ้าคลั่ง"},{"left":"Paralytic","right":"อัมพาต/ตาย"}],
...

  {
    ...
    options: ["ELISA antibody detection in serum","Histopathology with Sellers stain","DFA (Direct Fluorescent Antibody Test)","PCR (RT-PCR brain — confirmatory แต่นานกว่า)"],
    answer: 2,
    explain: "DFA = วิธีหลัก (สถานเสาวภา)\nทำได้ภายในวันเดียว\nNegri bodies = หลักฐานอ้อม, เจอ = positive แต่ไม่เจอ ≠ negative\n\n💡 brain impression smear",
...

  {
    ...
    options: ["อย่าแยก อย่ายึด อย่าย่อย อย่ายุติ อย่ายอม","อย่าแหย่ อย่าแยก อย่าเหยียบ อย่ายุ่ง อย่าหยิบ","อย่าเยี่ยม อย่ายุ่ง อย่ายอม อย่าเยือก อย่ายา","อย่ายา อย่ายอง อย่ายึด อย่ายับยั้ง อย่ายอม"],
    answer: 1,
...

  {
    ...
    options: ["Parvoviridae / Parvovirus","Rhabdoviridae / Lyssavirus","Coronaviridae / Coronavirus","Reoviridae / Rotavirus"],
    answer: 1,
    explain: "Rhabdoviridae\nLyssavirus genus\nnegative-sense ssRNA\nbullet-shaped\nenveloped\n\n❌ ทำไมข้ออื่นผิด\n— Parvoviridae = CPV\n— Coronaviridae = CCV\n— Reoviridae = Rotavirus\n\n💡 bullet-shaped, ssRNA, enveloped",
...

  {
    ...
    options: ["Scratch + Lick to MM/wound + Trans-placenta","พาหะแมลงดูดเลือดเช่นยุงและเห็บกัด","การหายใจเอาอากาศในห้องปกติทั่วไป","การกินอาหารและดื่มน้ำตามปกติ"],
    answer: 0,
    explain: "Non-bite: scratch จากเล็บที่ปนเปื้อนน้ำลาย (สัตว์เลียเล็บตัวเอง), lick ที่ mucous membrane / แผลเปิด, trans-placental (rare)\nBite = หลัก\n\n❌ ทำไมข้ออื่นผิด\n— พาหะแมลง = arboviral (ไม่ใช่ rabies)\n— หายใจปกติ = ไม่ใช่ aerosol (เฉพาะถ้ำค้างคาว)\n— กินอาหารปกติ = enteric ไม่ใช่ route หลัก",
...

  {
    ...
    pairs: [{"left":"Centripetal (Retrograde)","right":"จากกล้ามเนื้อ → spinal cord → brain"},{"left":"Centrifugal (Anterograde)","right":"จากสมอง → salivary gland (shedding)"}],
...

  {
    ...
    options: ["Intracytoplasmic clear vacuoles","Intracytoplasmic eosinophilic inclusion bodies","Multinucleated giant cells ขนาดใหญ่","Intranuclear basophilic inclusion"],
    answer: 1,
    explain: "Negri bodies = pathognomonic แต่ sensitivity ต่ำ → ไม่เจอก็เป็น Rabies ได้\nDFA แม่นกว่า\n\n💡 พบ = positive แต่ไม่เจอ ≠ negative",
...

  {
    ...
    options: ["ถูกเลียที่ผิวหนังปกติโดยไม่มีรอยถลอก","ถูกสัตว์เลียบนผิวหนังที่มีรอยถลอกแห้งหลายเดือน","ถูกกัดทะลุผิวหนังมีเลือดออก หรือน้ำลายสัมผัสเยื่อบุ","ถูกข่วนเป็นรอยถลอกเล็กน้อย ไม่มีเลือดออก","ถูกต้องตัวสัตว์โดยไม่มีแผลที่ผิวหนัง"],
    answer: 2,
    explain: "Cat. 3: ถูกกัดมีเลือด, ถูกข่วนจนผิวหนังขาดมีเลือด, น้ำลายสัมผัสเยื่อบุตา/ปาก/จมูก → ล้างแผล + วัคซีน + อิมมูโนโกลบูลิน\nCat. 1 = ไม่ติด\nCat. 2 = ฉีดวัคซีน (ไม่อิมมูโน)\n\n❌ ทำไมข้ออื่นผิด\n— \"เลียผิวปกติ\" = Cat 1\n— \"เลียผิวรอยถลอกแห้งหลายเดือน\" = Cat 2 (low risk)\n— \"ข่วนรอยถลอกไม่มีเลือด\" = Cat 2\n— \"ต้องตัวไม่มีแผล\" = Cat 1",
...

  {
    ...
    options: ["Wash + irrigate ด้วย soap solution หรือ QUAT","พอกแผลด้วยสมุนไพรไทยตามภูมิปัญญาท้องถิ่น","ปิดแผลทันทีโดยไม่ต้องล้างทำความสะอาด","เอารองเท้าตบที่แผลให้มีเลือดออกเพิ่ม"],
    answer: 0,
    explain: "WHO/CDC: ล้างน้ำสะอาดด้วยสบู่หรือ QUAT อย่างน้อย 15 นาที\nแล้ว apply ethanol/povidone iodine\nห้ามรักษาตามความเชื่อโบราณ\n\n❌ ทำไมข้ออื่นผิด\n— พอกสมุนไพร / ปิดแผลไม่ล้าง / ตบให้เลือดออก = ห้ามตามแนว WHO/CDC",
...

  {
    ...
    answer: false,
    explain: "False! Sens/Spec ของ test kit ไม่สูงมากนัก + การเก็บน้ำลายสัตว์ป่วยเสี่ยงสัมผัสเชื้อ\nDFA ยังเป็น gold standard",
...

  {
    ...
    options: ["ไม่ต้องฉีดในลูกสัตว์ที่อายุน้อยกว่า 4 เดือน","2 เข็มเริ่มอายุ 12 สัปดาห์ แล้ว booster ทุกปี","ฉีดทุก 6 เดือนต่อเนื่องไปตลอดชีวิต","1 เข็มเดียวตอนอายุ 3 เดือน เท่านั้นพอ"],
    answer: 1,
...

  {
    ...
    answer: true,
    explain: "Human-to-human transmission พบได้ใน case report ผ่าน organ/cornea transplant — case rare แต่มีจริง",
...

  {
    ...
    options: ["CaPiV + Bordetella + Borrelia + Canine influenza + Leishmania + CHV-1","CDV + CPV + Rabies (core ทุกตัว ฉีดอายุ ≥ 16 wk)","Rabies + Leptospirosis เดี่ยว (ฉีดอายุ < 12 wk)","CDV + CPV + CAV (core ทั้งหมด ฉีดอายุ ≥ 16 wk)"],
    answer: 0,
    explain: "Non-core สุนัข: CaPiV, Bordetella, Borrelia, CIV, leishmania, CHV-1\nKilled CPV/CCoV/Giardia/Microsporum = Not Recommended",
...

  {
    ...
    options: ["14 สัปดาห์","12 สัปดาห์","16 สัปดาห์ขึ้นไป","10 สัปดาห์"],
    answer: 2,
    explain: "WSAVA 2024: start 6-8 wk → revaccinate every 3-4 wk จนถึง ≥16 wk\nMDA persist up to 16 wk\n\n❌ ทำไมข้ออื่นผิด\n— 14/12/10 wk = MDA อาจยัง interfere → ฉีดต้อง ≥16 wk เพื่อ override\n\n💡 เพื่อ override MDA",
    verified: "Vaccination_guideline.pdf p.9",
    wikiRefs: [
          {
                "pageId": "com5-rabies-and-vaccine-guidelines",
...

  {
    ...
    options: ["ไม่ตอบสนองต่อการกระตุ้นซ้ำ","ตอบสนองมากกว่าปกติ (hyper-response)","ตอบสนองได้บ้าง แต่ไม่ดีเท่า primary series","ตอบสนองได้ดีไม่ต่างจากสุนัขที่ฉีดประจำ"],
    answer: 3,
    explain: "Moore et al. JAVMA 2015: anamnestic response ของสัตว์ที่ขาด rabies vaccine เหมือนสัตว์ที่ฉีดประจำ → post-exposure: booster + observe 45 d (NOT euthanize/quarantine 6 mo)\n\n❌ ทำไมข้ออื่นผิด\n— \"ไม่ตอบสนอง\" / \"hyper response\" / \"ตอบสนองได้บ้างแต่ไม่ดี\" = ผิด — anamnestic response ของสัตว์ที่เคยฉีด ดีเท่า primary\n\n💡 memory response — anamnestic",
...

  {
    ...
    options: ["ฉีดทุก 5 ปี (ขยาย interval จากเดิม 3 ปี)","Lepto + FeLV เพิ่มเป็น core (with conditions)","ยกเลิก rabies vaccine ออกจาก core ทั้งหมด","ลด core vaccine เหลือเฉพาะ CDV ตัวเดียว"],
    answer: 1,
    explain: "Highlights 2024: Lepto+FeLV เพิ่มเป็น core มีเงื่อนไข + บูสต์เข็มแรกที่ 6 เดือนแทน 1 ปี\n6-mo booster แทน 1-yr\nserological titer testing (≥20 wks)\n\n❌ ทำไมข้ออื่นผิด\n— \"ฉีดทุก 5 ปี\" = ผิด (3-yr ยังเหมือนเดิม)\n— \"ยกเลิก rabies\" = ผิด\n— \"ลด core เหลือ CDV\" = ผิด",
...

  {
    ...
    options: ["ฉีดเฉพาะแมวสูงวัยอายุมากกว่า 5 ปีเท่านั้น","แมวในประเทศ endemic + อายุ < 1 ปี หรือแมวโตที่เสี่ยง expose","เฉพาะแมวบ้านที่อยู่ในห้องตลอด (กลุ่ม low-risk)","ทุกตัวต้องฉีดเหมือน FPV/FHV/FCV แบบ absolute"],
    answer: 1,
    explain: "WSAVA 2024: FeLV core with conditions\nendemic + <1yr or older with risk\nต้อง FeLV-ve test ก่อนทุกครั้ง\nVPAT 2024 ใช้ <2 yr\n\n❌ ทำไมข้ออื่นผิด\n— \"> 5 ปีเท่านั้น\" = ทิศตรงข้าม (target < 1 yr)\n— \"แมวบ้านในห้อง\" = low-risk ไม่ฉีด\n— \"ทุกตัวเหมือน FPV\" = ผิด (conditional, ไม่ absolute)\n\n💡 ต้องตรวจ FeLV-negative ก่อนฉีด",
...

  {
    ...
    options: ["MDA ต่ำกว่า protective titer แต่ยังสูงพอที่จะ neutralize vaccine","ช่วงหลังจากได้รับวัคซีนเข็มสุดท้ายของ puppy series แล้ว","ช่วงก่อนคลอดที่ลูกสัตว์ยังอยู่ในครรภ์แม่","ช่วงที่ MDA สูงสุด ป้องกันโรคได้ + วัคซีนทำงานได้ดี"],
    answer: 0,
    explain: "CPV: HI ≥ 80 = protective, HI ≤ 10 = no interference\nWindow = ช่วงที่ MDA ลดต่ำกว่า protective แต่ยัง interfere vaccine → ต้องฉีดซ้ำทุก 2-4 wk จน 16 wk\n\n❌ ทำไมข้ออื่นผิด\n— \"หลังวัคซีนเข็มสุดท้าย\" = ตรงข้าม\n— \"ก่อนคลอด\" = ไม่เกี่ยว MDA\n— \"MDA สูงสุด\" = vaccine ไม่ work แต่ไม่ใช่ \"window\" ของ susceptibility",
...

  {
    ...
    options: ["น้ำหนัก ≤ 5 kg, อายุน้อย, multiple vaccines, certain breeds","อ้วน BCS 8/9, สุนัขโต > 7 ปี, vaccine ใหม่","ไม่มีปัจจัยเสี่ยงในสุนัข > 1 ปี","สุนัขใหญ่ > 30 kg, อายุ > 5 ปี, วัคซีนเข็มเดียว"],
    answer: 0,
    explain: "Moore JAVMA 2023: AE rate 19.4/10,000 visits\n25% เพิ่มต่อวัคซีนเข็มที่เพิ่ม\nTop 3 breed: Frenchie, Dachshund, Boston Terrier\nRabies + DA2PP มี VAE rate สูงสุด\n\n❌ ทำไมข้ออื่นผิด\n— อ้วน + > 7 yr = ทิศทางตรงข้าม\n— \"ไม่มี risk factor\" = ผิด\n— ใหญ่ > 30 kg + > 5 yr = ทิศทางตรงข้าม\n\n💡 French Bulldog, Dachshund, Boston Terrier",
...

  {
    ...
    options: ["ไม่ต่างกัน (immunogenicity เท่ากัน)","Mucosal (IN/oral) ให้ IgA + onset เร็ว","ห้ามใช้ในสุนัข < 8 สัปดาห์","Parenteral ดีกว่าทุกกรณี (systemic IgG-driven)"],
    answer: 1,
    explain: "IN/oral ให้ mucosal IgA\nระวัง zoonotic B. bronchiseptica (โดยเฉพาะ immunocompromised owners)\n\n❌ ทำไมข้ออื่นผิด\n— \"ไม่ต่างกัน\" = ผิด\n— \"ห้ามใน < 8 wk\" = ใช้ได้ใน young\n— \"Parenteral ดีกว่าทุกกรณี\" = ผิด (mucosal IgA ต่างกัน)\n\n💡 parenteral onset ช้ากว่า",
...

  {
    ...
    options: ["ไม่ต้อง booster หลัง puppy/kitten series","18 เดือน หลัง initial vaccination series","24 เดือน หลัง puppy/kitten series","6 เดือน แทน 12-16 เดือน แล้ว revaccinate ทุก 3 ปี","12 เดือน เหมือน WSAVA guideline ปี 2016"],
    answer: 3,
...

  {
    ...
    options: ["Killed CPV, CCoV, Giardia spp., Microsporum canis","CaPiV, B. bronchiseptica (กลุ่ม non-core)","Rabies, Leptospirosis (core ในประเทศไทย)","CDV, CPV, CAV (core ทั้งหมดเสมอ)"],
    answer: 0,
    explain: "Not recommended (WSAVA 2024): Killed CPV, CCoV, Giardia, Microsporum\ninsufficient scientific evidence\n\n❌ ทำไมข้ออื่นผิด\n— \"CaPiV/Bordetella\" = non-core (ใช้ได้)\n— \"Rabies/Lepto\" = core\n— \"CDV/CPV/CAV\" = core (ไม่ใช่ Not Recommended)",
...

  {
    ...
    answer: true,
    explain: "Highlight WSAVA 2024: separate program สำหรับ shelter/sanctuary cats and dogs (high-density crowded environment)",
...

  {
    ...
    options: ["Annual revaccination","ไม่ต้อง booster","ทุก 3 ปี เหมือน low-risk","ทุก 5 ปี"],
    answer: 0,
    explain: "Low-risk cat: revacc ทุก 3 ปี\nHigh-risk cat: annual revaccination\nเปลี่ยน boost 6 เดือนแทน 1 ปี เพิ่มจาก 2016\n\n❌ ทำไมข้ออื่นผิด\n— \"ไม่ต้อง booster\" = ผิด\n— \"ทุก 3 ปี\" = low-risk schedule\n— \"ทุก 5 ปี\" = ผิด\n\n💡 ทุก 1 ปี",
...

  {
    ...
    answer: true,
    explain: "Monovalent rabies > polyvalent ใน puppy <1 yr (Thai Rabies CPG)\nปีแรก visit ไหน rabies ก็ควรฉีดเข็มเดียว ไม่รวม",
...

  {
    ...
    answer: 2,
    explain: "Anamnestic response เหมือน up-to-date → booster + observe 45 d (ไม่ต้อง euthanize / 6-mo quarantine)\nMoore 2015 เปลี่ยนแนวทางเดิม",
...

  {
    ...
    options: ["Cataract ที่เลนส์ตาขุ่น","Dendritic corneal ulceration","Glaucoma ความดันลูกตาสูง","Cherry eye ต่อมเปลือกตาที่ 3 ปลิ้น"],
    answer: 1,
    explain: "Dendritic corneal ulcer = FHV-1 specific\nstromal keratitis ก็พบได้\nchronic corneal ulcer ในแมวที่เคยติดเชื้อ\n\n❌ ทำไมข้ออื่นผิด\n— Cataract = lens (ไม่ specific)\n— Glaucoma = ↑ IOP\n— Cherry eye = third eyelid prolapse",
...

  {
    ...
    options: ["Alcohol 70% เช็ดพื้นผิว","Quaternary ammonium (QUAT)","1:32 of 5.25% sodium hypochlorite","Chlorhexidine 2% solution"],
    answer: 2,
...

  {
    ...
    pairs: [{"left":"Dendritic corneal ulcer","right":"FHV-1"},{"left":"Oral ulcer + limping syndrome","right":"FCV"},{"left":"Chemosis เด่น (ocular > respiratory)","right":"Chlamydia felis"},{"left":"Cough เด่น + zoonotic","right":"Bordetella bronchiseptica"}],
...

  {
    ...
    options: ["ติดต่อจากแมวสู่คนได้ผ่านการสัมผัสน้ำเหลือง/หนองจากแผลโดยตรง","ติดต่อทางอากาศโดยการหายใจเอาสปอร์เหมือนวัณโรค","ติดต่อจากการกินอาหารหรือน้ำที่ปนเปื้อนเชื้อรา","เป็นเชื้อราเฉพาะในแมว ไม่ติดต่อมาสู่คน"],
    answer: 0,
    explain: "Sporotrichosis เป็น zoonotic fungal infection ที่ติดต่อจากแมวสู่คนได้ทาง direct contact with exudate/discharge from cutaneous lesions (รวมการข่วน/กัด เพราะ yeast cell อยู่ในเล็บ/น้ำลาย) — ต่างจาก fungal อื่นที่มักได้จากสิ่งแวดล้อม\n\nคำแนะนำเจ้าของ:\n• ใส่ถุงมือทุกครั้งที่จับแมว/ทำแผล\n• เลี้ยงแบบ indoor + กักตัวจนหาย\n• คนภูมิคุ้มกันต่ำ (HIV, chemo, organ transplant) → ห้ามสัมผัส\n• ★ กินยาต่ออีก 1 เดือนหลังแผลหายสนิท ไม่งั้นกลับมาเป็นอีก\n\n❌ ทำไมข้ออื่นผิด\n— Airborne = ไม่ใช่ route หลัก (TB, COVID)\n— Foodborne = ไม่ใช่ Sporothrix\n— \"ไม่ติดต่อ\" = false, อันตรายต่อคน\n\n💡 รวมข่วน, กัด",
...

  {
    ...
    answer: 2,
    explain: "Fluconazole = best CNS penetration ในกลุ่ม azole (small molecule, water-soluble, low protein binding) → reach CSF concentration > 60% ของ plasma, ใช้ในกรณี mild-moderate CNS Crypto, severe CNS / disseminated → Amphotericin B + Flucytosine (synergistic) ก่อน, แล้ว maintenance ด้วย Fluconazole\n\n❌ ทำไมข้ออื่นผิด\n— Itraconazole = lipophilic, large molecule → CNS penetration แย่\n— Ketoconazole = ไม่ผ่าน BBB + hepatotoxic\n— Posaconazole = active แต่ ราคาแพง + CNS penetration ยังไม่ดีเท่า Fluconazole",
