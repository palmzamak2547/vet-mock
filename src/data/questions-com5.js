...
export const QB_COM5 = [
  ...
  { id: 504, subject: 'com5', topic: 'cve', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['Antibiotic เท่านั้น', 'Restoration of fluid + electrolyte', 'Vaccine therapy', 'Antiviral specific drug'],
  ...
  { id: 541, subject: 'com5', topic: 'cve', year: 4, source: 'CVE.pdf',
    ...
    options: ['Sulfa-Trimethoprim PO เดี่ยว', 'Vancomycin IV เดี่ยว', 'Doxycycline + Metronidazole PO', 'Beta-lactam + Aminoglycoside / Enrofloxacin', 'Amoxicillin PO เดี่ยว'],
  ...
  { id: 509, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Com_5_final_TJ.pdf',
    ...
    options: ['ผ่านพาหะแมลง', 'Tick-borne', 'กินอาหารปนเปื้อน', 'การสัมผัสกับแมวที่ติดเชื้อ', 'สูดดมสปอร์'],
  ...
  { id: 549, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Sporotrichosis and Cryptococcosis.pdf',
    ...
    options: ['Local / Regional / Metastatic', 'Pulmonary / GI / CNS', 'Cutaneous / Cutaneolymphatic / Disseminated', 'Nasal / Cutaneous / CNS'],
  ...
  { id: 573, subject: 'com5', topic: 'gi-protozoa', year: 4, source: 'GI_protozoa.pdf',
    ...
    options: ['ทุกครั้งที่กินเนื้อดิบ shed > 30 วัน', 'ไม่ shed เลย (< 1 วัน)', 'หลัง infection แรกครั้งเดียวในชีวิต ระยะเวลา 7-10 วัน', 'ตลอดชีวิต ทุกวัน 365 d/y'],
  ...
  { id: 582, subject: 'com5', topic: 'rabies', year: 4, source: 'Rabies.pdf',
    ...
    options: ['Cytoplasmic vacuoles', 'Intracytoplasmic eosinophilic inclusion bodies', 'Multinucleated giant cells', 'Intranuclear basophilic inclusion'],
  ...
  { id: 593, subject: 'com5', topic: 'vaccine', year: 4, source: 'Vaccination_guideline.pdf',
    ...
    options: ['ฉีดในแมวอายุ > 5 ปีเท่านั้น', 'แมวในประเทศ endemic + อายุ < 1 ปี หรือ older cats with risk of exposure', 'แค่แมวบ้านที่อยู่ในห้องตลอด (low-risk)', 'ทุกตัวต้องฉีดเหมือน FPV/FHV/FCV'],
  ...
  { id: 597, subject: 'com5', topic: 'vaccine', year: 4, source: 'Vaccination_guideline.pdf',
    ...
    options: ['CDV ≥ 8, CAV ≥ 4, CPV ≥ 16', 'ทั้งสามตัว ≥ 100', 'CDV ≥ 256, CAV ≥ 256, CPV ≥ 256', 'CDV ≥ 32 (1:32), CAV ≥ 16 (1:16), CPV ≥ 80'],
  ...
  { id: 615, subject: 'com5', topic: 'feline-uri', year: 4, source: 'Feline_Upper_Respiratory_Infection.pdf',
    ...
    options: ['Alcohol 70%', 'Quaternary ammonium', '1:32 of 5.25% sodium hypochlorite', 'Chlorhexidine 2%'],
  ...
  { id: 625, subject: 'com5', topic: 'sporo-crypto', year: 4, source: 'Sporotrichosis and Cryptococcosis + FINAL 86',
    ...
    options: ['ติดต่อจากแมวสู่คนได้ผ่านการสัมผัสน้ำเหลือง/หนองจากแผลโดยตรง', 'ติดต่อทางอากาศเหมือนวัณโรค', 'ติดต่อจากการกินอาหารที่ปนเปื้อน', 'ไม่ติดต่อสู่คน'],
  ...
  { id: 627, subject: 'com5', topic: 'vaccine', year: 4, source: 'WSAVA 2024 + FINAL 86',
    ...
    options: ['ยกเลิก rabies vaccine', 'เพิ่ม Leptospirosis และ FeLV เป็น core ในบางกรณี + ปรับ booster หลัง 16 wk เป็น 6 เดือน', 'ลด core เหลือแค่ rabies', 'แนะนำให้ vaccine ทุกตัวเดือนละครั้ง'],
