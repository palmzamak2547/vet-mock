...
export const LECTURE_COVERS = {
  ...
  'zoonoses': {
    'zoo-intro': { src: base('lecture-covers', 'zoonoses-zoo-intro'), alt: 'ปกสไลด์ 3109504 Zoonoses ภาพอาคารคณะสัตวแพทยศาสตร์ จุฬาฯ' },
    'zoo-ai': { src: base('lecture-covers', 'zoonoses-zoo-ai'), alt: 'ปกสไลด์ Avian Influenza Virus ภาพอนุภาคไวรัสพื้นน้ำเงิน' },
    'zoo-siv': { src: base('lecture-covers', 'zoonoses-zoo-siv'), alt: 'ปกสไลด์ Swine Influenza Virus (SIV) ภาพหน้าสุกร' },
    'zoo-ebola': { src: base('lecture-covers', 'zoonoses-zoo-ebola'), alt: 'ปกสไลด์ Ebola virus disease พื้นขาว กรอบเหลือง' },
    'zoo-vbz': { src: base('lecture-covers', 'zoonoses-zoo-vbz'), alt: 'ปกสไลด์ Vector-borne viral zoonosis ภาพยุงลายและเห็บ' },
    'zoo-rickettsial': { src: base('lecture-covers', 'zoonoses-zoo-rickettsial'), alt: 'ปกสไลด์ Rickettsia zoonoses ภาพแบคทีเรียสีม่วง' },
    'zoo-rabies': { src: base('lecture-covers', 'zoonoses-zoo-rabies'), alt: 'ปกสไลด์ Comprehensive Rabies Control in Thailand ภาพการ์ตูนสุนัขสองตัว' },
    'zoo-emerging': { src: base('lecture-covers', 'zoonoses-zoo-emerging'), alt: 'ปกสไลด์ Emerging virus พื้นขาว' },
    'zoo-corona': { src: base('lecture-covers', 'zoonoses-zoo-corona'), alt: 'ปกสไลด์ Viral Zoonosis II Coronaviruses ภาพค้างคาว เฟอร์เรต สุนัข แมว และเสือ' },
    'zoo-outbreak': { src: base('lecture-covers', 'zoonoses-zoo-outbreak'), alt: 'ปกสไลด์ Lessons from the Field Outbreak Investigation of Zoonotic Diseases ภาพค้างคาว' },
    'zoo-helminthic': { src: base('lecture-covers', 'zoonoses-zoo-helminthic'), alt: 'ปกสไลด์ Helminthic Zoonoses ภาพไข่พยาธิและตัวอ่อนพยาธิ' },
    'zoo-protozoal': { src: base('lecture-covers', 'zoonoses-zoo-protozoal'), alt: 'ปกสไลด์ Protozoal Zoonoses พื้นส้ม' },
  },
  'avian-medicine': {
