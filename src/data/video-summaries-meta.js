...
export const VIDEO_META = {
  ...
  'BnfVPW0S_lw': {
    ...
    "examFormat": "คาบนี้ไม่พูดถึงข้อสอบเลย คำว่า ข้อสอบ กลางภาค ปลายภาค คะแนน ควิซ ออกสอบ เก็บคะแนน และ มิดเทอม ปรากฏ 0 ครั้ง ส่วนคำว่า สอบ ที่มี 19 ครั้งเป็นคำอื่นทั้งหมด เช่น สอบสวน 14 ครั้ง สิ่งที่ใกล้เคียงที่สุดคือคำว่า ต้องจำ 1 ครั้งที่ [1:47] ซึ่งเป็นประโยคที่เธอบอกว่าไม่อยากให้ท่องจำ"
  },
  'DhtSsPLtFTo': {
    "videoId": "DhtSsPLtFTo",
    ...
    "durationMin": 150,
    "instructor": null,
    "examFormat": "คาบนี้ไม่พูดถึงข้อสอบของวิชาเลย สิ่งเดียวที่ผูกกับคะแนนคือคำถามท้ายคาบ 2 ข้อที่ให้เขียนส่ง ข้อ 1 จำนวนเคสโรคพิษสุนัขบ้าในสัตว์เฉลี่ยกี่ตัวต่อวันในปีนี้ ซึ่งเธอสั่งให้คำนวณเองจากจำนวนเคสหารด้วยจำนวนวัน [144:02] ข้อ 2 อุณหภูมิที่เหมาะสมในการเก็บวัคซีนชนิดฉีด [145:42] เฉลยและวิธีคิด"
  },
  'EeXx1XBh3O8': {
    "videoId": "EeXx1XBh3O8",
