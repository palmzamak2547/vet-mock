...
export const QB_COM3_SPECIAL = [
  ...
  { id: 1508, subject: 'com3', topic: 'special-prep', year: 4, source: 'COM III Final 2019',
    ...
    options: ['Plain film radiography', 'Abdominal ultrasonography', 'Computed tomography (CT)', 'Magnetic resonance imaging', 'ถูกทุกข้อเท่ากัน'],
    answer: 3,
  ...
  { id: 1514, subject: 'com3', topic: 'special-prep', year: 4, source: 'COM III Final 2019',
    ...
    options: [
      'Myelogram ที่ LS area หรือ MRI ของ spine',
      'Computed Tomography (Brain scan)',
      'Histopathology ของ disc material',
      'Plain film radiography (cervical, lumbar)',
      'Electromyography (EMG) ขาหลัง',
    ],
    answer: 0,
    explain: 'Acute T-L UMN paraplegia + DPP intact = suspect IVDD type II ใน GSD (non-chondrodystrophoid), MRI = gold standard, contrast radiography (myelogram) ที่ lumbosacral area = alternative ถ้าไม่มี MRI, plain film ดูได้แต่ disc compression ต้องใช้ contrast/MRI',
  ...
  { id: 1520, subject: 'com3', topic: 'special-prep', year: 4, source: 'COM III Final 2019',
    ...
    options: [
      'monthly heartworm prevention history',
      'being myotonic clonic seizure',
      'crackle lung sound with dyspnea',
      'snake bite wound at hindlimb',
  ...
  { id: 1533, subject: 'com3', topic: 'special-prep', year: 4, source: 'COM III Final 2019',
    ...
    options: ['Glucagon จากตับอ่อน', 'Thyroid hormone เพิ่มขึ้น', 'Inflammatory cytokines', 'Glucocorticoid จาก adrenal', 'Insulin ลดต่ำลง'],
    answer: 2,
  ...
  { id: 1536, subject: 'com3', topic: 'special-prep', year: 4, source: 'COM III Final 2019',
    ...
    options: ['Poikilocytosis (RBC ผิดรูป)', 'Pulseless (คลำชีพจรไม่ได้)', 'Paralysis (อัมพาตขาหลัง)', 'Pain (เจ็บปวดรุนแรง)', 'Pale (เยื่อเมือกซีด)'],
    answer: 0,
  ...
  { id: 1548, subject: 'com3', topic: 'special-prep', year: 4, source: 'COM III Final 2019',
    ...
    options: ['Plain film radiography', 'Ocular ultrasonography', 'Computed tomography (CT)', 'Magnetic resonance imaging', 'ถูกทุกข้อเท่ากัน'],
    answer: 3,
  ...
  { id: 1552, subject: 'com3', topic: 'special-prep', year: 4, source: 'COM III Final 2019',
    ...
    options: [
      ...
      'Coxofemoral Osteoarthritis (bilateral)',
      'Vertebral fracture จาก trauma',
      'Brain Tumors บริเวณ forebrain',
  ...
  { id: 1560, subject: 'com3', topic: 'special-prep', year: 4, source: 'COM III Final 2019',
    ...
    options: [
      ...
      'กดทับไขสันหลังส่วนปลาย → ปวดเอว-ก้นกบ + อัมพาตขาหลังและก้น',
      'กดทับเส้นประสาทนอกไขสันหลัง → ปวดขาหลังข้างเดียว',
      'กดทับไขสันหลังส่วนนอก จากเนื้องอก/เลือดออก',
      'กดทับสมองส่วนต้น → ปวดส่วนคอ + อัมพาตขาหน้า/หลัง',
    ],
    answer: 1,
    explain: 'Cauda equina = compression ของ nerve roots ที่ L7-S1-Cd (ปลาย spinal cord) จากความเสื่อม/กระแทก, LMN signs ขาหลัง + tail/anal/perineal + LS pain, GSD predisposed, DLSS = degenerative cause',
    verified: 'Spinal disorder 2 hr.pdf 2026 + DC3final 2019' },
  ...
  { id: 1562, subject: 'com3', topic: 'special-prep', year: 4, source: 'COM III Final 2019',
    ...
    options: [
      'Bulldog ควรนอนตะแคง + ใช้ Thoracic pump theory',
      'ท่านอนตะแคงเหมาะกับสุนัขและแมวส่วนใหญ่',
      'กดให้ลึกประมาณ 1/3 ของความหนา chest',
      'ความถี่การกด 100 ครั้งต่อนาที',
