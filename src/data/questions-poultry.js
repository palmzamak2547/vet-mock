...
export const QB_POULTRY = [
  ...
  { id: 4005, subject: 'poultry', topic: 'mahahon-poultry-biosec', year: 4,
    ...
    options: ['Salmonella, E. coli', 'Coccidia, parasites', 'IBD only', 'NDV + Influenza + Mycoplasma'],
    answer: 3,
  ...
  { id: 4020, subject: 'poultry', topic: 'mahahon-poultry-zoonosis', year: 4,
    ...
    options: ['ไก่: asymptomatic, คน: ไม่ติด', 'ไก่: chronic mild, คน: encephalitis only', 'ไก่: เฉพาะ leg paralysis, คน: GI only', 'ไก่: sudden death + diarrhea + cyanosis, คน: acute respi + flu-like signs'],
    answer: 3,
  ...
  { id: 4021, subject: 'poultry', topic: 'mahahon-poultry-zoonosis', year: 4,
    ...
    options: ['Yersiniosis mimics pseudo-appendicitis', 'Severe pneumonia', 'Severe encephalitis', 'Hemolytic anemia'],
    answer: 0,
  ...
  { id: 4029, subject: 'poultry', topic: 'mahahon-poultry-firstweek', year: 4,
    ...
    options: ['Vitamin D ขาด', 'Marek disease', 'Bacterial infection', 'Heat stress + ความชื้นต่ำในเครื่องฟัก (ระเหยน้ำมาก 55%) ส่งผลต่อ embryo development'],
    answer: 3,
  ...
  { id: 4030, subject: 'poultry', topic: 'mahahon-poultry-firstweek', year: 4,
    ...
    options: ['Brooding temperature ผิด (Too cold/Too hot) → ลูกไก่ไม่กิน + เครียด → vent pasting', 'การติดเชื้อ Salmonella เท่านั้น', 'การให้น้ำมากเกินไป', 'ฉีดวัคซีนผิดทาง'],
    answer: 0,
  ...
  { id: 4040, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    ...
    options: ['ละลายน้ำดีและถูกย่อยใน small intestine', 'ไม่มีประโยชน์เลย', 'เป็นแหล่งพลังงานหลักของไก่', 'กระตุ้นการทำงานของ gizzard + ทำให้ลำไส้เคลื่อนไหวดี + ลด bacterial attachment'],
    answer: 3,
  ...
  { id: 4044, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    ...
    options: ['High protein + low fiber', 'Same as broiler finisher', 'High calcium 4% เพื่อสร้างเปลือกไข่', 'Low energy + high fiber + coarse particles → ชะลอการเจริญ + กระตุ้นพัฒนาทางเดินอาหาร'],
    answer: 3,
  ...
  { id: 4045, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    ...
    options: ['ลดปริมาณ Sulfur-containing AAs (Methionine + Cystine) + ลด Linoleic acid 3% → 1% เมื่อใข่เริ่มสุดระยะ', 'จำกัดน้ำดื่ม', 'เพิ่มแสง 24 ชั่วโมง', 'เพิ่ม Calcium เป็น 6%'],
    answer: 0,
