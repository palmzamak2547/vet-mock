...
export const QB_POULTRY = [
  ...
  { id: 4001, subject: 'poultry', topic: 'mahahon-poultry-biosec', year: 4,
    source: 'Poultry Final TJ.pdf p3 (Nataya Biosecurity)', sourceType: 'student-compilation',
    tags: ['biosecurity', 'levels'], type: 'mcq',
    q: 'Biosecurity 3 levels คืออะไรตามลำดับ',
    options: [
      'Conceptual / Structural / Procedural',
      'Primary / Secondary / Tertiary',
      'Fence / Disinfect / Quarantine',
      'Pre / On / Post',
    ],
    answer: 0,
    explain: '3 levels of biosecurity: 1) Conceptual = ตำแหน่งฟาร์ม + design 2) Structural = building physical (fence, footbath, ระบบลม) 3) Procedural = SOP, daily practice',
    verified: 'TJ p3 + Lecture 2026' },

  { id: 4002, subject: 'poultry', topic: 'mahahon-poultry-biosec', year: 4,
    source: 'Poultry Final TJ.pdf p3', sourceType: 'student-compilation',
    tags: ['disease-equation'], type: 'mcq',
    q: 'สมการของ Disease ตามแนวทางอ.เกรียงวิทย์/อ.ณทยา คือ',
    options: ['Pathogen + Host', 'Virulence × Frequency × Dose', 'Susceptibility ÷ Immunity', 'Exposure + Time'],
    answer: 1,
  ...
  { id: 4011, subject: 'poultry', topic: 'mahahon-poultry-drugs', year: 4,
    source: 'Poultry Final TJ.pdf p5', sourceType: 'student-compilation',
    tags: ['piperazine', 'roundworm'], type: 'mcq',
    q: 'ยารักษาพยาธิตัวกลม (roundworm) แบบจำเพาะในไก่',
    options: ['Praziquantel', 'Piperazine', 'Ivermectin', 'Albendazole'],
    answer: 1,
  ...
  { id: 4012, subject: 'poultry', topic: 'mahahon-poultry-qa', year: 4,
    source: 'Poultry Final TJ.pdf p6 (QA)', sourceType: 'student-compilation',
    tags: ['QA-components'], type: 'mcq',
    q: 'องค์ประกอบหลักของ Quality Assurance (QA) มีกี่ส่วนและคืออะไร',
    options: [
      '3: QC, Audit, Accreditation',
      '5: QC + Audit + Accreditation + Assessment + Traceability',
      '7: รวม HACCP, GMP, ISO',
      '2: QC + QA',
    ],
    answer: 1,
    explain: 'QA 5 components: 1) Quality Control 2) Quality Audit 3) Quality Accreditation 4) Quality Assessment 5) Traceability ตรวจสอบย้อนกลับ',
    verified: 'TJ p6 #1' },

  { id: 4013, subject: 'poultry', topic: 'mahahon-poultry-qa', year: 4,
    source: 'Poultry Final TJ.pdf p6', sourceType: 'student-compilation',
    tags: ['PDCA', 'problem-solving'], type: 'mcq',
    q: 'PDCA ใน QA ย่อมาจากอะไรและใช้สำหรับอะไร',
    options: [
      'Process-Develop-Check-Approve · workflow design',
      'Plan-Do-Check-Action · Systematic Problem Solving (continuous improvement)',
      'Prevent-Detect-Correct-Audit · risk management',
      'Plan-Direct-Coordinate-Assess · project management',
    ],
    answer: 1,
  ...
  { id: 4031, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    source: 'TJ p1 + Master 86 p4-5 (Hatairat Plaimast L8)', sourceType: 'student-compilation',
    tags: ['amino-acid', 'limiting', 'methionine', 'lysine', 'threonine'], type: 'mcq',
    q: 'Most limiting amino acids (กรดอะมิโนจำกัดที่สุด) ในอาหารไก่คือกลุ่มใด',
    options: [
    ...
    verified: 'TJ p1 #1 + Master 86 p5' },

  { id: 4032, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    source: 'Master 86 p5 (Lysine ratio table)', sourceType: 'student-compilation',
    tags: ['lysine', 'ratio-100', 'AA-balance'], type: 'mcq',
    q: 'ใน Ideal amino acid profile ของไก่ ใช้กรดอะมิโนตัวใดเป็น reference (= 100)',
    options: ['Methionine', 'Threonine', 'Lysine', 'Tryptophan', 'Arginine'],
    answer: 2,
  ...
  { id: 4034, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    source: 'Master 86 p6 (Linoleic acid)', sourceType: 'student-compilation',
    tags: ['fat', 'essential-fatty-acid', 'linoleic'], type: 'mcq',
    q: 'Essential Fatty Acid (EFA) ที่จำเป็นต้องเสริมในอาหารไก่คือตัวใด',
    options: ['Oleic acid', 'Stearic acid', 'Linoleic acid', 'Palmitic acid'],
    answer: 2,
  ...
  { id: 4036, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    source: 'Master 86 p7 (Ca:P ratio)', sourceType: 'student-compilation',
    tags: ['calcium-phosphorus', 'ratio', 'broiler-layer'], type: 'mcq',
    q: 'Optimum Ca:Available P ratio ในไก่เนื้อ (Broiler) และไก่ไข่ (Layer)',
    options: [
      'Broiler 1:1, Layer 1:1',
      'Broiler 2:1, Layer 10:1',
      'Broiler 5:1, Layer 5:1',
      'Broiler 10:1, Layer 2:1',
    ],
    answer: 1,
  ...
  { id: 4037, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    source: 'Master 86 p7 (DEB)', sourceType: 'student-compilation',
    tags: ['DEB', 'electrolyte', 'sodium-potassium-chloride'], type: 'mcq',
    q: 'Dietary Electrolyte Balance (DEB) optimum ในอาหารไก่คือเท่าไร',
    options: ['100 mEq/kg', '150 mEq/kg', '250 mEq/kg', '500 mEq/kg', '1000 mEq/kg'],
    answer: 2,
  ...
  { id: 4042, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    source: 'TJ p2 #8 + Master 86 (Coarse calcium 2-4mm)', sourceType: 'student-compilation',
    tags: ['coarse-calcium', 'particle-size', 'eggshell'], type: 'mcq',
    q: 'Coarse calcium (หินเกล็ดสำหรับไก่ไข่) มีขนาดอนุภาคเท่าไรและสำคัญต่ออะไร',
    options: [
      '<1 mm · ดูดซึมเร็ว',
      '2-4 mm · สำคัญมากต่อคุณภาพเปลือกไข่',
      '10 mm · ใช้สำหรับไก่เนื้อ',
      '>20 mm · ใช้กรอกในกระเพาะ',
    ],
    answer: 1,
