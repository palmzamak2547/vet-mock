...
export const QB_POULTRY = [
  ...
  { id: 1902, subject: 'poultry', topic: 'first-week-mortality', year: 4,
    ...
    options: ['IgG (IgY) เป็นหลัก', 'IgA (น้ำลาย/น้ำตา) เป็นหลัก', 'IgM ในระยะ acute เท่านั้น', 'IgE และ IgD เป็นหลัก'],
    answer: 0,
  ...
  { id: 1903, subject: 'poultry', topic: 'first-week-mortality', year: 4,
    ...
    options: ['IgM (pentamer)', 'IgA (mucosal)', 'IgY (IgG)', 'IgD (membrane)'],
    answer: 2,
  ...
  { id: 1908, subject: 'poultry', topic: 'biosecurity', year: 4,
    ...
    options: [
      'หลอดเลือดที่ปาก (oral mucosa)',
      'หัวใจ, Right jugular vein, Brachial vein',
      'หลอดเลือดที่ขา (femoral) เท่านั้น',
      'หลอดเลือดใต้ลิ้น (sublingual)',
    ],
    answer: 1,
  ...
  { id: 1916, subject: 'poultry', topic: 'first-week-mortality', year: 4,
    ...
    options: ['E. coli (Colibacillosis) + Staphylococcus', 'Salmonella (Pullorum) + Mycoplasma', 'Marek\'s disease + IBD (Gumboro)', 'Newcastle + Avian influenza'],
    answer: 0,
  ...
  { id: 1918, subject: 'poultry', topic: 'avian-zoonosis', year: 4,
    ...
    options: [
      'Wild crow → คน CNS infection + encephalitis',
      'Parrot, Turkey, Pigeon → คน flu-like + pneumonia',
      'Chicken เท่านั้น → คน watery diarrhea',
      'Duck เท่านั้น → คน skin lesion',
    ],
    answer: 1,
  ...
  { id: 1919, subject: 'poultry', topic: 'avian-zoonosis', year: 4,
    ...
    options: ['Chicken เท่านั้น, "Bird flu"', 'Turkey, Duck, Goose → คนเรียก "Erysipeloid"', 'Pigeon เท่านั้น, "Pigeon lung"', 'Wild birds, "Bird fancier disease"'],
    answer: 1,
  ...
  { id: 1920, subject: 'poultry', topic: 'avian-zoonosis', year: 4,
    ...
    options: ['Chicken → คน diarrhea', 'Turkey → คน sudden death', 'Pigeon (ขี้นกพิราบ) → คน Lung/CNS', 'Wild crow → คน skin disease'],
    answer: 2,
  ...
  { id: 1921, subject: 'poultry', topic: 'avian-zoonosis', year: 4,
    ...
    options: ['Wild birds (Crow, Pigeon), ติดต่อผ่านยุง', 'Chicken, ไม่มี vector (direct contact)', 'Turkey, ติดต่อทางน้ำ', 'Duck, ติดต่อทางอาหาร'],
    answer: 0,
  ...
  { id: 1923, subject: 'poultry', topic: 'avian-zoonosis', year: 4,
    ...
    options: ['High fever + pneumonia', 'Severe watery diarrhea', 'Eye irritation + Conjunctivitis', 'Skin lesion + dermatitis'],
    answer: 2,
  ...
  { id: 1924, subject: 'poultry', topic: 'biosecurity', year: 4,
    ...
    options: [
      ...
      'Prevalence = ผู้ป่วย ณ จุดเวลาหนึ่ง, Incidence = ผู้ป่วยรายใหม่ในช่วงที่ศึกษา',
      'ทั้งสองค่าเหมือนกัน ใช้แทนกันได้เสมอ',
  ...
  { id: 1926, subject: 'poultry', topic: 'biosecurity', year: 4,
    ...
    options: ['ครั้งเดียว, ทันทีที่ป่วย', '3 ครั้ง, ทุกๆ 1 เดือน', '2 ครั้ง — ช่วงแรกที่ติดเชื้อ + ระยะพื้นตัว', 'ไม่ต้องตรวจซ้ำ, ตรวจ Ag pcr ดีกว่า'],
    answer: 2,
  ...
  { id: 1927, subject: 'poultry', topic: 'biosecurity', year: 4,
    ...
    options: ['Avian Influenza (AI)', 'Marek\\\'s disease', 'Newcastle disease', 'Salmonella'],
    answer: 3,
  ...
  { id: 1931, subject: 'poultry', topic: 'biosecurity', year: 4,
    ...
    options: [
      ...
      'ล้างรองเท้าก่อนจุ่ม, เปลี่ยนน้ำยาทุกวัน',
      'ใช้น้ำเปล่า ไม่ต้องผสมน้ำยาฆ่าเชื้อ',
      'จุ่มแค่ 30 วินาทีก็เพียงพอ',
    ],
    answer: 1,
  ...
  { id: 1933, subject: 'poultry', topic: 'biosecurity', year: 4,
    ...
    options: ['Salmonella + E. coli + Pasteurella', 'IBD (Gumboro) + CAV + Reovirus', 'Newcastle disease + Avian influenza + Mycoplasma', 'Coccidia + helminth + Cryptosporidium'],
    answer: 2,
  ...
  { id: 1938, subject: 'poultry', topic: 'first-week-mortality', year: 4,
    ...
    options: ['ช่วง MDA ลดต่ำกว่า protective level', 'ช่วงที่ไก่กินอาหารมากที่สุดในวัน', 'ช่วงที่ลูกไก่เพิ่งออกจากตู้ฟัก', 'ช่วงที่ไก่โตเต็มที่พร้อมส่งโรงเชือด'],
    answer: 0,
  ...
  { id: 1941, subject: 'poultry', topic: 'quality-assurance', year: 4,
    ...
    options: ['ไม่พบ E. coli, ไม่พบ Salmonella, Total bacteria <1000 cfu/ml', 'อนุญาตให้มี Salmonella ได้ <500 cfu/ml ในน้ำดิบ', 'อนุญาตให้มี E. coli ได้ <100 cfu/ml ในน้ำดื่ม', 'ไม่ต้องตรวจน้ำ ใช้น้ำประปาได้เลย'],
    answer: 0,
  ...
  { id: 1945, subject: 'poultry', topic: 'avian-drugs', year: 4,
    ...
    options: ['Penicillin + Cephalosporin (β-lactam)', 'Tylosin, Lincomycin-Spectinomycin', 'Sulfonamide + Trimethoprim เท่านั้น', 'Vancomycin + Bacitracin'],
    answer: 1,
  ...
  { id: 1948, subject: 'poultry', topic: 'avian-drugs', year: 4,
    ...
    options: ['Neomycin, Colistin, Streptomycin, Gentamicin, Bacitracin', 'Enrofloxacin, Tylosin, Amoxicillin (ดูดซึมดี)', 'Sulfonamide + Trimethoprim เท่านั้น', 'ทุกตัวต้องมี withdrawal time เสมอ'],
    answer: 0,
  ...
  { id: 1950, subject: 'poultry', topic: 'avian-drugs', year: 4,
    ...
    options: ['Ivermectin (parasitic — limited oral abs.)', 'Levamisole + Piperazine', 'Praziquantel เท่านั้น', 'Benzimidazole'],
    answer: 3,
  ...
  { id: 1953, subject: 'poultry', topic: 'quality-assurance', year: 4,
    ...
    options: ['Quality control, Audit, Accreditation, Traceability (= 5 ด้านของ QA)', 'Food quality + Food safety, Service excellence', 'Production, Distribution, Marketing, Sales', 'Cost, Speed, Volume, Service'],
    answer: 1,
    explain: 'BQM 4 มิติ (ฉบับ Betagro ขยายจาก 3 มิติ): (1) Food quality + Food safety, (2) Service excellence, (3) Animal welfare (Five Freedoms), (4) Corporate responsibility (CSR + environment + community), ใช้ "BQM 24/7" — คุณภาพ 24 ชม. × 7 วัน ตลอด\n\n💡 Animal welfare, Corporate responsibility' },
  ...
  { id: 1955, subject: 'poultry', topic: 'quality-assurance', year: 4,
    ...
    options: ['น้อยกว่า 30', '30-50 เท่านั้น', '60-65 ขึ้นไป', 'มากกว่า 100'],
    answer: 2,
  ...
  { id: 1958, subject: 'poultry', topic: 'avian-zoonosis', year: 4,
    ...
    options: [
      ...
      'ปนเปื้อนในน้ำใต้ดิน + ดิน + อาหารที่มี M. avium',
      'แพร่ผ่านยุงดูดเลือด (mosquito)',
      'แพร่ผ่านการสัมผัสเปลือกไข่ที่ปนเปื้อน',
    ],
    answer: 1,
  ...
  { id: 4010, subject: 'poultry', topic: 'mahahon-poultry-drugs', year: 4,
    ...
    options: [
      ...
      'Ionophore coccidiostats เท่านั้น',
  ...
  { id: 4014, subject: 'poultry', topic: 'mahahon-poultry-qa', year: 4,
    ...
    options: [
      ...
      'E. coli (APEC) + Mycobacterium avium',
  ...
  { id: 4023, subject: 'poultry', topic: 'mahahon-poultry-firstweek', year: 4,
    ...
    options: [
      ...
      'Leghorn, Plymouth Rock, Rhode Island',
      'Khaki Campbell, Pekin (เป็ด)',
    ],
    answer: 1,
  ...
  { id: 4035, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    ...
    options: [
      ...
      '90%, ไก่ดูดซึมได้ดีโดยไม่ต้องเสริม',
      '10%, ไม่มีผลต่อโภชนาการของไก่',
    ],
    answer: 1,
  ...
  { id: 4040, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    ...
    options: ['ละลายน้ำดีและถูกย่อยใน small intestine', 'ไม่มีประโยชน์ใดเลยต่อไก่', 'เป็นแหล่งพลังงานหลักของไก่', 'กระตุ้น gizzard + ลด bacterial attachment'],
    answer: 3,
  ...
  { id: 4041, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    ...
    options: ['80:20', '20:80', '40:60', '35:65', '50:50'],
    answer: 4,
  ...
  { id: 4043, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    ...
    options: ['2 ระยะ, Protein คงที่ตลอด', '5 ระยะ, Protein เพิ่มตามอายุ', '3 ระยะ (Starter/Grower/Finisher)', '1 ระยะ, ไม่ต้องเปลี่ยน'],
    answer: 2,
  ...
  { id: 4044, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    ...
    options: ['High protein + low fiber + high energy', 'เหมือน broiler finisher ทุกประการ', 'High calcium 4% เพื่อสร้างเปลือกไข่', 'Low energy + high fiber + coarse particles'],
    answer: 3,
  ...
  { id: 4045, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    ...
    options: ['ลด Met+Cys + ลด Linoleic acid', 'จำกัดปริมาณน้ำดื่ม', 'เพิ่มแสงเป็น 24 ชั่วโมง', 'เพิ่ม Calcium เป็น 6%'],
    answer: 0,
  ...
  { id: 4048, subject: 'poultry', topic: 'mahahon-poultry-drugs', year: 4,
    ...
    options: ['E. tenella = cecum, E. necatrix = jejunum, E. acervulina = duodenum', 'E. tenella = duodenum, E. acervulina = cecum, E. necatrix = jejunum', 'ทุกสายพันธุ์อยู่ที่ duodenum เหมือนกัน', 'E. tenella = jejunum, E. necatrix = cecum'],
    answer: 0,
  ...
  { id: 4054, subject: 'poultry', topic: 'mahahon-poultry-qa', year: 4,
    ...
    options: [
      ...
      'ใช้ใบมีดร้อนตัดที่ฟาร์มเอง',
      'ใช้ Infrared ตัดที่โรงฟัก (Hatchery)',
      'ห้ามตัดปากในทุกกรณีโดยเด็ดขาด',
    ],
    answer: 2,
  ...
  { id: 4059, subject: 'poultry', topic: 'mahahon-poultry-zoonosis', year: 4,
    ...
    options: ['วัคซีน 1 เข็มเท่านั้น, อาการ = neuro signs, เสี่ยงสูง = chicken broiler', 'ฉีดวัคซีนซ้ำทุกสัปดาห์ตลอดชีวิต', 'ไม่มีวัคซีน, ต้องใช้ antibiotic ตลอดชีวิต', 'วัคซีน 2 เข็ม ห่าง 2-4 wk, อาการ = sudden death, เสี่ยง = Turkey'],
    answer: 3,
