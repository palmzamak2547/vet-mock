...
export const QB_POULTRY = [
  ...
  { id: 4029, subject: 'poultry', topic: 'mahahon-poultry-firstweek', year: 4,
    ...
    options: ['Vitamin D ขาด', 'Marek disease', 'Bacterial infection', 'Heat stress + ความชื้นต่ำ'],
    answer: 3,
  ...
  { id: 4045, subject: 'poultry', topic: 'mahahon-poultry-nutrition', year: 4,
    ...
    options: ['ลด Met+Cys + ลด Linoleic acid', 'จำกัดน้ำดื่ม', 'เพิ่มแสง 24 ชั่วโมง', 'เพิ่ม Calcium เป็น 6%'],
    answer: 0,
