...
export const QUESTIONS_Y5_ONE_HEALTH_2026_B = [
  ...
  },
  {
    ...
    "answer": 3,
    "explain": "Cross resistance คือกลไกเดียวทำให้ดื้อยาหลายชนิดแม้คนละกลุ่ม ตัวอย่างเช่น efflux pump ตัวเดียวที่ปั๊มยาได้หลายชนิดออกจากเซลล์ ตัวเลือกแรกคือ co-selection ซึ่งเป็นคนละกลไก คือยีนหลายตัวติดมาด้วยกันบนพลาสมิดวงเดียว ส่วนการกลายพันธุ์แล้วส่งต่อให้ลูกหลานคือ vertical transfer และเอนไซม์ที่ทำลายยาชนิดเดียวไม่ทำให้เกิดการดื้อข้ามยา",
    "verified": "OneHealth final น.4",
    "sourceType": "lecture-derived",
    "examOrigin": "เรียบเรียงจากเอกสารสรุป One Health final ของรุ่นก่อนหน้า"
  },
