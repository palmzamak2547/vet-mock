...
export const QB_PRACTRUM = [
  ...
  { id: 3006, subject: 'practrum', topic: 'bovine-anesthesia', year: 4,
    ...
    options: ['L6-S1', 'L7-S1', 'L8-S1', 'S3-C1', 'S5-C1 (1st intercoccygeal space)'],
    answer: 4,
    explain: 'Caudal epidural ในวัว = S5-C1 (sacrococcygeal joint) หรือ Co1-Co2 (1st intercoccygeal space) · คลำหา TP เคลื่อนไหวเมื่อยกหาง · block tail + perineum + posterior vagina · ปริมาณยา 5-7 ml lidocaine 2%',
    verified: 'TJ p4 highlighted E' },
  ...
  { id: 3008, subject: 'practrum', topic: 'rumenotomy', year: 4,
    ...
    answer: 3,
    explain: 'Propofol = IV induction agent สำหรับสัตว์เล็ก · ในวัวต้อง IV access ใหญ่ + เสี่ยง regurgitation + bloat · standing rumenotomy ใช้ local (lidocaine) + sedation (xylazine) + post-op analgesia (flunixin) + antibiotic (procaine penicillin)',
  ...
  { id: 3016, subject: 'practrum', topic: 'animal-nutrition', year: 4,
    ...
    q: 'R:C ratio (Roughage : Concentrate) ของวัวรีดนม high-yield ควรอยู่ประมาณ',
    options: ['80:20', '60:40', '50:50', '40:60', '20:80'],
    answer: 3,
    explain: 'High-producing dairy cows ต้อง concentrate มาก (energy-dense) เพื่อ milk yield · R:C ~40:60 หรือ 50:50 · แต่ห้ามให้ concentrate เกิน 60% → SARA (subacute ruminal acidosis) · roughage ต้องมี physically effective fiber พอ',
    verified: '(Final) p2 — Feed mgt' },
  ...
  { id: 3027, subject: 'practrum', topic: 'penile-deviation', year: 4,
    ...
    options: [
      'Apical ligament reinforcement (suture fascia lata graft)',
      'Castration เท่านั้น',
      'Antibiotic อย่างเดียว',
      'ไม่ต้องรักษา',
    ],
    answer: 0,
    explain: 'Apical ligament reinforcement: ใช้ fascia lata หรือ Lyodura strip suture เสริม dorsal ligament · Success rate 60-80% · post-op rest 60 วัน ก่อนใช้ผสม · เหมาะกับ valuable bull · ถ้าไม่คุ้มมูลค่า → cull',
