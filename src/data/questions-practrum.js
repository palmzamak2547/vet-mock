...
export const QB_PRACTRUM = [
  ...
  { id: 2001, subject: 'practrum', topic: 'bovine-anesthesia', year: 4,
    ...
    options: ['Beta-2 agonism ที่หลอดลม', 'Vasoconstriction + bradycardia + diuresis', 'Histamine release', 'Ganglionic blockade'],
    answer: 1,
  ...
  { id: 3033, subject: 'practrum', topic: 'mahahon-practrum-dystocia', year: 4,
    ...
    options: [
      ...
      'Convert เป็น hock flexion ก่อน แล้วดึงขาหลังออก',
      'C-section ทันที',
      'รอให้คลอดเอง',
    ],
    answer: 1,
  ...
  { id: 3046, subject: 'practrum', topic: 'mahahon-practrum-feed', year: 4,
    ...
    options: [
      ...
      'Binder + ลดฝุ่น + แหล่ง energy (CP 1-3%)',
      'แหล่ง vitamin (CP 50%)',
      'แทนน้ำได้ทั้งหมด',
    ],
    answer: 1,
  ...
  { id: 3052, subject: 'practrum', topic: 'mahahon-practrum-silage', year: 4,
    ...
    options: [
      'ลด pH ภายในให้ bacteria กลุ่มอื่นตาย และ preserve สารอาหาร',
      'เพิ่ม pH ให้ alkaline',
  ...
  { id: 3060, subject: 'practrum', topic: 'mahahon-practrum-surgery', year: 4,
    ...
    options: [
      'ยา 5 cc / เข็ม 21G / 1"',
      'ยา 20 cc / เข็ม 18G หรือ spinal 20-18G / 3.5"',
      'ยา 50 cc / เข็ม 14G / 6"',
  ...
  { id: 3061, subject: 'practrum', topic: 'mahahon-practrum-surgery', year: 4,
    ...
    options: [
      '0.05 mg/kg, max 2 cc',
      '0.22 mg/kg, max 6 cc (ปริมาณเริ่มต้น 2.5 cc)',
      '1 mg/kg, max 20 cc',
      '2 mg/kg, max 50 cc',
    ],
    answer: 1,
  ...
  { id: 3068, subject: 'practrum', topic: 'mahahon-practrum-surgery', year: 4,
    ...
    options: [
      'วัวที่จะส่งโรงฆ่า',
      'พ่อแม่พันธุ์ (breeding stock) เพื่อความสวยและเพิ่มมูลค่าทางพันธุกรรม',
      'ลูกวัวที่อายุน้อยกว่า 1 เดือน',
      'วัวที่มีโรคติดเชื้อ',
    ],
    answer: 1,
