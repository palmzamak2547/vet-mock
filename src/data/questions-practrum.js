...
export const QB_PRACTRUM = [
  ...
  { id: 2025, subject: 'practrum', topic: 'animal-nutrition', year: 4,
    ...
    q: 'Roughage : Concentrate ratio (R:C) ที่เหมาะสมสำหรับ lactating dairy cow คือข้อใด',
    options: ['100:0 (roughage เท่านั้น)', '60:40 to 50:50 (early lactation high producers สามารถ 40:60)', '20:80 (concentrate dominant ถาวร)', '0:100 (concentrate เท่านั้น)'],
    answer: 1,
    explain: 'R:C ratio ปกติสำหรับวัวนม:\n• **General**: 60:40 (forage : concentrate)\n• **Early lactation high producer**: อาจถึง 40:60 ชั่วคราว\n• **Late lactation/dry cow**: 70:30 หรือ 80:20\n\n⚠️ ลดลงต่ำกว่า 40:60 เสี่ยง:\n• Subacute rumen acidosis (SARA)\n• Laminitis\n• Displaced abomasum (LDA/RDA)\n• Milk fat depression\n\n💡 Effective NDF ขั้นต่ำ ~21% ของ DM',
