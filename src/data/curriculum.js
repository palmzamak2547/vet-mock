...
export const SUBJECTS_BY_YEAR = {
  ...
  5: [
    ...
    { id: 'epidemiology', code: '3107508', name: 'ระบาดวิทยา',
      ...
      topics: [
        { id: 'epidem-intro', label: 'Intro to Vet Epidemiology', icon: '📖', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'epidem-basic-concepts', label: 'Basic concepts of epidemiology', icon: '🧠', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'epidem-disease-transmission', label: 'Concept of disease transmission', icon: '🌐', lecturer: 'Saharuetai Jeamsripong', lecturer_year: 2026 },
        { id: 'epidem-causation', label: 'Causation', icon: '🔗', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'epidem-disease-frequency', label: 'Disease frequency', icon: '📊', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'epidem-outbreak-investigation', label: 'Outbreak investigation', icon: '🔍', lecturer: 'Saharuetai Jeamsripong', lecturer_year: 2026 },
        { id: 'epidem-dx-screening', label: 'Diagnosis & screening', icon: '🩺', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'epidem-observational-study', label: 'Observational study', icon: '👀', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'epidem-surveillance', label: 'Animal disease surveillance & monitoring', icon: '📡', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'epidem-control-prevention', label: 'Control / Prevention / Eradication', icon: '🛡', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'epidem-applied-stats', label: 'Applied statistics in epidemiology (Part 1-2)', icon: '📐', lecturer: 'Vachira Hunprasit', lecturer_year: 2026 },
        { id: 'epidem-ppp', label: 'Public-Private Partnership (PPP)', icon: '🤝', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'epidem-govt-policy', label: 'Government policy + control programs', icon: '🏛', lecturer: 'DLD guest', lecturer_year: 2026, lecturerNote: 'รวม พรบ.โรคระบาด 2558' },
        { id: 'epidem-asf', label: 'ASF', icon: '🐖', lecturer: 'DLD guest', lecturer_year: 2026 },
        { id: 'epidem-fmd-strategy', label: 'FMD strategy', icon: '🦠', lecturer: 'DLD guest', lecturer_year: 2026 },
        { id: 'epidem-lumpy-skin', label: 'Lumpy Skin Disease action plan', icon: '🐄', lecturer: 'DLD guest', lecturer_year: 2026 },
        { id: 'epidem-big-data', label: 'Big Data', icon: '💾', lecturer: 'TBD', lecturer_year: 2026 },
      ] },
    ...
    { id: 'avian-medicine', code: '3107507', name: 'อายุรศาสตร์สัตว์ปีก',
      ...
      topics: [
        { id: 'avian-intro', label: 'Intro to Avian Medicine', icon: '📖', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-ai', label: 'Avian Influenza (ไข้หวัดนก)', icon: '🦠', lecturer: 'Jiroj Sasipreeyajan', lecturer_year: 2026 },
        { id: 'avian-nd', label: 'Newcastle Disease', icon: '🐔', lecturer: 'Somsak Pakpinyo', lecturer_year: 2026 },
        { id: 'avian-mpv', label: 'Avian Metapneumovirus', icon: '🦠', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-ae', label: 'Avian Encephalomyelitis', icon: '🧠', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-coli', label: 'Colibacillosis', icon: '🦠', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-myco', label: 'Mycoplasmosis', icon: '🦠', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-fowl-cholera', label: 'Fowl cholera', icon: '🐔', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-nds', label: 'New Duck Syndrome', icon: '🦆', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-coryza', label: 'Infectious Coryza', icon: '🤧', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-ahra-set', label: 'AHRA set — Adeno / Salmonella / Omphalitis / Ascites / Staph', icon: '🏥', lecturer: 'Kriengwich Limpavithayakul (AHRA)', lecturer_year: 2026, lecturerNote: 'Guest จาก Shine-Chic · ข้อสอบเก่า Vet 84 มี set นี้' },
        { id: 'avian-ib', label: 'Infectious Bronchitis', icon: '🫁', lecturer: 'Nataya Charoenvisal', lecturer_year: 2026 },
        { id: 'avian-duck-plague', label: 'Duck Plague (DP)', icon: '🦆', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-dvh', label: 'Duck Viral Hepatitis', icon: '🦆', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-goose-parvo', label: 'Goose Parvovirus', icon: '🦢', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-duck-flavi', label: 'Duck flavivirus', icon: '🦠', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-mycosis', label: 'Mycosis + Mycotoxicosis', icon: '🍄', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-ort', label: 'ORT (Ornithobacterium rhinotracheale)', icon: '🦠', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-campy', label: 'Campylobacter', icon: '🦠', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-lt', label: 'Laryngotracheitis (LT/LM)', icon: '🫁', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-histomoniasis', label: 'Histomoniasis', icon: '🦃', lecturer: 'TBD', lecturer_year: 2026 },
        { id: 'avian-vaccine-prog', label: 'Vaccine programs + Hatchery vaccinations', icon: '💉', lecturer: 'TBD', lecturer_year: 2026 },
    ...
    { id: 'milk-meat-hygiene', code: '3107518', name: 'สุขศาสตร์น้ำนม + เนื้อ',
      ...
      topics: [
        ...
        { id: 'milk-quality-determination', label: 'Determination of milk quality', icon: '🔬', lecturer: 'TBD', lecturer_year: 2026 },
    ...
    { id: 'one-health', code: '3107529', name: 'One Health',
      ...
      topics: [
        ...
        { id: 'oh-vet-role', label: 'Role of vet in One Health', icon: '🩺', lecturer: 'Saharuetai Jeamsripong', lecturer_year: 2026 },
        { id: 'oh-global-network', label: 'Global OH activity network', icon: '🌍', lecturer: 'Saharuetai Jeamsripong', lecturer_year: 2026 },
        { id: 'oh-collaboration', label: 'Collaboration & partnership', icon: '🤝', lecturer: 'Sirawit Pagdepanichkit', lecturer_year: 2026 },
        { id: 'oh-communication', label: 'OH communication', icon: '💬', lecturer: 'Sirawit Pagdepanichkit', lecturer_year: 2026 },
        { id: 'oh-disease-prevention', label: 'OH for disease prevention/control', icon: '🛡', lecturer: 'Kamonpan Charoenkul', lecturer_year: 2026 },
        { id: 'oh-integrating-epi', label: 'Integrating OH into epidemiology', icon: '🔗', lecturer: 'Saharuetai Jeamsripong', lecturer_year: 2026 },
        { id: 'oh-foodborne', label: 'OH foodborne diseases', icon: '🍽', lecturer: 'Taradon Luangtongkum', lecturer_year: 2026 },
        { id: 'oh-livestock-waste', label: 'OH livestock waste management', icon: '🚜', lecturer: 'Sirawit Pagdepanichkit', lecturer_year: 2026 },
        { id: 'oh-env-carcinogen', label: 'Environmental health risks I — carcinogens', icon: '☠️', lecturer: 'Saharuetai Jeamsripong', lecturer_year: 2026 },
        { id: 'oh-env-mutagen', label: 'Environmental health risks II — mutagens & GMO', icon: '🧬', lecturer: 'Saharuetai Jeamsripong', lecturer_year: 2026 },
        { id: 'oh-elephant', label: 'Elephant (handout not distributed)', icon: '🐘', lecturer: 'TBD', lecturer_year: 2026, hidden: true },
        { id: 'oh-amr', label: 'Antimicrobial Resistance (AMR)', icon: '💊', lecturer: 'Rungtip Chuanchuen', lecturer_year: 2026 },
