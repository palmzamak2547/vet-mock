    ...
    { id: 'com4', code: '3107416', name: 'COM IV', name_en: 'C ANI CLI SCI IV · Companion Animal',
      ...
      topics: [
        ...
        { id: 'immune-drugs',   label: 'คาบ 15 · Drugs for Immune-mediated', icon: '💊',
          ...
          lecturerNote: 'Glucocorticoid, Cyclosporine, Azathioprine (dog only), MMF, Chlorambucil (cat), IVIG' },
        { id: 'imha',           label: 'คาบ 16 · IMHA + ITP', icon: '🩸',
          lecturer: 'Rosama Pusoonthornthum (RP)', lecturer_year: 2026, schedule: '5 มี.ค. · คาบ 16',
          lecturerNote: 'Spherocytes · Autoagglutination · Coombs test · pred 2-3 mg/kg/d' },
        { id: 'ibd',            label: 'คาบ 17 · IBD + GN (Inflammatory disease)', icon: '🌀',
          ...
          lecturerNote: 'Chronic enteropathy · LPE/EE · histopath gold standard · step-wise diet→ATB→steroid' },
        { id: 'sle',            label: 'คาบ 18 · SLE (Systemic Lupus Erythematosus)', icon: '🦋',
          ...
          lecturerNote: '≥ 2 organ + ANA · polyarthritis #1 sign · non-erosive' },
        ...
        { id: 'derm-parasitic', label: 'คาบ 20 · Parasitic Skin Diseases', icon: '🪲',
          ...
          lecturerNote: 'Demodex, Sarcoptes, Cheyletiella, Notoedres, Otodectes · ticks/fleas + FAD' },
        { id: 'derm-bacterial', label: 'คาบ 21 · Bacterial Skin Diseases', icon: '🦠',
          ...
          lecturerNote: 'Pyoderma surface/superficial/deep · S. pseudintermedius · MRSP' },
        { id: 'derm-fungal',    label: 'คาบ 22 · Fungal Skin Diseases', icon: '🍄',
          ...
          lecturerNote: 'Dermatophytosis (M. canis, M. gypseum, T. mentag) · Malassezia · DTM' },
        { id: 'derm-endocrine', label: 'คาบ 23 · Endocrine Skin Diseases', icon: '⚖️',
          ...
          lecturerNote: 'Hypothyroidism · HAC (Cushing\'s) · Alopecia X · Sex hormone alopecia' },
        { id: 'derm-nutrition', label: 'คาบ 24 · Nutritional Skin Diseases', icon: '🥗',
          ...
          lecturerNote: 'Zinc-responsive (Husky/Mal) · Vit A (Cocker) · EFA · generic food dz' },
        { id: 'derm-allergic',  label: 'คาบ 25 · Allergic Dermatitis', icon: '🤧',
          ...
          lecturerNote: 'CAD (atopic) · FAD · food allergy · Favrot · TRIP · cyclo/oclacitinib/lokivetmab' },
        { id: 'derm-autoimmune', label: 'คาบ 26 · Autoimmune Skin Diseases', icon: '🛡',
          ...
          lecturerNote: 'Pemphigus complex (Dsg1/Dsg3) · Bullous pemphigoid · DLE/SLE skin' },
        ...
        { id: 'peds-geri',      label: 'คาบ 27-28 · Pediatrics & Geriatrics', icon: '👶',
          ...
          lecturerNote: 'Neonatal 4Hs · NEI (cat type B) · fading puppy · DISHAA cognitive · q6mo geriatric screen' },
      ] },
