  ...
  5: [
    ...
    { id: 'epidemiology', code: '3107508', name: 'ระบาดวิทยา',
      ...
      topics: [
        ...
        { id: 'epidem-disease-transmission', label: 'Concept of disease transmission', icon: '🌐', lecturer: 'ฐูนิชา ชาญชัยเดชาชัย (TC)', lecturer_year: 2026, lecturerNote: 'ตารางบรรยาย 2569 (3 ส.ค. ภาคบ่าย) — ไม่ใช่ อ.สหฤทัย อย่างที่สรุปรุ่นก่อนระบุ' },
        { id: 'epidem-causation', label: 'Concept of Causal Association', icon: '🔗', lecturer: 'ฐูนิชา ชาญชัยเดชาชัย (TC)', lecturer_year: 2026 },
        ...
        { id: 'epidem-sample-size', label: 'Sample size determination', icon: '🔢', lecturer: 'ฐูนิชา ชาญชัยเดชาชัย (TC)', lecturer_year: 2026 },
        ...
        { id: 'epidem-applied-stats', label: 'Applied statistic for Epidemiology', icon: '📐', lecturer: 'ฐูนิชา ชาญชัยเดชาชัย (TC)', lecturer_year: 2026, lecturerNote: 'ตารางบรรยาย 2569 (7 ก.ย.) — ไม่ใช่ อ.วชิรา อย่างที่สรุปรุ่นก่อนระบุ' },
        { id: 'epidem-data-analysis', label: 'Epidemiology data analysis', icon: '📈', lecturer: 'ฐูนิชา ชาญชัยเดชาชัย (TC)', lecturer_year: 2026 },
        ...
        { id: 'epidem-eid-pandemic', label: 'Emerging Infectious Diseases & Pandemic Preparedness', icon: '🌍', lecturer: 'ฐูนิชา ชาญชัยเดชาชัย (TC)', lecturer_year: 2026, lecturerNote: 'ตารางกำกับว่า สอนแต่ไม่ออกข้อสอบ' },
        { id: 'epidem-economics', label: 'Economics and Decision Tools for Vet Epidemiology', icon: '💰', lecturer: 'ฐูนิชา ชาญชัยเดชาชัย (TC)', lecturer_year: 2026, lecturerNote: 'ตารางกำกับว่า สอนแต่ไม่ออกข้อสอบ' },
    ...
    { id: 'food-industry', code: '3109501', name: 'อุตสาหกรรมอาหาร (FIQC)',
      ...
      topics: [
        ...
        { id: 'fiqc-haccp', label: 'HACCP for livestock', icon: '✅', lecturer: 'Sompis Junlaboothdi', lecturer_year: 2026 },
        { id: 'fiqc-poultry-export', label: 'Poultry standard for export', icon: '🐔', lecturer: 'Sompis Junlaboothdi', lecturer_year: 2026 },
    ...
    { id: 'rec-adv-bioscience', code: '3100-508', name: 'Recent Advances in Vet Biosciences',
      ...
      topics: [
        ...
        { id: 'ravb-proteomics', label: 'Applied Proteomics in Vet Sci', icon: '🧬', lecturer: 'Kannaporn Suriyaphol', lecturer_year: 2026 },
