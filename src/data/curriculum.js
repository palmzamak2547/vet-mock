...
export const SUBJECTS_BY_YEAR = {
  4: [
    ...
    { id: 'com3', code: '3106416', name: 'COM III', name_en: 'C ANI CLI SCI III · Companion Animal',
      icon: '🚨', color: '#c26d6d', semester: 2, has_questions: true,
      topics: [
        { id: 'neuro-exam',    label: 'Neuro Exam + Localization', icon: '🔍',
          lecturer: 'Krissda Boonaramrueng', lecturer_year: 2026,
          lecturerNote: 'ปี 2024 (sunsun84) Aj. Krissda สอนเหมือนกัน — เนื้อหาเทียบกันได้' },
        { id: 'ataxia-tremor', label: 'Ataxia, Tremor, Vestibular', icon: '🌀',
          lecturer: 'Krissda Boonaramrueng', lecturer_year: 2026,
          lecturerNote: 'ปี 2024 (sunsun84) Aj. Krissda สอนเหมือนกัน' },
        { id: 'seizure',       label: 'Seizure & Narcolepsy', icon: '⚡',
          lecturer: 'Krissda Boonaramrueng', lecturer_year: 2026,
          lecturerNote: 'IVETF + ACVIM consensus 2015 — เนื้อหาน่าจะใกล้เคียง' },
        { id: 'spinal',        label: 'Spinal Disorder & Injuries', icon: '🦴',
          lecturer: 'Kumpanart Soontornvipart', lecturer_year: 2026,
          lecturerNote: 'Surgery + neuro overlap — Aj. Kumpanart สอน 2 ชม.' },
        { id: 'neuro-er',      label: 'Neuro Emergency', icon: '🧠',
          lecturer: 'Krissda Boonaramrueng', lecturer_year: 2026 },
        { id: 'triage',        label: 'Triage', icon: '🚦',
          lecturer: 'Chutirat Torsahakul', lecturer_year: 2026,
          lecturerNote: 'ปี 2024 Aj. Chutirat สอน emergency series ทั้งหมด — เนื้อหาเทียบกันได้' },
        { id: 'shock',         label: 'SHOCK', icon: '⚠️',
          lecturer: 'Chutirat Torsahakul', lecturer_year: 2026 },
        { id: 'cpcr',          label: 'CPCR (RECOVER)', icon: '❤️',
          lecturer: 'Chutirat Torsahakul', lecturer_year: 2026 },
        { id: 'acute-abdomen', label: 'Acute Abdomen', icon: '🩺',
          lecturer: 'Chutirat Torsahakul', lecturer_year: 2026 },
        { id: 'resp-cv-er',    label: 'Respiratory & CV Emergency', icon: '🫁',
          lecturer: 'Chutirat Torsahakul', lecturer_year: 2026 },
        { id: 'metabolic-er',  label: 'Metabolic / Endocrine / UT Emergency', icon: '💊',
          lecturer: 'Chutirat Torsahakul', lecturer_year: 2026 },
        { id: 'nutrition',     label: 'Nutrition in Critical Illness', icon: '🥣',
          lecturer: 'Chutirat Torsahakul', lecturer_year: 2026 },
        { id: 'er-anes',       label: 'Emergency Anesthesia', icon: '😴',
          lecturer: 'Sumit Durongphongtorn', lecturer_year: 2026 },
      ] },
