...
export const CHANGELOG = [
  {
    ...
    changes: [
      { scope: 'system', kind: 'feature', icon: '📚', title: 'คลังเอกสารการเรียน',
        desc: 'รวมเอกสาร สไลด์ สรุป และตำราไว้ที่เดียว ค้นหาด้วยชื่อ วิชา หรือหัวข้อ กรองตามชนิดเอกสารและชั้นปี เปิดอ่านในแอปได้ทันทีพร้อมปากกาและยางลบ — รอยเขียนของแต่ละเล่มจะกลับมาเหมือนเดิมทุกครั้งที่เปิดใหม่ เอกสารที่เตรียมมาแบบ fast web view จะขึ้นหน้าแรกได้เลยโดยไม่ต้องรอโหลดทั้งไฟล์',
      },
    ],
  },
  {
