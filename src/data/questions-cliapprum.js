...
export const QB_CLIAPPRUM = [
  ...
  { id: 2100, subject: 'cliapprum', topic: 'metabolism-nutrition', year: 4,
    ...
    options: ['BUN concentration และ urine pH เท่านั้น',
              'Negative Energy Balance + metabolic profile',
              'Heart rate, BP และ CRT เท่านั้น',
              'Coat color และ tail length score'],
    answer: 1,
  ...
  { id: 2101, subject: 'cliapprum', topic: 'metabolism-nutrition', year: 4,
    ...
    options: ['น้ำหนักอาหารที่กิน (as fed) × %ความชื้น ÷ 100 = ปริมาณน้ำในอาหาร',
              'น้ำหนักอาหารที่กิน (as fed) × %Dry Matter ÷ 100 = ปริมาณ DM ที่กินจริง',
              'น้ำหนักอาหารที่กิน (as fed) ÷ น้ำหนักตัว × 100 = สัดส่วนต่อ BW',
              'CP × NDF ÷ ADF = ค่าดัชนีคุณภาพอาหารหยาบ'],
    answer: 1,
  ...
  { id: 2105, subject: 'cliapprum', topic: 'metabolism-nutrition', year: 4,
    ...
    options: ['Score 1 (เหลวเป็นน้ำ ไม่จับตัว, กระจายทั่วพื้น)', 'Score 2-3 (กึ่งกองกึ่งเปียก, ลักษณะ pancake/cow pie)', 'Score 4-5 (กองสูง แห้ง แข็ง จับเป็นก้อน)', 'Score 5 เท่านั้น (กลมแข็งเป็นลูกเหมือนมูลแพะ)'],
    answer: 1,
  ...
  { id: 2108, subject: 'cliapprum', topic: 'ruminant-anesthesia', year: 4,
    ...
    options: ['Allergic reaction ต่อ inhalant agent (พบบ่อยในวัวที่ดมยานาน)',
  ...
  { id: 2109, subject: 'cliapprum', topic: 'ruminant-anesthesia', year: 4,
    ...
    options: ['Food + water 12-24 hr (มาตรฐาน adult cattle)',
              'Food 8 hr / water ไม่จำกัด (มาตรฐานเดียวกับสุกร)',
  ...
  { id: 2110, subject: 'cliapprum', topic: 'ruminant-anesthesia', year: 4,
    ...
    options: ['1-2 ml/kg/h (อัตราต่ำ ใช้เฉพาะลูกวัวแรกเกิด)',
              '4-8 ml/kg/h (อัตรา maintenance มาตรฐานในวัวปกติ)',
  ...
  { id: 2111, subject: 'cliapprum', topic: 'ruminant-anesthesia', year: 4,
    ...
    options: ['ทั้ง Active + Passive (silent) = เกิดที่ light plane เท่านั้น',
              'Active = light plane, Passive (silent) = deep plane',
              'Active = deep plane, Passive (silent) = light plane',
              'ทั้ง Active + Passive (silent) = เกิดที่ deep plane เท่านั้น'],
    answer: 1,
  ...
  { id: 2112, subject: 'cliapprum', topic: 'ruminant-anesthesia', year: 4,
    ...
    options: ['Block เส้นประสาทขาหน้า ใช้สำหรับหัตถการกระดูกขาหน้า',
              'Block ประสาทตาทั้ง motor + sensory ใช้สำหรับ enucleation',
              'Block เส้นประสาท intercostal ใช้สำหรับหัตถการผนังทรวงอก',
              'Block เส้นประสาท sciatic ใช้สำหรับหัตถการขาหลัง'],
    answer: 1,
  ...
  { id: 2114, subject: 'cliapprum', topic: 'ruminant-anesthesia', year: 4,
    ...
    options: ['ทำให้ tachycardia รุนแรง + เพิ่ม myocardial oxygen demand',
              'Saliva เหนียวข้น + GI motility ลด, เสี่ยง bloat',
              'ราคาแพงเกินไปสำหรับการใช้ในสัตว์ใหญ่อย่างวัว',
              'เป็นยาที่ห้ามใช้ในสัตว์เลี้ยงลูกด้วยนมทุกชนิด'],
    answer: 1,
  ...
  { id: 2115, subject: 'cliapprum', topic: 'ruminant-anesthesia', year: 4,
    ...
    options: ['ให้ analgesia ได้ดีเยี่ยม แต่ราคาแพงและออกฤทธิ์สั้น',
              'Muscle relaxation + minimal CV depression, ไม่มี analgesic',
              'Lipid solubility ต่ำ จึงให้ทาง inhalation ได้อย่างเดียว',
              'เพิ่ม rumen contraction และกระตุ้น GI motility ชัดเจน'],
    answer: 1,
  ...
  { id: 2117, subject: 'cliapprum', topic: 'gi-surgery-sawita', year: 4,
    ...
    options: ['ใช้ auscultation ร่วมกับ deep palpation ผนังท้องเท่านั้น',
              'Simultaneous auscultation + percussion ฟังเสียง ping',
              'ถ่าย X-ray ช่องท้องเป็น gold standard ในการวินิจฉัย',
              'ส่อง endoscopy ผ่านหลอดอาหารเข้าไปดู abomasum โดยตรง'],
    answer: 1,
  ...
  { id: 2118, subject: 'cliapprum', topic: 'gi-surgery-sawita', year: 4,
    ...
    options: ['วัวปกติ คลำเจอ apex ชี้ไปทางอุ้งเชิงกรานตามธรรมชาติ',
              'Cecal dilatation แบบ simple (apex ยังชี้ caudal ตามเดิม)',
              'Cecal dislocation/retroflexion (body + apex พลิกไป cranial)',
              'การตั้งท้องเดือนที่ 9 คลำเจอลูกดันมาทางทวารหนัก'],
    answer: 2,
  ...
  { id: 2119, subject: 'cliapprum', topic: 'gi-surgery-sawita', year: 4,
    ...
    options: ['Wither test เพียงอย่างเดียว',
              ...
              'Multi-modal (pain test + bloodwork + radiograph)',
  ...
  { id: 2120, subject: 'cliapprum', topic: 'gi-surgery-sawita', year: 4,
    ...
    options: ['ปกติ 5.5-7.5, acidosis = pH <5.5, alkalosis (inactive rumen) = pH >7.0',
              'ปกติ 7.4-8.0, acidosis = pH <6.5, alkalosis = pH >8.5 (เหมือนเลือด)',
              'ปกติ 4.0-5.0 เป็นกรดอ่อนตามธรรมชาติ, acidosis = pH <2.0',
  ...
  { id: 2122, subject: 'cliapprum', topic: 'gi-surgery-sawita', year: 4,
    ...
    options: ['Transition period ช่วง 30 วันแรกหลังคลอด (peak incidence)',
              'Heat stress ร่วมกับการเลี้ยงด้วยหญ้าสดเพียงอย่างเดียว',
              'การตั้งท้องช่วงเดือน 7-9 ก่อนคลอด ที่มดลูกขยายใหญ่',
  ...
  { id: 2132, subject: 'cliapprum', topic: 'gi-vdtt', year: 4,
    ...
    options: ['0-1 ครั้ง/นาที (atony บ่งบอกภาวะ rumen หยุดทำงาน)', '1-3 ครั้ง/นาที (ประมาณ 1 ครั้งทุก 30-45 วินาที)', '5-7 ครั้ง/นาที (เร็วกว่าปกติชัดเจน hypermotility)', '>10 ครั้ง/นาที (ถี่มากผิดปกติแบบ spasm)'],
    answer: 1,
  ...
  { id: 2128, subject: 'cliapprum', topic: 'hoof-health-fleet', year: 4,
    ...
    options: ['Sole ulcer + white line disease จากกีบยาวเกินไป',
