...
export const QB_CLIAPPRUM = [
  ...
  { id: 2117, subject: 'cliapprum', topic: 'gi-surgery-sawita', year: 4,
    ...
    options: ['Auscultation + Palpation เท่านั้น',
              'Simultaneous auscultation + percussion (ping)',
  ...
  { id: 2118, subject: 'cliapprum', topic: 'gi-surgery-sawita', year: 4,
    ...
    options: ['Normal cow',
              'Cecal dilatation',
              'Cecal dislocation/retroflexion',
              'Pregnancy month 9'],
    answer: 2,
  ...
  { id: 2122, subject: 'cliapprum', topic: 'gi-surgery-sawita', year: 4,
    ...
    options: ['Transition period (first 30 days post-partum)',
  ...
  { id: 2133, subject: 'cliapprum', topic: 'gi-vdtt', year: 4,
    ...
    options: ['Polycythemia', 'Hardware disease / hypocalcemia / acidosis', 'Heart disease only', 'Skin disease'],
    answer: 1,
