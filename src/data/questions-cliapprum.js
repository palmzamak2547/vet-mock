...
export const QB_CLIAPPRUM = [
  ...
  { id: 2107, subject: 'cliapprum', topic: 'metabolism-nutrition', year: 4,
    ...
    options: ['<0.4 mM',
              '≥1.2 mM (subclinical ketosis · clinical ketosis ≥3.0 mM)',
              '≥10 mM',
              '≥100 mM'],
    answer: 1,
  ...
  { id: 2114, subject: 'cliapprum', topic: 'ruminant-anesthesia', year: 4,
    ...
    options: ['ทำให้ tachycardia เกินไป',
              'Atropine ทำให้ secretions เหนียวข้นขึ้น (thickened) แทนที่จะลด → อาจอุดทางเดินหายใจ + ลด GI motility ทำให้ rumen stasis · bloat',
              'Atropine ราคาแพงในวัว',
              'ห้ามใช้ใน mammals'],
    answer: 1,
  ...
  { id: 2115, subject: 'cliapprum', topic: 'ruminant-anesthesia', year: 4,
    ...
    options: ['ข้อดี = analgesia ดีมาก · ข้อเสีย = ราคาแพง',
              'ข้อดี = muscle relaxation ดี + minimal cardiopulmonary depression · ข้อเสีย = ไม่มี analgesic effect ต้องใช้ร่วม opioid/alpha-2',
              'ข้อดี = lipid solubility ต่ำ ปลอดภัย · ข้อเสีย = inhalational only',
              'ข้อดี = ทำให้ rumen contraction เพิ่ม'],
    answer: 1,
