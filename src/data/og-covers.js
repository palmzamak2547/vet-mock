...
export const OG_COVERS = [
  ...
  { id: 'bench', route: '/app/bench',
    ...
    description: 'บทเรียนระบาดวิทยา Module 5 ที่ตอบกลับได้ พร้อมโต๊ะทดลองที่คำนวณค่าทำนายผลบวกสด',
    cover: 'ผลบวกหนึ่งครั้ง เชื่อได้แค่ไหน' },
  { id: 'admin', route: '/app/admin',
    title: 'หลังบ้าน',
    description: 'สถิติทั้งหมด และโจทย์ที่คนผิดบ่อย เห็นได้เฉพาะผู้ดูแล',
    cover: 'เห็นก่อนใครจะแจ้ง' },
];
