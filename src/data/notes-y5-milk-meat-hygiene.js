...
export const NOTES_Y5_MILK_MEAT_HYGIENE = {
  ...
  'milk-overview': {
    ...
    icon: '📖',
    summary: 'ตารางสอน 3107518 ส.ค.–ธ.ค. 2567 · ครึ่งแรกสุขศาสตร์น้ำนม (SJ + RC + CN) · ครึ่งหลังสุขศาสตร์เนื้อสัตว์ (SP + RC + TL + SC).',
    sections: [
      {
        heading: 'Course identity',
        source: '0 - Milk_hygiene_and_meat_inspection_2024.pdf p.1',
        body: [
          { bullets: [
            'รหัสวิชา **3107518** (เดิม 3109503 ในตารางสอน) — สุขศาสตร์น้ำนมและเนื้อสัตว์',
            'ภาควิชาสัตวแพทยสาธารณสุข · คณะสัตวแพทยศาสตร์ · จุฬาฯ',
            'นิสิตชั้นปีที่ 5 · ภาคต้น ปี 2567',
            'วันที่สอน 5 ส.ค. – 13 ธ.ค. 2567 · 09:00–12:00 น. · ห้อง 807 ตึก 60 ปี',
            'ผู้ประสานรายวิชา: **ศ.สพ.ญ.ดร. รุ่งทิพย์ ชวนชื่น** (Rungtip Chuanchuen)',
          ] },
        ],
      },
      {
        heading: 'Milk half lecture flow (Aug → mid Sep)',
        source: '0 - Milk_hygiene_and_meat_inspection_2024.pdf p.1',
        body: [
          { bullets: [
            '7 ส.ค. — Introduction to milk hygiene (RC)',
            '7 ส.ค. — Cow mastitis & milk quality (RC)',
            '14 ส.ค. — Farm biosecurity for good milk quality production (จักรกริศน์ เนื่องจำนงค์)',
            '21 ส.ค. — Composition & quality of raw milk (SJ)',
            '21 ส.ค. — Standard of raw milk & dairy products (SJ)',
            '28 ส.ค. — Milk storage & transportation (RC)',
            '28 ส.ค. — Determination of milk quality (RC)',
            '4 ก.ย. — Milk microbiology + Milk-borne pathogens & diseases (SJ)',
            '11 ก.ย. — GMP/HACCP standards for MCC & milk processing plants (SJ)',
            '18 ก.ย. — Processing & manufacturing technologies for milk products (SJ)',
            '23 ก.ย. – 1 ต.ค. — **สอบกลางภาค (Midterm)**',
            '2 ต.ค. — Cleaning & sanitizing in MCC & processing plants (SJ)',
          ] },
        ],
      },
      {
        heading: 'Meat half lecture flow (Oct → Dec)',
        source: '0 - Milk_hygiene_and_meat_inspection_2024.pdf p.1-2',
        body: [
          { bullets: [
            '9 ต.ค. — Introduction to meat hygiene + Aquatic food deterioration & toxins (SP)',
            '16 ต.ค. — Spoilage/disease-causing microorganisms in meat + microbiological std + sampling (TL — ผศ.น.สพ.ดร. ธราดล เหลืองทองคำ)',
            '23 ต.ค. — Storage of meat & meat products (RC) *(เลื่อนได้)*',
            '30 ต.ค. — Meat wholesomeness + Molecular techniques for meat quality/authentication (RC)',
            '6 พ.ย. — Slaughterhouse hygiene (SP)',
            '13 พ.ย. — Slaughterhouse design & process + AM/PM meat inspection (SP)',
            '20 พ.ย. — Postmortem changes + Meat cutting & grading (SP)',
            '27 พ.ย. — Pest & vector control in slaughterhouses + Egg hygiene (รศ.น.สพ.ดร. ศุภชัย เนื้อนวลสุวรรณ + SC)',
            '2–13 ธ.ค. — **สอบปลายภาค (Final)**',
          ] },
        ],
      },
      {
        heading: 'Department affiliations on syllabus',
        source: '0 - Milk_hygiene_and_meat_inspection_2024.pdf p.2',
        body: [
          { bullets: [
            'ภาควิชาสัตวแพทยสาธารณสุข — RC, SJ, SP, TL, ศุภชัย, SC',
            'ภาควิชาสัตวบาล — จักรกริศน์ เนื่องจำนงค์ (biosecurity lecture)',
          ] },
          { callout: 'หมายเหตุ: รหัสวิชาในตารางสอนคือ 3109503 แต่ในระบบ curriculum ของ VetMock ใช้ 3107518 — ใช้คู่ขนานได้.', kind: 'tip' },
        ],
      },
    ],
  },
