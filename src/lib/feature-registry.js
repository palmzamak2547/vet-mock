...
export const FEATURES = [
  ...
  },
  {
    ...
    label: 'แข่งกับเพื่อน', labelEn: 'Race with friends', icon: '🏁',
  ...
  },
  {
    ...
    label: 'คิวรอตรวจ', labelEn: 'Review Queue', icon: '📋',
  ...
  },
  {
    ...
    label: 'รายการอ่าน', labelEn: 'Reading Checklist', icon: '📖',
  ...
  },
  {
    ...
    hint: 'ตารางเรียน นับถอยหลังสอบ และเนื้อหาออกสอบ',
  ...
  // ── 📊 Progress ──────────────────────────────────────────
  {
    ...
    hint: 'สถิติ จุดอ่อน และสำรองข้อมูล',
  ...
  },
  {
    ...
    label: 'อันดับคะแนน', labelEn: 'Global leaderboard', icon: '🥇',
    hint: 'อันดับคะแนนรวม',
  ...
  },
  {
    ...
    label: 'สรุปช่วงสอบ', labelEn: 'Phase Wrapped', icon: '🎉',
    hint: 'สรุปการเรียนตลอดช่วงสอบ',
  ...
  },
  {
    ...
    label: 'แฟลชการ์ดปิดภาพ', labelEn: 'Image Occlusion', icon: '🖼',
  ...
  },
  {
    ...
    hint: 'แชร์ข้อสอบและอันดับคะแนนกลุ่ม',
  ...
  },
  {
    ...
    label: 'ตั้งค่าเสียงอ่าน', labelEn: 'Voice settings', icon: '🎚',
  ...
  },
  {
    ...
    label: 'ตั้งค่าบัญชี', labelEn: 'Account settings', icon: '⚙️',
    hint: 'จัดการบัญชี รหัสผ่าน และการลบบัญชี',
  ...
  },
  {
    ...
    label: 'เกี่ยวกับ VetMock', labelEn: 'About', icon: 'ℹ️',
  ...
  },
  {
    ...
    label: 'แจ้งปัญหาและข้อเสนอแนะ', labelEn: 'Feedback', icon: '🐛',
    hint: 'แจ้งข้อผิดพลาด ติชม หรือขอฟีเจอร์',
