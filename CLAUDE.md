# CLAUDE.md — VetMock Project Guide
...
> Read `MycOS/CLAUDE.md` for full context — this file is just the quick refresh.
...
- Mentioning Claude/AI in any user-facing artifact (see Rule 1)
