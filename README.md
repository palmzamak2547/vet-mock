...
| | |
|---|---|
| ข้อสอบ | **4,707 ข้อ** ใน 65 bank files, 42 วิชา |
| ชั้นปีที่มีเนื้อหา | ปี 1 (298), ปี 2 (253), ปี 4 (2,095), ปี 5 (2,061) |
| สรุปโน้ต | 35 ไฟล์, 350 หัวข้อ, 3,315 sections, อ้างอิงแหล่งที่มาครบ 100% |
| สรุปคลิป | 400 คลิป ใน 27 ไฟล์ |
| VetWiki (governed) | 208 หัวข้อ, 1,772 sections = 53.5% ของ note sections |
