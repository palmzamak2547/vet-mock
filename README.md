...
| | |
|---|---|
| ข้อสอบพร้อมฝึก | **4,480 ข้อ** ใน 65 bank files, 42 วิชา |
| พักไว้เพื่อความถูกต้อง | 26 ข้อรอภาพที่ตรวจสอบแล้ว (เก็บใน source bank แต่ไม่ส่งให้ผู้เรียน) |
| ชั้นปีที่มีเนื้อหา | ปี 1 (296), ปี 2 (142), ปี 4 (2,092), ปี 5 (1,950) |
