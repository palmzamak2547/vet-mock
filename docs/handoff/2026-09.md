# VetMock session log — September 2026

Dated handoff entries moved verbatim from `AGENTS.md` on 2026-09-23, in the order
they were written there, which is not strictly by date. The guide and its rules stay
in [`AGENTS.md`](../AGENTS.md). New entries are appended there first, under its
Session log heading, and moved into a file here when it grows.
