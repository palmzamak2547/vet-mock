...
## 2026-09-26 — Learning plan and review candidate (isolated)
...
- Rebased onto the released security commit `69e7f158`, retaining both handoffs; feature/test blobs were unchanged. Candidate metadata is 5.131.0/SWv196. Preserve the bughunt, sync, content and Research Studio lanes; App/Home contain narrow integration seams. No push/deploy from this lane; candidate is ready for its production release decision. Recheck main before one approved push, then prove exact-SHA CI/deployment and live changed-capability flows.
